...
Detail: Frame: Attribute](frame-attribute.md "previous page")
[next

Detail: Frame: Dictionary-Like](frame-dictionary_like.md "next page")
...
* [`Frame.__round__()`](#static_frame.Frame.__round__)
* [`Frame.all()`](#static_frame.Frame.all)
* [`Frame.any()`](#static_frame.Frame.any)
* [`Frame.clip()`](#static_frame.Frame.clip)
* [`Frame.corr()`](#static_frame.Frame.corr)
* [`Frame.count()`](#static_frame.Frame.count)
* [`Frame.cov()`](#static_frame.Frame.cov)
* [`Frame.cumprod()`](#static_frame.Frame.cumprod)
* [`Frame.cumsum()`](#static_frame.Frame.cumsum)
* [`Frame.drop_duplicated()`](#static_frame.Frame.drop_duplicated)
* [`Frame.dropfalsy()`](#static_frame.Frame.dropfalsy)
* [`Frame.dropna()`](#static_frame.Frame.dropna)
* [`Frame.duplicated()`](#static_frame.Frame.duplicated)
* [`Frame.equals()`](#static_frame.Frame.equals)
* [`Frame.fillfalsy()`](#static_frame.Frame.fillfalsy)
* [`Frame.fillfalsy_backward()`](#static_frame.Frame.fillfalsy_backward)
* [`Frame.fillfalsy_forward()`](#static_frame.Frame.fillfalsy_forward)
* [`Frame.fillfalsy_leading()`](#static_frame.Frame.fillfalsy_leading)
* [`Frame.fillfalsy_trailing()`](#static_frame.Frame.fillfalsy_trailing)
* [`Frame.fillna()`](#static_frame.Frame.fillna)
* [`Frame.fillna_backward()`](#static_frame.Frame.fillna_backward)
* [`Frame.fillna_forward()`](#static_frame.Frame.fillna_forward)
* [`Frame.fillna_leading()`](#static_frame.Frame.fillna_leading)
* [`Frame.fillna_trailing()`](#static_frame.Frame.fillna_trailing)
* [`Frame.head()`](#static_frame.Frame.head)
* [`Frame.iloc_max()`](#static_frame.Frame.iloc_max)
* [`Frame.iloc_min()`](#static_frame.Frame.iloc_min)
* [`Frame.iloc_notfalsy_first()`](#static_frame.Frame.iloc_notfalsy_first)
* [`Frame.iloc_notfalsy_last()`](#static_frame.Frame.iloc_notfalsy_last)
* [`Frame.iloc_notna_first()`](#static_frame.Frame.iloc_notna_first)
* [`Frame.iloc_notna_last()`](#static_frame.Frame.iloc_notna_last)
* [`Frame.insert_after()`](#static_frame.Frame.insert_after)
* [`Frame.insert_before()`](#static_frame.Frame.insert_before)
* [`Frame.isfalsy()`](#static_frame.Frame.isfalsy)
* [`Frame.isin()`](#static_frame.Frame.isin)
* [`Frame.isna()`](#static_frame.Frame.isna)
* [`Frame.join_inner()`](#static_frame.Frame.join_inner)
* [`Frame.join_left()`](#static_frame.Frame.join_left)
* [`Frame.join_outer()`](#static_frame.Frame.join_outer)
* [`Frame.join_right()`](#static_frame.Frame.join_right)
* [`Frame.loc_max()`](#static_frame.Frame.loc_max)
* [`Frame.loc_min()`](#static_frame.Frame.loc_min)
* [`Frame.loc_notfalsy_first()`](#static_frame.Frame.loc_notfalsy_first)
* [`Frame.loc_notfalsy_last()`](#static_frame.Frame.loc_notfalsy_last)
* [`Frame.loc_notna_first()`](#static_frame.Frame.loc_notna_first)
* [`Frame.loc_notna_last()`](#static_frame.Frame.loc_notna_last)
* [`Frame.max()`](#static_frame.Frame.max)
* [`Frame.mean()`](#static_frame.Frame.mean)
* [`Frame.median()`](#static_frame.Frame.median)
* [`Frame.merge_inner()`](#static_frame.Frame.merge_inner)
* [`Frame.merge_left()`](#static_frame.Frame.merge_left)
* [`Frame.merge_outer()`](#static_frame.Frame.merge_outer)
* [`Frame.merge_right()`](#static_frame.Frame.merge_right)
* [`Frame.min()`](#static_frame.Frame.min)
* [`Frame.notfalsy()`](#static_frame.Frame.notfalsy)
* [`Frame.notna()`](#static_frame.Frame.notna)
* [`Frame.pivot()`](#static_frame.Frame.pivot)
* [`Frame.pivot_stack()`](#static_frame.Frame.pivot_stack)
* [`Frame.pivot_unstack()`](#static_frame.Frame.pivot_unstack)
* [`Frame.prod()`](#static_frame.Frame.prod)
* [`Frame.rank_dense()`](#static_frame.Frame.rank_dense)
* [`Frame.rank_max()`](#static_frame.Frame.rank_max)
* [`Frame.rank_mean()`](#static_frame.Frame.rank_mean)
* [`Frame.rank_min()`](#static_frame.Frame.rank_min)
* [`Frame.rank_ordinal()`](#static_frame.Frame.rank_ordinal)
* [`Frame.rehierarch()`](#static_frame.Frame.rehierarch)
* [`Frame.reindex()`](#static_frame.Frame.reindex)
* [`Frame.relabel()`](#static_frame.Frame.relabel)
* [`Frame.relabel_flat()`](#static_frame.Frame.relabel_flat)
* [`Frame.relabel_level_add()`](#static_frame.Frame.relabel_level_add)
* [`Frame.relabel_level_drop()`](#static_frame.Frame.relabel_level_drop)
* [`Frame.relabel_shift_in()`](#static_frame.Frame.relabel_shift_in)
* [`Frame.relabel_shift_out()`](#static_frame.Frame.relabel_shift_out)
* [`Frame.rename()`](#static_frame.Frame.rename)
* [`Frame.roll()`](#static_frame.Frame.roll)
* [`Frame.sample()`](#static_frame.Frame.sample)
* [`Frame.set_columns()`](#static_frame.Frame.set_columns)
* [`Frame.set_columns_hierarchy()`](#static_frame.Frame.set_columns_hierarchy)
* [`Frame.set_index()`](#static_frame.Frame.set_index)
* [`Frame.set_index_hierarchy()`](#static_frame.Frame.set_index_hierarchy)
* [`Frame.shift()`](#static_frame.Frame.shift)
* [`Frame.sort_columns()`](#static_frame.Frame.sort_columns)
* [`Frame.sort_index()`](#static_frame.Frame.sort_index)
* [`Frame.sort_values()`](#static_frame.Frame.sort_values)
* [`Frame.std()`](#static_frame.Frame.std)
* [`Frame.sum()`](#static_frame.Frame.sum)
* [`Frame.tail()`](#static_frame.Frame.tail)
* [`Frame.transpose()`](#static_frame.Frame.transpose)
* [`Frame.unique()`](#static_frame.Frame.unique)
* [`Frame.unique_enumerated()`](#static_frame.Frame.unique_enumerated)
* [`Frame.unset_columns()`](#static_frame.Frame.unset_columns)
* [`Frame.unset_index()`](#static_frame.Frame.unset_index)
* [`Frame.var()`](#static_frame.Frame.var)
