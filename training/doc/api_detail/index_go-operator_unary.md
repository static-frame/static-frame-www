...
* [View page source](../_sources/api_detail/index_go-operator_unary.rst.txt)

[Previous](index_go-operator_binary.html "Detail: IndexGO: Operator Binary")
[Next](index_go-accessor_values.html "Detail: IndexGO: Accessor Values")

---

# Detail: IndexGO: Operator Unary[](#detail-indexgo-operator-unary "Link to this heading")

[Overview: IndexGO: Operator Unary](../api_overview/index_go-operator_unary.html#api-overview-indexgo-operator-unary)

IndexGO.\_\_abs\_\_()[](#static_frame.IndexGO.__abs__ "Link to this definition")
:   ```
...
IndexGO.\_\_invert\_\_()[](#static_frame.IndexGO.__invert__ "Link to this definition")
:   ```
...
IndexGO.\_\_neg\_\_()[](#static_frame.IndexGO.__neg__ "Link to this definition")
:   ```
    >>> ix = sf.IndexGO((0, 1024, -2048, 4096))
    >>> ix
    <IndexGO>
...
IndexGO.\_\_pos\_\_()[](#static_frame.IndexGO.__pos__ "Link to this definition")
:   ```
    >>> ix = sf.IndexGO((0, 1024, -2048, 4096))
    >>> ix
    <IndexGO>
