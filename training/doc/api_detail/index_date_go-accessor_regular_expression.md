...
* Detail: IndexDateGO: Accessor Regular Expression
* [View page source](../_sources/api_detail/index_date_go-accessor_regular_expression.rst.txt)

[Previous](index_date_go-accessor_string.html "Detail: IndexDateGO: Accessor String")
[Next](index_date_go-accessor_hashlib.html "Detail: IndexDateGO: Accessor Hashlib")

---

# Detail: IndexDateGO: Accessor Regular Expression[](#detail-indexdatego-accessor-regular-expression "Link to this heading")

[Overview: IndexDateGO: Accessor Regular Expression](../api_overview/index_date_go-accessor_regular_expression.html#api-overview-indexdatego-accessor-regular-expression)

IndexDateGO.via\_re(*pattern*, *flags).search(pos*, *endpos*)
...
IndexDateGO.via\_re(*pattern*, *flags).match(pos*, *endpos*)
:   via\_re *= <function Index.via\_re>*
...
IndexDateGO.via\_re(*pattern*, *flags).fullmatch(pos*, *endpos*)
:   via\_re *= <function Index.via\_re>*
...
IndexDateGO.via\_re(*pattern*, *flags).split(maxsplit*)
:   via\_re *= <function Index.via\_re>*
...
IndexDateGO.via\_re(*pattern*, *flags).findall(pos*, *endpos*)
:   via\_re *= <function Index.via\_re>*
...
IndexDateGO.via\_re(*pattern*, *flags).sub(repl*, *count*)
:   via\_re *= <function Index.via\_re>*
...
IndexDateGO.via\_re(*pattern*, *flags).subn(repl*, *count*)
:   via\_re *= <function Index.via\_re>*
