...
:   Return repr(self).
    ...
    >>> repr(fva)
    <static_frame.core.fill_value_auto.FillValueAuto object at 0x706c06676c40>
    ```
...
:   Return str(self).
    ...
    >>> fva = sf.FillValueAuto.from_default()
    >>> str(fva)
    <static_frame.core.fill_value_auto.FillValueAuto object at 0x706c066751c0>
    ```
...
Detail: FillValueAuto: Attribute](fill_value_auto-attribute.md "previous page")
[next

Detail: FillValueAuto: Selector](fill_value_auto-selector.md "next page")

On this page

* [`FillValueAuto.__repr__()`](#static_frame.FillValueAuto.__repr__)
* [`FillValueAuto.__str__()`](#static_frame.FillValueAuto.__str__)
