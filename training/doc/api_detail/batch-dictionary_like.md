...
Detail: Batch: Method](batch-method.md "previous page")
[next

Detail: Batch: Display](batch-display.md "next page")

On this page

* [`Batch.__iter__()`](#static_frame.Batch.__iter__)
* [`Batch.items()`](#static_frame.Batch.items)
* [`Batch.keys()`](#static_frame.Batch.keys)
* [`Batch.values`](#static_frame.Batch.values)
