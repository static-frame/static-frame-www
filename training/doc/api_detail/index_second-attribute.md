...
Detail: IndexSecond: Exporter](index_second-exporter.md "previous page")
[next

Detail: IndexSecond: Method](index_second-method.md "next page")

On this page

* [`IndexSecond.STATIC`](#static_frame.IndexSecond.STATIC)
* [`IndexSecond.depth`](#static_frame.IndexSecond.depth)
* [`IndexSecond.dtype`](#static_frame.IndexSecond.dtype)
* [`IndexSecond.index_types`](#static_frame.IndexSecond.index_types)
* [`IndexSecond.memory`](#static_frame.IndexSecond.memory)
* [`IndexSecond.mloc`](#static_frame.IndexSecond.mloc)
* [`IndexSecond.name`](#static_frame.IndexSecond.name)
* [`IndexSecond.names`](#static_frame.IndexSecond.names)
* [`IndexSecond.nbytes`](#static_frame.IndexSecond.nbytes)
* [`IndexSecond.ndim`](#static_frame.IndexSecond.ndim)
* [`IndexSecond.positions`](#static_frame.IndexSecond.positions)
* [`IndexSecond.shape`](#static_frame.IndexSecond.shape)
* [`IndexSecond.size`](#static_frame.IndexSecond.size)
