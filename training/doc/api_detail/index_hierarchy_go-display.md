...
:   A Frame documenting the interface of this class.
    ...
    <Index: signature>
    __init__(indices, /, *, indexers,... IndexHierarchyGO Constructor          Initializer. Args...
    from_difference(*others)             IndexHierarchyGO Constructor          Construct a new I...
    from_index_items(items, /, *, ind... IndexHierarchyGO Constructor          Given an iterable...
    from_intersection(*others)           IndexHierarchyGO Constructor          Construct a new I...
    from_labels(labels, /, *, name, r... IndexHierarchyGO Constructor          Construct an Inde...
    ...
    from_tree(tree, /, *, name, index... IndexHierarchyGO Constructor          Convert into a In...
    from_union(*others)                  IndexHierarchyGO Constructor          Construct a new I...
    ...
    to_html_datatables(fp, /, *, show... IndexHierarchyGO Exporter             Return a complete...
    to_pandas()                          IndexHierarchyGO Exporter             Return a Pandas M...
    ...                                  ...              ...                  ...
    via_re(pattern, flags, /).sub(rep... IndexHierarchyGO Accessor Regular ... Return the string...
    via_re(pattern, flags, /).subn(re... IndexHierarchyGO Accessor Regular ... Perform the same ...
    ...
    via_type_clinic.check(hint, /, *,... IndexHierarchyGO Accessor Type Clinic Given a hint (a t...
    via_type_clinic.warn(hint, /, *, ... IndexHierarchyGO Accessor Type Clinic Given a hint (a t...
...
Detail: IndexHierarchyGO: Dictionary-Like](index_hierarchy_go-dictionary_like.md "previous page")
[next

Detail: IndexHierarchyGO: Selector](index_hierarchy_go-selector.md "next page")

On this page

* [`IndexHierarchyGO.interface`](#IndexHierarchyGO.interface)
* [`IndexHierarchyGO.__repr__()`](#static_frame.IndexHierarchyGO.__repr__)
* [`IndexHierarchyGO.__str__()`](#static_frame.IndexHierarchyGO.__str__)
* [`IndexHierarchyGO.display()`](#static_frame.IndexHierarchyGO.display)
* [`IndexHierarchyGO.display_tall()`](#static_frame.IndexHierarchyGO.display_tall)
* [`IndexHierarchyGO.display_wide()`](#static_frame.IndexHierarchyGO.display_wide)
