...
Detail: Batch: Attribute](batch-attribute.md "previous page")
[next

Detail: Batch: Dictionary-Like](batch-dictionary_like.md "next page")

On this page

* [`Batch.__array__()`](#static_frame.Batch.__array__)
* [`Batch.__array_ufunc__()`](#static_frame.Batch.__array_ufunc__)
* [`Batch.__bool__()`](#static_frame.Batch.__bool__)
* [`Batch.__round__()`](#static_frame.Batch.__round__)
* [`Batch.all()`](#static_frame.Batch.all)
* [`Batch.any()`](#static_frame.Batch.any)
* [`Batch.apply()`](#static_frame.Batch.apply)
* [`Batch.apply_except()`](#static_frame.Batch.apply_except)
* [`Batch.apply_items()`](#static_frame.Batch.apply_items)
* [`Batch.apply_items_except()`](#static_frame.Batch.apply_items_except)
* [`Batch.clip()`](#static_frame.Batch.clip)
* [`Batch.corr()`](#static_frame.Batch.corr)
* [`Batch.count()`](#static_frame.Batch.count)
* [`Batch.cov()`](#static_frame.Batch.cov)
* [`Batch.cumprod()`](#static_frame.Batch.cumprod)
* [`Batch.cumsum()`](#static_frame.Batch.cumsum)
* [`Batch.drop_duplicated()`](#static_frame.Batch.drop_duplicated)
* [`Batch.dropfalsy()`](#static_frame.Batch.dropfalsy)
* [`Batch.dropna()`](#static_frame.Batch.dropna)
* [`Batch.duplicated()`](#static_frame.Batch.duplicated)
* [`Batch.equals()`](#static_frame.Batch.equals)
* [`Batch.fillfalsy()`](#static_frame.Batch.fillfalsy)
* [`Batch.fillfalsy_backward()`](#static_frame.Batch.fillfalsy_backward)
* [`Batch.fillfalsy_forward()`](#static_frame.Batch.fillfalsy_forward)
* [`Batch.fillfalsy_leading()`](#static_frame.Batch.fillfalsy_leading)
* [`Batch.fillfalsy_trailing()`](#static_frame.Batch.fillfalsy_trailing)
* [`Batch.fillna()`](#static_frame.Batch.fillna)
* [`Batch.fillna_backward()`](#static_frame.Batch.fillna_backward)
* [`Batch.fillna_forward()`](#static_frame.Batch.fillna_forward)
* [`Batch.fillna_leading()`](#static_frame.Batch.fillna_leading)
* [`Batch.fillna_trailing()`](#static_frame.Batch.fillna_trailing)
* [`Batch.head()`](#static_frame.Batch.head)
* [`Batch.iloc_max()`](#static_frame.Batch.iloc_max)
* [`Batch.iloc_min()`](#static_frame.Batch.iloc_min)
* [`Batch.isfalsy()`](#static_frame.Batch.isfalsy)
* [`Batch.isin()`](#static_frame.Batch.isin)
* [`Batch.isna()`](#static_frame.Batch.isna)
* [`Batch.loc_max()`](#static_frame.Batch.loc_max)
* [`Batch.loc_min()`](#static_frame.Batch.loc_min)
* [`Batch.max()`](#static_frame.Batch.max)
* [`Batch.mean()`](#static_frame.Batch.mean)
* [`Batch.median()`](#static_frame.Batch.median)
* [`Batch.min()`](#static_frame.Batch.min)
* [`Batch.notfalsy()`](#static_frame.Batch.notfalsy)
* [`Batch.notna()`](#static_frame.Batch.notna)
* [`Batch.prod()`](#static_frame.Batch.prod)
* [`Batch.rank_dense()`](#static_frame.Batch.rank_dense)
* [`Batch.rank_max()`](#static_frame.Batch.rank_max)
* [`Batch.rank_mean()`](#static_frame.Batch.rank_mean)
* [`Batch.rank_min()`](#static_frame.Batch.rank_min)
* [`Batch.rank_ordinal()`](#static_frame.Batch.rank_ordinal)
* [`Batch.reindex()`](#static_frame.Batch.reindex)
* [`Batch.relabel()`](#static_frame.Batch.relabel)
* [`Batch.relabel_flat()`](#static_frame.Batch.relabel_flat)
* [`Batch.relabel_level_add()`](#static_frame.Batch.relabel_level_add)
* [`Batch.relabel_level_drop()`](#static_frame.Batch.relabel_level_drop)
* [`Batch.relabel_shift_in()`](#static_frame.Batch.relabel_shift_in)
* [`Batch.rename()`](#static_frame.Batch.rename)
* [`Batch.roll()`](#static_frame.Batch.roll)
* [`Batch.sample()`](#static_frame.Batch.sample)
* [`Batch.shift()`](#static_frame.Batch.shift)
* [`Batch.sort_columns()`](#static_frame.Batch.sort_columns)
* [`Batch.sort_index()`](#static_frame.Batch.sort_index)
* [`Batch.sort_values()`](#static_frame.Batch.sort_values)
* [`Batch.std()`](#static_frame.Batch.std)
* [`Batch.sum()`](#static_frame.Batch.sum)
* [`Batch.tail()`](#static_frame.Batch.tail)
* [`Batch.transpose()`](#static_frame.Batch.transpose)
* [`Batch.unique()`](#static_frame.Batch.unique)
* [`Batch.unset_index()`](#static_frame.Batch.unset_index)
* [`Batch.var()`](#static_frame.Batch.var)
