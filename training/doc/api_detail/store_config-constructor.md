...
Detail: DisplayConfig: Display](display_config-display.md "previous page")
[next

Detail: StoreConfig: Exporter](store_config-exporter.md "next page")

On this page

* [`StoreConfig.__init__()`](#static_frame.StoreConfig.__init__)
* [`StoreConfig.from_frame()`](#static_frame.StoreConfig.from_frame)
