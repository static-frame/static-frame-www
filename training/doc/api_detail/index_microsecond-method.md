...
[Overview: IndexMicrosecond: Method](../api_overview/index_microsecond-method.md#api-overview-indexmicrosecond-method)

IndexMicrosecond.\_\_array\_\_(*dtype=None*, *copy=None*)[#](#static_frame.IndexMicrosecond.__array__ "Link to this definition")
...
IndexMicrosecond.\_\_bool\_\_()[#](#static_frame.IndexMicrosecond.__bool__ "Link to this definition")
...
:   Perform difference with another Index, container, or NumPy array. Retains order.
    ...
    1517-06-30T00:00:00.000000
    <datetime64[us]>
    >>> ix2 = sf.IndexMicrosecond(('2022-04-01', '2021-12-31', '2018-06-30'))
    >>> ix2
    <IndexMicrosecond>
...
IndexMicrosecond.is\_sorted(*\**, *ascending=True*, *kind='mergesort'*, *key=None*)[#](#static_frame.IndexMicrosecond.is_sorted "Link to this definition")
:   Return True if this Index is sorted according to the specified parameters.
    ...
    ```
    >>> ix = sf.IndexMicrosecond(('2022-04-01', '2021-12-31', '2018-06-30'))
    >>> ix
    <IndexMicrosecond>
    2022-04-01T00:00:00.000000
    2021-12-31T00:00:00.000000
...
[IndexMicrosecond](index_microsecond.md#api-detail-indexmicrosecond): [Constructor](index_microsecond-constructor.md#api-detail-indexmicrosecond-constructor) | [Exporter](index_microsecond-exporter.md#api-detail-indexmicrosecond-exporter) | [Attribute](index_microsecond-attribute.md#api-detail-indexmicrosecond-attribute) | [Method](#api-detail-indexmicrosecond-method) | [Dictionary-Like](index_microsecond-dictionary_like.md#api-detail-indexmicrosecond-dictionary-like) | [Display](index_microsecond-display.md#api-detail-indexmicrosecond-display) | [Selector](index_microsecond-selector.md#api-detail-indexmicrosecond-selector) | [Iterator](index_microsecond-iterator.md#api-detail-indexmicrosecond-iterator) | [Operator Binary](index_microsecond-operator_binary.md#api-detail-indexmicrosecond-operator-binary) | [Operator Unary](index_microsecond-operator_unary.md#api-detail-indexmicrosecond-operator-unary) | [Accessor Values](index_microsecond-accessor_values.md#api-detail-indexmicrosecond-accessor-values) | [Accessor Datetime](index_microsecond-accessor_datetime.md#api-detail-indexmicrosecond-accessor-datetime) | [Accessor String](index_microsecond-accessor_string.md#api-detail-indexmicrosecond-accessor-string) | [Accessor Regular Expression](index_microsecond-accessor_regular_expression.md#api-detail-indexmicrosecond-accessor-regular-expression) | [Accessor Hashlib](index_microsecond-accessor_hashlib.md#api-detail-indexmicrosecond-accessor-hashlib) | [Accessor Type Clinic](index_microsecond-accessor_type_clinic.md#api-detail-indexmicrosecond-accessor-type-clinic)

[previous

Detail: IndexMicrosecond: Attribute](index_microsecond-attribute.md "previous page")
[next

Detail: IndexMicrosecond: Dictionary-Like](index_microsecond-dictionary_like.md "next page")

On this page

* [`IndexMicrosecond.__array__()`](#static_frame.IndexMicrosecond.__array__)
* [`IndexMicrosecond.__array_ufunc__()`](#static_frame.IndexMicrosecond.__array_ufunc__)
* [`IndexMicrosecond.__bool__()`](#static_frame.IndexMicrosecond.__bool__)
* [`IndexMicrosecond.__copy__()`](#static_frame.IndexMicrosecond.__copy__)
* [`IndexMicrosecond.__deepcopy__()`](#static_frame.IndexMicrosecond.__deepcopy__)
* [`IndexMicrosecond.__len__()`](#static_frame.IndexMicrosecond.__len__)
* [`IndexMicrosecond.all()`](#static_frame.IndexMicrosecond.all)
* [`IndexMicrosecond.any()`](#static_frame.IndexMicrosecond.any)
* [`IndexMicrosecond.astype()`](#static_frame.IndexMicrosecond.astype)
* [`IndexMicrosecond.copy()`](#static_frame.IndexMicrosecond.copy)
* [`IndexMicrosecond.cumprod()`](#static_frame.IndexMicrosecond.cumprod)
* [`IndexMicrosecond.cumsum()`](#static_frame.IndexMicrosecond.cumsum)
* [`IndexMicrosecond.difference()`](#static_frame.IndexMicrosecond.difference)
* [`IndexMicrosecond.dropfalsy()`](#static_frame.IndexMicrosecond.dropfalsy)
* [`IndexMicrosecond.dropna()`](#static_frame.IndexMicrosecond.dropna)
* [`IndexMicrosecond.equals()`](#static_frame.IndexMicrosecond.equals)
* [`IndexMicrosecond.fillfalsy()`](#static_frame.IndexMicrosecond.fillfalsy)
...
* [`IndexMicrosecond.isin()`](#static_frame.IndexMicrosecond.isin)
* [`IndexMicrosecond.isna()`](#static_frame.IndexMicrosecond.isna)
* [`IndexMicrosecond.label_widths_at_depth()`](#static_frame.IndexMicrosecond.label_widths_at_depth)
* [`IndexMicrosecond.level_add()`](#static_frame.IndexMicrosecond.level_add)
* [`IndexMicrosecond.loc_searchsorted()`](#static_frame.IndexMicrosecond.loc_searchsorted)
* [`IndexMicrosecond.loc_to_iloc()`](#static_frame.IndexMicrosecond.loc_to_iloc)
* [`IndexMicrosecond.max()`](#static_frame.IndexMicrosecond.max)
* [`IndexMicrosecond.mean()`](#static_frame.IndexMicrosecond.mean)
* [`IndexMicrosecond.median()`](#static_frame.IndexMicrosecond.median)
* [`IndexMicrosecond.min()`](#static_frame.IndexMicrosecond.min)
* [`IndexMicrosecond.notfalsy()`](#static_frame.IndexMicrosecond.notfalsy)
* [`IndexMicrosecond.notna()`](#static_frame.IndexMicrosecond.notna)
* [`IndexMicrosecond.prod()`](#static_frame.IndexMicrosecond.prod)
* [`IndexMicrosecond.relabel()`](#static_frame.IndexMicrosecond.relabel)
* [`IndexMicrosecond.rename()`](#static_frame.IndexMicrosecond.rename)
* [`IndexMicrosecond.roll()`](#static_frame.IndexMicrosecond.roll)
* [`IndexMicrosecond.sample()`](#static_frame.IndexMicrosecond.sample)
* [`IndexMicrosecond.sort()`](#static_frame.IndexMicrosecond.sort)
* [`IndexMicrosecond.std()`](#static_frame.IndexMicrosecond.std)
* [`IndexMicrosecond.sum()`](#static_frame.IndexMicrosecond.sum)
* [`IndexMicrosecond.tail()`](#static_frame.IndexMicrosecond.tail)
* [`IndexMicrosecond.union()`](#static_frame.IndexMicrosecond.union)
* [`IndexMicrosecond.unique()`](#static_frame.IndexMicrosecond.unique)
* [`IndexMicrosecond.values_at_depth()`](#static_frame.IndexMicrosecond.values_at_depth)
* [`IndexMicrosecond.var()`](#static_frame.IndexMicrosecond.var)
