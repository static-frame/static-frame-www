...
* [View page source](../_sources/api_detail/index_hour-accessor_datetime.rst.txt)

[Previous](index_hour-accessor_values.html "Detail: IndexHour: Accessor Values")
[Next](index_hour-accessor_string.html "Detail: IndexHour: Accessor String")

---

# Detail: IndexHour: Accessor Datetime[](#detail-indexhour-accessor-datetime "Link to this heading")

[Overview: IndexHour: Accessor Datetime](../api_overview/index_hour-accessor_datetime.html#api-overview-indexhour-accessor-datetime)

IndexHour.via\_dt.\_\_call\_\_(*\**, *fill\_value*)
:   IndexHour.via\_dt
...
IndexHour.via\_dt.year\_quarter
:   IndexHour.via\_dt
    :   Interface for applying datetime properties and methods to elements in this container.
...
IndexHour.via\_dt.is\_month\_end
:   IndexHour.via\_dt
    :   Interface for applying datetime properties and methods to elements in this container.
...
IndexHour.via\_dt.is\_month\_start
:   IndexHour.via\_dt
    :   Interface for applying datetime properties and methods to elements in this container.
...
IndexHour.via\_dt.is\_year\_end
:   IndexHour.via\_dt
    :   Interface for applying datetime properties and methods to elements in this container.
...
IndexHour.via\_dt.is\_year\_start
:   IndexHour.via\_dt
    :   Interface for applying datetime properties and methods to elements in this container.
...
IndexHour.via\_dt.is\_quarter\_end
:   IndexHour.via\_dt
    :   Interface for applying datetime properties and methods to elements in this container.
...
IndexHour.via\_dt.is\_quarter\_start
:   IndexHour.via\_dt
    :   Interface for applying datetime properties and methods to elements in this container.
...
IndexHour.via\_dt.isoformat(*\**, *sep*, *timespec*)
:   IndexHour.via\_dt
    :   Interface for applying datetime properties and methods to elements in this container.
...
IndexHour.via\_dt.fromisoformat
:   IndexHour.via\_dt
    :   Interface for applying datetime properties and methods to elements in this container.
...
IndexHour.via\_dt.strftime(*format*)
:   IndexHour.via\_dt
    :   Interface for applying datetime properties and methods to elements in this container.
...
IndexHour.via\_dt.strptime(*format*)
:   IndexHour.via\_dt
    :   Interface for applying datetime properties and methods to elements in this container.
...
IndexHour.via\_dt.strpdate(*format*)
:   IndexHour.via\_dt
    :   Interface for applying datetime properties and methods to elements in this container.
