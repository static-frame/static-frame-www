...
Detail: IndexGO: Exporter](index_go-exporter.md "previous page")
[next

Detail: IndexGO: Method](index_go-method.md "next page")

On this page

* [`IndexGO.STATIC`](#static_frame.IndexGO.STATIC)
* [`IndexGO.depth`](#static_frame.IndexGO.depth)
* [`IndexGO.dtype`](#static_frame.IndexGO.dtype)
* [`IndexGO.index_types`](#static_frame.IndexGO.index_types)
* [`IndexGO.memory`](#static_frame.IndexGO.memory)
* [`IndexGO.mloc`](#static_frame.IndexGO.mloc)
* [`IndexGO.name`](#static_frame.IndexGO.name)
* [`IndexGO.names`](#static_frame.IndexGO.names)
* [`IndexGO.nbytes`](#static_frame.IndexGO.nbytes)
* [`IndexGO.ndim`](#static_frame.IndexGO.ndim)
* [`IndexGO.positions`](#static_frame.IndexGO.positions)
* [`IndexGO.shape`](#static_frame.IndexGO.shape)
* [`IndexGO.size`](#static_frame.IndexGO.size)
