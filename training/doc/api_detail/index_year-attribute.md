...
Detail: IndexYear: Exporter](index_year-exporter.md "previous page")
[next

Detail: IndexYear: Method](index_year-method.md "next page")

On this page

* [`IndexYear.STATIC`](#static_frame.IndexYear.STATIC)
* [`IndexYear.depth`](#static_frame.IndexYear.depth)
* [`IndexYear.dtype`](#static_frame.IndexYear.dtype)
* [`IndexYear.index_types`](#static_frame.IndexYear.index_types)
* [`IndexYear.memory`](#static_frame.IndexYear.memory)
* [`IndexYear.mloc`](#static_frame.IndexYear.mloc)
* [`IndexYear.name`](#static_frame.IndexYear.name)
* [`IndexYear.names`](#static_frame.IndexYear.names)
* [`IndexYear.nbytes`](#static_frame.IndexYear.nbytes)
* [`IndexYear.ndim`](#static_frame.IndexYear.ndim)
* [`IndexYear.positions`](#static_frame.IndexYear.positions)
* [`IndexYear.shape`](#static_frame.IndexYear.shape)
* [`IndexYear.size`](#static_frame.IndexYear.size)
