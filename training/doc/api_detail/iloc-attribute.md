...
Detail: ILoc: Constructor](iloc-constructor.md "previous page")
[next

Detail: ILoc: Display](iloc-display.md "next page")

On this page

* [`ILoc.STATIC`](#static_frame.ILoc.STATIC)
* [`ILoc.key`](#static_frame.ILoc.key)
