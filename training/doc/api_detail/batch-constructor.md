...
Detail: Bus: Accessor Type Clinic](bus-accessor_type_clinic.md "previous page")
[next

Detail: Batch: Exporter](batch-exporter.md "next page")

On this page

* [`Batch.__init__()`](#static_frame.Batch.__init__)
* [`Batch.from_frames()`](#static_frame.Batch.from_frames)
* [`Batch.from_sqlite()`](#static_frame.Batch.from_sqlite)
* [`Batch.from_xlsx()`](#static_frame.Batch.from_xlsx)
* [`Batch.from_zip_csv()`](#static_frame.Batch.from_zip_csv)
* [`Batch.from_zip_npy()`](#static_frame.Batch.from_zip_npy)
* [`Batch.from_zip_npz()`](#static_frame.Batch.from_zip_npz)
* [`Batch.from_zip_parquet()`](#static_frame.Batch.from_zip_parquet)
* [`Batch.from_zip_pickle()`](#static_frame.Batch.from_zip_pickle)
* [`Batch.from_zip_tsv()`](#static_frame.Batch.from_zip_tsv)
