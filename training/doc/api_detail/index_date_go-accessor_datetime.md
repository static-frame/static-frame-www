...
* [View page source](../_sources/api_detail/index_date_go-accessor_datetime.rst.txt)

[Previous](index_date_go-accessor_values.html "Detail: IndexDateGO: Accessor Values")
[Next](index_date_go-accessor_string.html "Detail: IndexDateGO: Accessor String")

---

# Detail: IndexDateGO: Accessor Datetime[](#detail-indexdatego-accessor-datetime "Link to this heading")

[Overview: IndexDateGO: Accessor Datetime](../api_overview/index_date_go-accessor_datetime.html#api-overview-indexdatego-accessor-datetime)

IndexDateGO.via\_dt.\_\_call\_\_(*\**, *fill\_value*)
:   IndexDateGO.via\_dt
...
IndexDateGO.via\_dt.year\_month
:   IndexDateGO.via\_dt
    :   Interface for applying datetime properties and methods to elements in this container.
...
IndexDateGO.via\_dt.year\_quarter
:   IndexDateGO.via\_dt
    :   Interface for applying datetime properties and methods to elements in this container.
...
IndexDateGO.via\_dt.is\_month\_end
:   IndexDateGO.via\_dt
    :   Interface for applying datetime properties and methods to elements in this container.
...
IndexDateGO.via\_dt.is\_month\_start
:   IndexDateGO.via\_dt
    :   Interface for applying datetime properties and methods to elements in this container.
...
IndexDateGO.via\_dt.is\_year\_end
:   IndexDateGO.via\_dt
    :   Interface for applying datetime properties and methods to elements in this container.
...
IndexDateGO.via\_dt.is\_year\_start
:   IndexDateGO.via\_dt
    :   Interface for applying datetime properties and methods to elements in this container.
...
IndexDateGO.via\_dt.is\_quarter\_end
:   IndexDateGO.via\_dt
    :   Interface for applying datetime properties and methods to elements in this container.
...
IndexDateGO.via\_dt.is\_quarter\_start
:   IndexDateGO.via\_dt
    :   Interface for applying datetime properties and methods to elements in this container.
...
IndexDateGO.via\_dt.isoformat(*\**, *sep*, *timespec*)
:   IndexDateGO.via\_dt
    :   Interface for applying datetime properties and methods to elements in this container.
...
IndexDateGO.via\_dt.fromisoformat
:   IndexDateGO.via\_dt
    :   Interface for applying datetime properties and methods to elements in this container.
...
IndexDateGO.via\_dt.strftime(*format*)
:   IndexDateGO.via\_dt
    :   Interface for applying datetime properties and methods to elements in this container.
...
IndexDateGO.via\_dt.strptime(*format*)
:   IndexDateGO.via\_dt
    :   Interface for applying datetime properties and methods to elements in this container.
...
IndexDateGO.via\_dt.strpdate(*format*)
:   IndexDateGO.via\_dt
    :   Interface for applying datetime properties and methods to elements in this container.
