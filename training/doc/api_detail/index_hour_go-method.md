...
IndexHourGO.insert\_after(*key*, *labels*, */*)[#](#static_frame.IndexHourGO.insert_after "Link to this definition")
:   ```
    >>> ix = sf.IndexHourGO(('1517-04-01', '1517-12-31', '1517-06-30'))
    >>> ix
    <IndexHourGO>
...
IndexHourGO.insert\_before(*key*, *labels*, */*)[#](#static_frame.IndexHourGO.insert_before "Link to this definition")
:   ```
    >>> ix = sf.IndexHourGO(('1517-04-01', '1517-12-31', '1517-06-30'))
    >>> ix
    <IndexHourGO>
...
Detail: IndexHourGO: Attribute](index_hour_go-attribute.md "previous page")
[next

Detail: IndexHourGO: Dictionary-Like](index_hour_go-dictionary_like.md "next page")

On this page

* [`IndexHourGO.__array__()`](#static_frame.IndexHourGO.__array__)
* [`IndexHourGO.__array_ufunc__()`](#static_frame.IndexHourGO.__array_ufunc__)
* [`IndexHourGO.__bool__()`](#static_frame.IndexHourGO.__bool__)
* [`IndexHourGO.__copy__()`](#static_frame.IndexHourGO.__copy__)
* [`IndexHourGO.__deepcopy__()`](#static_frame.IndexHourGO.__deepcopy__)
* [`IndexHourGO.__len__()`](#static_frame.IndexHourGO.__len__)
* [`IndexHourGO.all()`](#static_frame.IndexHourGO.all)
* [`IndexHourGO.any()`](#static_frame.IndexHourGO.any)
* [`IndexHourGO.append()`](#static_frame.IndexHourGO.append)
* [`IndexHourGO.astype()`](#static_frame.IndexHourGO.astype)
* [`IndexHourGO.copy()`](#static_frame.IndexHourGO.copy)
* [`IndexHourGO.cumprod()`](#static_frame.IndexHourGO.cumprod)
* [`IndexHourGO.cumsum()`](#static_frame.IndexHourGO.cumsum)
* [`IndexHourGO.difference()`](#static_frame.IndexHourGO.difference)
* [`IndexHourGO.dropfalsy()`](#static_frame.IndexHourGO.dropfalsy)
* [`IndexHourGO.dropna()`](#static_frame.IndexHourGO.dropna)
* [`IndexHourGO.equals()`](#static_frame.IndexHourGO.equals)
* [`IndexHourGO.extend()`](#static_frame.IndexHourGO.extend)
* [`IndexHourGO.fillfalsy()`](#static_frame.IndexHourGO.fillfalsy)
* [`IndexHourGO.fillna()`](#static_frame.IndexHourGO.fillna)
* [`IndexHourGO.head()`](#static_frame.IndexHourGO.head)
* [`IndexHourGO.iloc_searchsorted()`](#static_frame.IndexHourGO.iloc_searchsorted)
* [`IndexHourGO.insert_after()`](#static_frame.IndexHourGO.insert_after)
* [`IndexHourGO.insert_before()`](#static_frame.IndexHourGO.insert_before)
...
* [`IndexHourGO.label_widths_at_depth()`](#static_frame.IndexHourGO.label_widths_at_depth)
* [`IndexHourGO.level_add()`](#static_frame.IndexHourGO.level_add)
* [`IndexHourGO.loc_searchsorted()`](#static_frame.IndexHourGO.loc_searchsorted)
* [`IndexHourGO.loc_to_iloc()`](#static_frame.IndexHourGO.loc_to_iloc)
* [`IndexHourGO.max()`](#static_frame.IndexHourGO.max)
* [`IndexHourGO.mean()`](#static_frame.IndexHourGO.mean)
* [`IndexHourGO.median()`](#static_frame.IndexHourGO.median)
* [`IndexHourGO.min()`](#static_frame.IndexHourGO.min)
* [`IndexHourGO.notfalsy()`](#static_frame.IndexHourGO.notfalsy)
* [`IndexHourGO.notna()`](#static_frame.IndexHourGO.notna)
* [`IndexHourGO.prod()`](#static_frame.IndexHourGO.prod)
* [`IndexHourGO.relabel()`](#static_frame.IndexHourGO.relabel)
* [`IndexHourGO.rename()`](#static_frame.IndexHourGO.rename)
* [`IndexHourGO.roll()`](#static_frame.IndexHourGO.roll)
* [`IndexHourGO.sample()`](#static_frame.IndexHourGO.sample)
* [`IndexHourGO.sort()`](#static_frame.IndexHourGO.sort)
* [`IndexHourGO.std()`](#static_frame.IndexHourGO.std)
* [`IndexHourGO.sum()`](#static_frame.IndexHourGO.sum)
* [`IndexHourGO.tail()`](#static_frame.IndexHourGO.tail)
* [`IndexHourGO.union()`](#static_frame.IndexHourGO.union)
* [`IndexHourGO.unique()`](#static_frame.IndexHourGO.unique)
* [`IndexHourGO.values_at_depth()`](#static_frame.IndexHourGO.values_at_depth)
* [`IndexHourGO.var()`](#static_frame.IndexHourGO.var)
