...
Detail: FrameGO: Exporter](frame_go-exporter.md "previous page")
[next

Detail: FrameGO: Method](frame_go-method.md "next page")

On this page

* [`FrameGO.STATIC`](#static_frame.FrameGO.STATIC)
* [`FrameGO.T`](#static_frame.FrameGO.T)
* [`FrameGO.columns`](#static_frame.FrameGO.columns)
* [`FrameGO.dtypes`](#static_frame.FrameGO.dtypes)
* [`FrameGO.index`](#static_frame.FrameGO.index)
* [`FrameGO.memory`](#static_frame.FrameGO.memory)
* [`FrameGO.mloc`](#static_frame.FrameGO.mloc)
* [`FrameGO.name`](#static_frame.FrameGO.name)
* [`FrameGO.nbytes`](#static_frame.FrameGO.nbytes)
* [`FrameGO.ndim`](#static_frame.FrameGO.ndim)
* [`FrameGO.shape`](#static_frame.FrameGO.shape)
* [`FrameGO.size`](#static_frame.FrameGO.size)
