...
IndexHierarchy.via\_str.encode(*encoding*, *errors*)
:   IndexHierarchy.via\_str
    :   Interface for applying string methods to elements in this container.
...
Detail: IndexHierarchy: Accessor Datetime](index_hierarchy-accessor_datetime.md "previous page")
[next

Detail: IndexHierarchy: Accessor Transpose](index_hierarchy-accessor_transpose.md "next page")
