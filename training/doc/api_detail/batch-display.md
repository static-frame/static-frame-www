...
:   A Frame documenting the interface of this class.
    ...
    <Index: signature>
    __init__(items, /, *, name, confi... Batch    Constructor          Default construct...
    from_frames(frames, /, *, name, c... Batch    Constructor          Return a Batch fr...
    from_sqlite(fp, /, *, config, max... Batch    Constructor          Given a file path...
    from_xlsx(fp, /, *, config, max_w... Batch    Constructor          Given a file path...
    from_zip_csv(fp, /, *, config, ma... Batch    Constructor          Given a file path...
    from_zip_npy(fp, /, *, config, ma... Batch    Constructor          Given a file path...
    from_zip_npz(fp, /, *, config, ma... Batch    Constructor          Given a file path...
    from_zip_parquet(fp, /, *, config... Batch    Constructor          Given a file path...
    from_zip_pickle(fp, /, *, config,... Batch    Constructor          Given a file path...
    from_zip_tsv(fp, /, *, config, ma... Batch    Constructor          Given a file path...
    ...
    to_zip_csv(fp, /, *, config, comp... Batch    Exporter             Write the complet...
    ...                                  ...      ...                  ...
    ...
    via_type_clinic.check(hint, /, *,... Batch    Accessor Type Clinic Given a hint (a t...
    via_type_clinic.warn(hint, /, *, ... Batch    Accessor Type Clinic Given a hint (a t...
