...
* [View page source](../_sources/api_detail/index_date-accessor_datetime.rst.txt)

[Previous](index_date-accessor_values.html "Detail: IndexDate: Accessor Values")
[Next](index_date-accessor_string.html "Detail: IndexDate: Accessor String")

---

# Detail: IndexDate: Accessor Datetime[](#detail-indexdate-accessor-datetime "Link to this heading")

[Overview: IndexDate: Accessor Datetime](../api_overview/index_date-accessor_datetime.html#api-overview-indexdate-accessor-datetime)

IndexDate.via\_dt.\_\_call\_\_(*\**, *fill\_value*)
:   IndexDate.via\_dt
...
IndexDate.via\_dt.year\_quarter
:   IndexDate.via\_dt
    :   Interface for applying datetime properties and methods to elements in this container.
...
IndexDate.via\_dt.is\_month\_end
:   IndexDate.via\_dt
    :   Interface for applying datetime properties and methods to elements in this container.
...
IndexDate.via\_dt.is\_month\_start
:   IndexDate.via\_dt
    :   Interface for applying datetime properties and methods to elements in this container.
...
IndexDate.via\_dt.is\_year\_end
:   IndexDate.via\_dt
    :   Interface for applying datetime properties and methods to elements in this container.
...
IndexDate.via\_dt.is\_year\_start
:   IndexDate.via\_dt
    :   Interface for applying datetime properties and methods to elements in this container.
...
IndexDate.via\_dt.is\_quarter\_end
:   IndexDate.via\_dt
    :   Interface for applying datetime properties and methods to elements in this container.
...
IndexDate.via\_dt.is\_quarter\_start
:   IndexDate.via\_dt
    :   Interface for applying datetime properties and methods to elements in this container.
...
IndexDate.via\_dt.isoformat(*\**, *sep*, *timespec*)
:   IndexDate.via\_dt
    :   Interface for applying datetime properties and methods to elements in this container.
...
IndexDate.via\_dt.fromisoformat
:   IndexDate.via\_dt
    :   Interface for applying datetime properties and methods to elements in this container.
...
IndexDate.via\_dt.strftime(*format*)
:   IndexDate.via\_dt
    :   Interface for applying datetime properties and methods to elements in this container.
...
IndexDate.via\_dt.strptime(*format*)
:   IndexDate.via\_dt
    :   Interface for applying datetime properties and methods to elements in this container.
...
IndexDate.via\_dt.strpdate(*format*)
:   IndexDate.via\_dt
    :   Interface for applying datetime properties and methods to elements in this container.
