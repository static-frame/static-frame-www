...
IndexMillisecondGO.\_\_init\_\_(*labels*, */*, *\**, *loc\_is\_iloc=False*, *name=<object object>*, *sort\_status=SortStatus.UNKNOWN*)[#](#static_frame.IndexMillisecondGO.__init__ "Link to this definition")
:   Initializer.
...
*classmethod* IndexMillisecondGO.from\_difference(*\*others*)[#](#static_frame.IndexMillisecondGO.from_difference "Link to this definition")
:   Construct a new Index based on the difference with Index, containers, or NumPy arrays. Retains order.

    ```
    >>> ix1 = sf.IndexMillisecondGO.from_labels(('1517-04-01', '1517-12-31', '1517-06-30'))
    >>> ix1
    <IndexMillisecondGO>
    1517-04-01T00:00:00.000
    1517-12-31T00:00:00.000
    1517-06-30T00:00:00.000
    <datetime64[ms]>
    >>> ix2 = sf.IndexMillisecondGO.from_labels(('2022-04-01', '2021-12-31', '2018-06-30'))
    >>> ix2
    <IndexMillisecondGO>
    ...
    <datetime64[ms]>
    >>> sf.IndexMillisecondGO.from_difference(ix1, ix2)
    <IndexMillisecondGO>
    1517-04-01T00:00:00.000
    1517-12-31T00:00:00.000
    1517-06-30T00:00:00.000
...
*classmethod* IndexMillisecondGO.from\_intersection(*\*others*)[#](#static_frame.IndexMillisecondGO.from_intersection "Link to this definition")
:   Construct a new Index based on the intersection with Index, containers, or NumPy arrays. Identical comparisons retain order.
    ...
    2018-06-30T00:00:00.000
    <datetime64[ms]>
    >>> sf.IndexMillisecondGO.from_intersection(ix1, ix2)
    <IndexMillisecondGO>
    <datetime64[ms]>
    ```
...
*classmethod* IndexMillisecondGO.from\_union(*\*others*)[#](#static_frame.IndexMillisecondGO.from_union "Link to this definition")
:   Construct a new Index based on the union with Index, containers, or NumPy arrays. Identical comparisons retain order.
    ...
    2018-06-30T00:00:00.000
    <datetime64[ms]>
    >>> sf.IndexMillisecondGO.from_union(ix1, ix2)
    <IndexMillisecondGO>
    1517-04-01T00:00:00.000
    1517-06-30T00:00:00.000
    1517-12-31T00:00:00.000
...
Detail: IndexMillisecond: Accessor Type Clinic](index_millisecond-accessor_type_clinic.md "previous page")
[next

Detail: IndexMillisecondGO: Exporter](index_millisecond_go-exporter.md "next page")

On this page

* [`IndexMillisecondGO.__init__()`](#static_frame.IndexMillisecondGO.__init__)
* [`IndexMillisecondGO.from_difference()`](#static_frame.IndexMillisecondGO.from_difference)
* [`IndexMillisecondGO.from_intersection()`](#static_frame.IndexMillisecondGO.from_intersection)
* [`IndexMillisecondGO.from_labels()`](#static_frame.IndexMillisecondGO.from_labels)
* [`IndexMillisecondGO.from_pandas()`](#static_frame.IndexMillisecondGO.from_pandas)
* [`IndexMillisecondGO.from_union()`](#static_frame.IndexMillisecondGO.from_union)
