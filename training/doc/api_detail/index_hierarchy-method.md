...
IndexHierarchy.\_\_array\_\_(*dtype=None*, *copy=None*)[#](#static_frame.IndexHierarchy.__array__ "Link to this definition")
...
:   Logical `and` over values along the specified axis.
    ...
    <bool>                            <bool> <bool>
    >>> ih.all()
    NotImplementedError('<function ufunc_all at 0x7b04de99f270> for IndexHierarchy is not defined; convert to `Frame`.')
    ```
...
:   Logical `or` over values along the specified axis.
    ...
    <bool>                            <bool> <bool>
    >>> ih.any()
    NotImplementedError('<function ufunc_any at 0x7b04de99f3d0> for IndexHierarchy is not defined; convert to `Frame`.')
    ```
...
:   Return the cumulative product over the specified axis.
    ...
    <int64>                           <int64> <int64>
    >>> ih.cumprod()
    NotImplementedError('<function cumprod at 0x7b0526253270> for IndexHierarchy is not defined; convert to `Frame`.')
    ```
...
:   Return the cumulative sum over the specified axis.
    ...
    <int64>                           <int64> <int64>
    >>> ih.cumsum()
    NotImplementedError('<function cumsum at 0x7b0526252a30> for IndexHierarchy is not defined; convert to `Frame`.')
    ```
...
IndexHierarchy.insert\_after(*key*, *labels*, */*)[[source]](../_modules/static_frame/core/index_hierarchy.md#IndexHierarchy.insert_after)[#](#static_frame.IndexHierarchy.insert_after "Link to this definition")
:   ```
    ...
    b                   1024    True
    <<U1>               <int64> <bool>
    >>> ih.insert_after(('a', 2048, False), [('a', 4096, True), ('a', 4096, False)])
    <IndexHierarchy: x>
    a                   1024    True
    a                   2048    True
    a                   2048    False
    ...
    b                   1024    True
    <<U1>               <int64> <bool>
    >>> ih.insert_after(sf.ILoc[-1], [('a', 4096, True), ('a', 4096, False)])
    <IndexHierarchy: x>
    a                   1024    True
    a                   2048    True
    a                   2048    False
...
IndexHierarchy.insert\_before(*key*, *labels*, */*)[[source]](../_modules/static_frame/core/index_hierarchy.md#IndexHierarchy.insert_before)[#](#static_frame.IndexHierarchy.insert_before "Link to this definition")
:   ```
    >>> ih = sf.IndexHierarchy.from_labels((('a', 1024, True), ('a', 2048, True), ('a', 2048, False), ('b', 1024, True)), name='x')
    >>> ih
    <IndexHierarchy: x>
    ...
    b                   1024    True
    <<U1>               <int64> <bool>
    >>> ih.insert_before(('a', 2048, False), [('a', 4096, True), ('a', 4096, False)])
    <IndexHierarchy: x>
    a                   1024    True
    a                   2048    True
    a                   4096    True
    ...
    b                   1024    True
    <<U1>               <int64> <bool>
    >>> ih.insert_before(sf.ILoc[-1], [('a', 4096, True), ('a', 4096, False)])
    <IndexHierarchy: x>
    a                   1024    True
    a                   2048    True
    a                   2048    False
...
IndexHierarchy.is\_sorted(*\**, *ascending=True*, *kind='mergesort'*, *key=None*)[#](#static_frame.IndexHierarchy.is_sorted "Link to this definition")
...
:   Return the mean along the specified axis.
    ...
    <int64>                           <int64> <int64>
    >>> ih.mean()
    NotImplementedError('<function mean at 0x7b05262538a0> for IndexHierarchy is not defined; convert to `Frame`.')
    ```
...
:   Return the median along the specified axis.
    ...
    <int64>                           <int64> <int64>
    >>> ih.median()
    NotImplementedError('<function median at 0x7b0525b7c7d0> for IndexHierarchy is not defined; convert to `Frame`.')
    ```
...
:   Return the product along the specified axis.
    ...
    <int64>                           <int64> <int64>
    >>> ih.prod()
    NotImplementedError('<function prod at 0x7b0526253110> for IndexHierarchy is not defined; convert to `Frame`.')
    ```
...
:   Return the standard deviaton along the specified axis.
    ...
    <int64>                           <int64> <int64>
    >>> ih.std()
    NotImplementedError('functools.partial(<function std at 0x7b0526247cb0>, ddof=0) for IndexHierarchy is not defined; convert to `Frame`.')
    ```
...
:   Sum values along the specified axis.
    ...
    <int64>                           <int64> <int64>
    >>> ih.sum()
    NotImplementedError('<function sum at 0x7b05262522a0> for IndexHierarchy is not defined; convert to `Frame`.')
    ```
...
:   Return the variance along the specified axis.
    ...
    <int64>                           <int64> <int64>
    >>> ih.var()
    NotImplementedError('functools.partial(<function var at 0x7b0526247b70>, ddof=0) for IndexHierarchy is not defined; convert to `Frame`.')
    ```
...
Detail: IndexHierarchy: Attribute](index_hierarchy-attribute.md "previous page")
[next

Detail: IndexHierarchy: Dictionary-Like](index_hierarchy-dictionary_like.md "next page")

On this page

* [`IndexHierarchy.__array__()`](#static_frame.IndexHierarchy.__array__)
* [`IndexHierarchy.__array_ufunc__()`](#static_frame.IndexHierarchy.__array_ufunc__)
* [`IndexHierarchy.__bool__()`](#static_frame.IndexHierarchy.__bool__)
* [`IndexHierarchy.__copy__()`](#static_frame.IndexHierarchy.__copy__)
* [`IndexHierarchy.__deepcopy__()`](#static_frame.IndexHierarchy.__deepcopy__)
* [`IndexHierarchy.__len__()`](#static_frame.IndexHierarchy.__len__)
* [`IndexHierarchy.all()`](#static_frame.IndexHierarchy.all)
* [`IndexHierarchy.any()`](#static_frame.IndexHierarchy.any)
* [`IndexHierarchy.copy()`](#static_frame.IndexHierarchy.copy)
* [`IndexHierarchy.cumprod()`](#static_frame.IndexHierarchy.cumprod)
* [`IndexHierarchy.cumsum()`](#static_frame.IndexHierarchy.cumsum)
* [`IndexHierarchy.difference()`](#static_frame.IndexHierarchy.difference)
* [`IndexHierarchy.dropfalsy()`](#static_frame.IndexHierarchy.dropfalsy)
* [`IndexHierarchy.dropna()`](#static_frame.IndexHierarchy.dropna)
* [`IndexHierarchy.equals()`](#static_frame.IndexHierarchy.equals)
* [`IndexHierarchy.fillfalsy()`](#static_frame.IndexHierarchy.fillfalsy)
* [`IndexHierarchy.fillna()`](#static_frame.IndexHierarchy.fillna)
* [`IndexHierarchy.flat()`](#static_frame.IndexHierarchy.flat)
* [`IndexHierarchy.head()`](#static_frame.IndexHierarchy.head)
* [`IndexHierarchy.iloc_searchsorted()`](#static_frame.IndexHierarchy.iloc_searchsorted)
* [`IndexHierarchy.index_at_depth()`](#static_frame.IndexHierarchy.index_at_depth)
* [`IndexHierarchy.indexer_at_depth()`](#static_frame.IndexHierarchy.indexer_at_depth)
* [`IndexHierarchy.insert_after()`](#static_frame.IndexHierarchy.insert_after)
* [`IndexHierarchy.insert_before()`](#static_frame.IndexHierarchy.insert_before)
* [`IndexHierarchy.intersection()`](#static_frame.IndexHierarchy.intersection)
* [`IndexHierarchy.is_sorted()`](#static_frame.IndexHierarchy.is_sorted)
* [`IndexHierarchy.isfalsy()`](#static_frame.IndexHierarchy.isfalsy)
* [`IndexHierarchy.isin()`](#static_frame.IndexHierarchy.isin)
* [`IndexHierarchy.isna()`](#static_frame.IndexHierarchy.isna)
* [`IndexHierarchy.label_widths_at_depth()`](#static_frame.IndexHierarchy.label_widths_at_depth)
* [`IndexHierarchy.level_add()`](#static_frame.IndexHierarchy.level_add)
* [`IndexHierarchy.level_drop()`](#static_frame.IndexHierarchy.level_drop)
* [`IndexHierarchy.loc_searchsorted()`](#static_frame.IndexHierarchy.loc_searchsorted)
* [`IndexHierarchy.loc_to_iloc()`](#static_frame.IndexHierarchy.loc_to_iloc)
* [`IndexHierarchy.max()`](#static_frame.IndexHierarchy.max)
* [`IndexHierarchy.mean()`](#static_frame.IndexHierarchy.mean)
* [`IndexHierarchy.median()`](#static_frame.IndexHierarchy.median)
* [`IndexHierarchy.min()`](#static_frame.IndexHierarchy.min)
* [`IndexHierarchy.notfalsy()`](#static_frame.IndexHierarchy.notfalsy)
* [`IndexHierarchy.notna()`](#static_frame.IndexHierarchy.notna)
* [`IndexHierarchy.prod()`](#static_frame.IndexHierarchy.prod)
* [`IndexHierarchy.rehierarch()`](#static_frame.IndexHierarchy.rehierarch)
* [`IndexHierarchy.relabel()`](#static_frame.IndexHierarchy.relabel)
* [`IndexHierarchy.relabel_at_depth()`](#static_frame.IndexHierarchy.relabel_at_depth)
* [`IndexHierarchy.rename()`](#static_frame.IndexHierarchy.rename)
* [`IndexHierarchy.roll()`](#static_frame.IndexHierarchy.roll)
* [`IndexHierarchy.sample()`](#static_frame.IndexHierarchy.sample)
* [`IndexHierarchy.sort()`](#static_frame.IndexHierarchy.sort)
* [`IndexHierarchy.std()`](#static_frame.IndexHierarchy.std)
* [`IndexHierarchy.sum()`](#static_frame.IndexHierarchy.sum)
* [`IndexHierarchy.tail()`](#static_frame.IndexHierarchy.tail)
* [`IndexHierarchy.union()`](#static_frame.IndexHierarchy.union)
* [`IndexHierarchy.unique()`](#static_frame.IndexHierarchy.unique)
* [`IndexHierarchy.values_at_depth()`](#static_frame.IndexHierarchy.values_at_depth)
* [`IndexHierarchy.var()`](#static_frame.IndexHierarchy.var)
