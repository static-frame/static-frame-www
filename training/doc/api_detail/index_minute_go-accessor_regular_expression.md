...
* Detail: IndexMinuteGO: Accessor Regular Expression
* [View page source](../_sources/api_detail/index_minute_go-accessor_regular_expression.rst.txt)

[Previous](index_minute_go-accessor_string.html "Detail: IndexMinuteGO: Accessor String")
[Next](index_minute_go-accessor_hashlib.html "Detail: IndexMinuteGO: Accessor Hashlib")

---

# Detail: IndexMinuteGO: Accessor Regular Expression[](#detail-indexminutego-accessor-regular-expression "Link to this heading")

[Overview: IndexMinuteGO: Accessor Regular Expression](../api_overview/index_minute_go-accessor_regular_expression.html#api-overview-indexminutego-accessor-regular-expression)

IndexMinuteGO.via\_re(*pattern*, *flags).search(pos*, *endpos*)
...
IndexMinuteGO.via\_re(*pattern*, *flags).match(pos*, *endpos*)
:   via\_re *= <function Index.via\_re>*
...
IndexMinuteGO.via\_re(*pattern*, *flags).fullmatch(pos*, *endpos*)
:   via\_re *= <function Index.via\_re>*
...
IndexMinuteGO.via\_re(*pattern*, *flags).split(maxsplit*)
:   via\_re *= <function Index.via\_re>*
...
IndexMinuteGO.via\_re(*pattern*, *flags).findall(pos*, *endpos*)
:   via\_re *= <function Index.via\_re>*
...
IndexMinuteGO.via\_re(*pattern*, *flags).sub(repl*, *count*)
:   via\_re *= <function Index.via\_re>*
...
IndexMinuteGO.via\_re(*pattern*, *flags).subn(repl*, *count*)
:   via\_re *= <function Index.via\_re>*
