...
Detail: CallGuard: Method](call_guard-method.md "previous page")
[next

Detail: ClinicResult: Exporter](clinic_result-exporter.md "next page")

On this page

* [`ClinicResult.__init__()`](#static_frame.ClinicResult.__init__)
