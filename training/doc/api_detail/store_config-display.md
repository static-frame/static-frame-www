...
Detail: StoreConfig: Method](store_config-method.md "previous page")
[next

Detail: StoreFilter: Constructor](store_filter-constructor.md "next page")

On this page

* [`StoreConfig.interface`](#StoreConfig.interface)
* [`StoreConfig.__repr__()`](#static_frame.StoreConfig.__repr__)
* [`StoreConfig.__str__()`](#static_frame.StoreConfig.__str__)
