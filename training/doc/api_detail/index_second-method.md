...
IndexSecond.insert\_after(*key*, *labels*, */*)[#](#static_frame.IndexSecond.insert_after "Link to this definition")
:   ```
    >>> ix = sf.IndexSecond(('1517-04-01', '1517-12-31', '1517-06-30'))
    >>> ix
    <IndexSecond>
...
IndexSecond.insert\_before(*key*, *labels*, */*)[#](#static_frame.IndexSecond.insert_before "Link to this definition")
:   ```
    >>> ix = sf.IndexSecond(('1517-04-01', '1517-12-31', '1517-06-30'))
    >>> ix
    <IndexSecond>
...
Detail: IndexSecond: Attribute](index_second-attribute.md "previous page")
[next

Detail: IndexSecond: Dictionary-Like](index_second-dictionary_like.md "next page")

On this page

* [`IndexSecond.__array__()`](#static_frame.IndexSecond.__array__)
* [`IndexSecond.__array_ufunc__()`](#static_frame.IndexSecond.__array_ufunc__)
* [`IndexSecond.__bool__()`](#static_frame.IndexSecond.__bool__)
* [`IndexSecond.__copy__()`](#static_frame.IndexSecond.__copy__)
* [`IndexSecond.__deepcopy__()`](#static_frame.IndexSecond.__deepcopy__)
* [`IndexSecond.__len__()`](#static_frame.IndexSecond.__len__)
* [`IndexSecond.all()`](#static_frame.IndexSecond.all)
* [`IndexSecond.any()`](#static_frame.IndexSecond.any)
* [`IndexSecond.astype()`](#static_frame.IndexSecond.astype)
* [`IndexSecond.copy()`](#static_frame.IndexSecond.copy)
* [`IndexSecond.cumprod()`](#static_frame.IndexSecond.cumprod)
* [`IndexSecond.cumsum()`](#static_frame.IndexSecond.cumsum)
* [`IndexSecond.difference()`](#static_frame.IndexSecond.difference)
* [`IndexSecond.dropfalsy()`](#static_frame.IndexSecond.dropfalsy)
* [`IndexSecond.dropna()`](#static_frame.IndexSecond.dropna)
* [`IndexSecond.equals()`](#static_frame.IndexSecond.equals)
* [`IndexSecond.fillfalsy()`](#static_frame.IndexSecond.fillfalsy)
* [`IndexSecond.fillna()`](#static_frame.IndexSecond.fillna)
* [`IndexSecond.head()`](#static_frame.IndexSecond.head)
* [`IndexSecond.iloc_searchsorted()`](#static_frame.IndexSecond.iloc_searchsorted)
* [`IndexSecond.insert_after()`](#static_frame.IndexSecond.insert_after)
* [`IndexSecond.insert_before()`](#static_frame.IndexSecond.insert_before)
...
* [`IndexSecond.label_widths_at_depth()`](#static_frame.IndexSecond.label_widths_at_depth)
* [`IndexSecond.level_add()`](#static_frame.IndexSecond.level_add)
* [`IndexSecond.loc_searchsorted()`](#static_frame.IndexSecond.loc_searchsorted)
* [`IndexSecond.loc_to_iloc()`](#static_frame.IndexSecond.loc_to_iloc)
* [`IndexSecond.max()`](#static_frame.IndexSecond.max)
* [`IndexSecond.mean()`](#static_frame.IndexSecond.mean)
* [`IndexSecond.median()`](#static_frame.IndexSecond.median)
* [`IndexSecond.min()`](#static_frame.IndexSecond.min)
* [`IndexSecond.notfalsy()`](#static_frame.IndexSecond.notfalsy)
* [`IndexSecond.notna()`](#static_frame.IndexSecond.notna)
* [`IndexSecond.prod()`](#static_frame.IndexSecond.prod)
* [`IndexSecond.relabel()`](#static_frame.IndexSecond.relabel)
* [`IndexSecond.rename()`](#static_frame.IndexSecond.rename)
* [`IndexSecond.roll()`](#static_frame.IndexSecond.roll)
* [`IndexSecond.sample()`](#static_frame.IndexSecond.sample)
* [`IndexSecond.sort()`](#static_frame.IndexSecond.sort)
* [`IndexSecond.std()`](#static_frame.IndexSecond.std)
* [`IndexSecond.sum()`](#static_frame.IndexSecond.sum)
* [`IndexSecond.tail()`](#static_frame.IndexSecond.tail)
* [`IndexSecond.union()`](#static_frame.IndexSecond.union)
* [`IndexSecond.unique()`](#static_frame.IndexSecond.unique)
* [`IndexSecond.values_at_depth()`](#static_frame.IndexSecond.values_at_depth)
* [`IndexSecond.var()`](#static_frame.IndexSecond.var)
