...
Detail: Series: Constructor](series-constructor.md "previous page")
[next

Detail: Series: Attribute](series-attribute.md "next page")

On this page

* [`Series.to_frame()`](#static_frame.Series.to_frame)
* [`Series.to_frame_go()`](#static_frame.Series.to_frame_go)
* [`Series.to_frame_he()`](#static_frame.Series.to_frame_he)
* [`Series.to_html()`](#static_frame.Series.to_html)
* [`Series.to_html_datatables()`](#static_frame.Series.to_html_datatables)
* [`Series.to_pairs()`](#static_frame.Series.to_pairs)
* [`Series.to_pandas()`](#static_frame.Series.to_pandas)
* [`Series.to_series_he()`](#static_frame.Series.to_series_he)
* [`Series.to_visidata()`](#static_frame.Series.to_visidata)
