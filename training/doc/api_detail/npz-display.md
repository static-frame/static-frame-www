...
Detail: NPZ: Method](npz-method.md "previous page")
[next

Detail: NPY: Constructor](npy-constructor.md "next page")

On this page

* [`NPZ.interface`](#NPZ.interface)
* [`NPZ.__repr__()`](#static_frame.NPZ.__repr__)
* [`NPZ.__str__()`](#static_frame.NPZ.__str__)
