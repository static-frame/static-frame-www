...
* [View page source](../_sources/api_detail/index_year_month-exporter.rst.txt)

[Previous](index_year_month-constructor.html "Detail: IndexYearMonth: Constructor")
[Next](index_year_month-attribute.html "Detail: IndexYearMonth: Attribute")

---

# Detail: IndexYearMonth: Exporter[](#detail-indexyearmonth-exporter "Link to this heading")

[Overview: IndexYearMonth: Exporter](../api_overview/index_year_month-exporter.html#api-overview-indexyearmonth-exporter)

IndexYearMonth.to\_html(*config=None*, */*, *\**, *style\_config=<static\_frame.core.style\_config.StyleConfig object>*)[](#static_frame.IndexYearMonth.to_html "Link to this definition")
...
IndexYearMonth.to\_html\_datatables(*fp=None*, */*, *\**, *show=True*, *config=None*)[](#static_frame.IndexYearMonth.to_html_datatables "Link to this definition")
...
IndexYearMonth.to\_pandas()[[source]](../_modules/static_frame/core/index_datetime.html#IndexYearMonth.to_pandas)[](#static_frame.IndexYearMonth.to_pandas "Link to this definition")
...
IndexYearMonth.to\_series()[](#static_frame.IndexYearMonth.to_series "Link to this definition")
