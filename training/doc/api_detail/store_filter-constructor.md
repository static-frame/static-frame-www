...
Detail: StoreConfig: Display](store_config-display.md "previous page")
[next

Detail: StoreFilter: Exporter](store_filter-exporter.md "next page")

On this page

* [`StoreFilter.__init__()`](#static_frame.StoreFilter.__init__)
* [`StoreFilter.from_type_filter_array()`](#static_frame.StoreFilter.from_type_filter_array)
* [`StoreFilter.from_type_filter_element()`](#static_frame.StoreFilter.from_type_filter_element)
