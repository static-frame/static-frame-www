...
[Overview: IndexMillisecondGO: Method](../api_overview/index_millisecond_go-method.md#api-overview-indexmillisecondgo-method)

IndexMillisecondGO.\_\_array\_\_(*dtype=None*, *copy=None*)[#](#static_frame.IndexMillisecondGO.__array__ "Link to this definition")
...
IndexMillisecondGO.\_\_bool\_\_()[#](#static_frame.IndexMillisecondGO.__bool__ "Link to this definition")
...
:   Perform difference with another Index, container, or NumPy array. Retains order.
    ...
    1517-06-30T00:00:00.000
    <datetime64[ms]>
    >>> ix2 = sf.IndexMillisecondGO(('2022-04-01', '2021-12-31', '2018-06-30'))
    >>> ix2
    <IndexMillisecondGO>
...
IndexMillisecondGO.insert\_after(*key*, *labels*, */*)[#](#static_frame.IndexMillisecondGO.insert_after "Link to this definition")
:   ```
    >>> ix = sf.IndexMillisecondGO(('1517-04-01', '1517-12-31', '1517-06-30'))
    >>> ix
    <IndexMillisecondGO>
...
IndexMillisecondGO.insert\_before(*key*, *labels*, */*)[#](#static_frame.IndexMillisecondGO.insert_before "Link to this definition")
:   ```
    >>> ix = sf.IndexMillisecondGO(('1517-04-01', '1517-12-31', '1517-06-30'))
    >>> ix
    <IndexMillisecondGO>
...
IndexMillisecondGO.is\_sorted(*\**, *ascending=True*, *kind='mergesort'*, *key=None*)[#](#static_frame.IndexMillisecondGO.is_sorted "Link to this definition")
:   Return True if this Index is sorted according to the specified parameters.
    ...
    ```
    >>> ix = sf.IndexMillisecondGO(('2022-04-01', '2021-12-31', '2018-06-30'))
    >>> ix
    <IndexMillisecondGO>
    2022-04-01T00:00:00.000
    2021-12-31T00:00:00.000
...
[IndexMillisecondGO](index_millisecond_go.md#api-detail-indexmillisecondgo): [Constructor](index_millisecond_go-constructor.md#api-detail-indexmillisecondgo-constructor) | [Exporter](index_millisecond_go-exporter.md#api-detail-indexmillisecondgo-exporter) | [Attribute](index_millisecond_go-attribute.md#api-detail-indexmillisecondgo-attribute) | [Method](#api-detail-indexmillisecondgo-method) | [Dictionary-Like](index_millisecond_go-dictionary_like.md#api-detail-indexmillisecondgo-dictionary-like) | [Display](index_millisecond_go-display.md#api-detail-indexmillisecondgo-display) | [Selector](index_millisecond_go-selector.md#api-detail-indexmillisecondgo-selector) | [Iterator](index_millisecond_go-iterator.md#api-detail-indexmillisecondgo-iterator) | [Operator Binary](index_millisecond_go-operator_binary.md#api-detail-indexmillisecondgo-operator-binary) | [Operator Unary](index_millisecond_go-operator_unary.md#api-detail-indexmillisecondgo-operator-unary) | [Accessor Values](index_millisecond_go-accessor_values.md#api-detail-indexmillisecondgo-accessor-values) | [Accessor Datetime](index_millisecond_go-accessor_datetime.md#api-detail-indexmillisecondgo-accessor-datetime) | [Accessor String](index_millisecond_go-accessor_string.md#api-detail-indexmillisecondgo-accessor-string) | [Accessor Regular Expression](index_millisecond_go-accessor_regular_expression.md#api-detail-indexmillisecondgo-accessor-regular-expression) | [Accessor Hashlib](index_millisecond_go-accessor_hashlib.md#api-detail-indexmillisecondgo-accessor-hashlib) | [Accessor Type Clinic](index_millisecond_go-accessor_type_clinic.md#api-detail-indexmillisecondgo-accessor-type-clinic)

[previous

Detail: IndexMillisecondGO: Attribute](index_millisecond_go-attribute.md "previous page")
[next

Detail: IndexMillisecondGO: Dictionary-Like](index_millisecond_go-dictionary_like.md "next page")

On this page

* [`IndexMillisecondGO.__array__()`](#static_frame.IndexMillisecondGO.__array__)
* [`IndexMillisecondGO.__array_ufunc__()`](#static_frame.IndexMillisecondGO.__array_ufunc__)
* [`IndexMillisecondGO.__bool__()`](#static_frame.IndexMillisecondGO.__bool__)
* [`IndexMillisecondGO.__copy__()`](#static_frame.IndexMillisecondGO.__copy__)
* [`IndexMillisecondGO.__deepcopy__()`](#static_frame.IndexMillisecondGO.__deepcopy__)
* [`IndexMillisecondGO.__len__()`](#static_frame.IndexMillisecondGO.__len__)
* [`IndexMillisecondGO.all()`](#static_frame.IndexMillisecondGO.all)
* [`IndexMillisecondGO.any()`](#static_frame.IndexMillisecondGO.any)
* [`IndexMillisecondGO.append()`](#static_frame.IndexMillisecondGO.append)
* [`IndexMillisecondGO.astype()`](#static_frame.IndexMillisecondGO.astype)
* [`IndexMillisecondGO.copy()`](#static_frame.IndexMillisecondGO.copy)
* [`IndexMillisecondGO.cumprod()`](#static_frame.IndexMillisecondGO.cumprod)
* [`IndexMillisecondGO.cumsum()`](#static_frame.IndexMillisecondGO.cumsum)
* [`IndexMillisecondGO.difference()`](#static_frame.IndexMillisecondGO.difference)
* [`IndexMillisecondGO.dropfalsy()`](#static_frame.IndexMillisecondGO.dropfalsy)
* [`IndexMillisecondGO.dropna()`](#static_frame.IndexMillisecondGO.dropna)
* [`IndexMillisecondGO.equals()`](#static_frame.IndexMillisecondGO.equals)
* [`IndexMillisecondGO.extend()`](#static_frame.IndexMillisecondGO.extend)
* [`IndexMillisecondGO.fillfalsy()`](#static_frame.IndexMillisecondGO.fillfalsy)
* [`IndexMillisecondGO.fillna()`](#static_frame.IndexMillisecondGO.fillna)
* [`IndexMillisecondGO.head()`](#static_frame.IndexMillisecondGO.head)
* [`IndexMillisecondGO.iloc_searchsorted()`](#static_frame.IndexMillisecondGO.iloc_searchsorted)
* [`IndexMillisecondGO.insert_after()`](#static_frame.IndexMillisecondGO.insert_after)
* [`IndexMillisecondGO.insert_before()`](#static_frame.IndexMillisecondGO.insert_before)
* [`IndexMillisecondGO.intersection()`](#static_frame.IndexMillisecondGO.intersection)
* [`IndexMillisecondGO.is_sorted()`](#static_frame.IndexMillisecondGO.is_sorted)
* [`IndexMillisecondGO.isfalsy()`](#static_frame.IndexMillisecondGO.isfalsy)
* [`IndexMillisecondGO.isin()`](#static_frame.IndexMillisecondGO.isin)
* [`IndexMillisecondGO.isna()`](#static_frame.IndexMillisecondGO.isna)
* [`IndexMillisecondGO.label_widths_at_depth()`](#static_frame.IndexMillisecondGO.label_widths_at_depth)
* [`IndexMillisecondGO.level_add()`](#static_frame.IndexMillisecondGO.level_add)
* [`IndexMillisecondGO.loc_searchsorted()`](#static_frame.IndexMillisecondGO.loc_searchsorted)
* [`IndexMillisecondGO.loc_to_iloc()`](#static_frame.IndexMillisecondGO.loc_to_iloc)
* [`IndexMillisecondGO.max()`](#static_frame.IndexMillisecondGO.max)
* [`IndexMillisecondGO.mean()`](#static_frame.IndexMillisecondGO.mean)
* [`IndexMillisecondGO.median()`](#static_frame.IndexMillisecondGO.median)
* [`IndexMillisecondGO.min()`](#static_frame.IndexMillisecondGO.min)
* [`IndexMillisecondGO.notfalsy()`](#static_frame.IndexMillisecondGO.notfalsy)
* [`IndexMillisecondGO.notna()`](#static_frame.IndexMillisecondGO.notna)
* [`IndexMillisecondGO.prod()`](#static_frame.IndexMillisecondGO.prod)
* [`IndexMillisecondGO.relabel()`](#static_frame.IndexMillisecondGO.relabel)
* [`IndexMillisecondGO.rename()`](#static_frame.IndexMillisecondGO.rename)
* [`IndexMillisecondGO.roll()`](#static_frame.IndexMillisecondGO.roll)
* [`IndexMillisecondGO.sample()`](#static_frame.IndexMillisecondGO.sample)
* [`IndexMillisecondGO.sort()`](#static_frame.IndexMillisecondGO.sort)
* [`IndexMillisecondGO.std()`](#static_frame.IndexMillisecondGO.std)
* [`IndexMillisecondGO.sum()`](#static_frame.IndexMillisecondGO.sum)
* [`IndexMillisecondGO.tail()`](#static_frame.IndexMillisecondGO.tail)
* [`IndexMillisecondGO.union()`](#static_frame.IndexMillisecondGO.union)
* [`IndexMillisecondGO.unique()`](#static_frame.IndexMillisecondGO.unique)
* [`IndexMillisecondGO.values_at_depth()`](#static_frame.IndexMillisecondGO.values_at_depth)
* [`IndexMillisecondGO.var()`](#static_frame.IndexMillisecondGO.var)
