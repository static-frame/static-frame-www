...
Detail: FrameGO: Operator Binary](frame_go-operator_binary.md "previous page")
[next

Detail: FrameGO: Accessor Values](frame_go-accessor_values.md "next page")

On this page

* [`FrameGO.__abs__()`](#static_frame.FrameGO.__abs__)
* [`FrameGO.__invert__()`](#static_frame.FrameGO.__invert__)
* [`FrameGO.__neg__()`](#static_frame.FrameGO.__neg__)
* [`FrameGO.__pos__()`](#static_frame.FrameGO.__pos__)
* [`FrameGO.abs()`](#static_frame.FrameGO.abs)
