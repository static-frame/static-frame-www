...
* [View page source](../_sources/api_detail/frame_go-operator_unary.rst.txt)

[Previous](frame_go-operator_binary.html "Detail: FrameGO: Operator Binary")
[Next](frame_go-accessor_values.html "Detail: FrameGO: Accessor Values")

---

# Detail: FrameGO: Operator Unary[](#detail-framego-operator-unary "Link to this heading")

[Overview: FrameGO: Operator Unary](../api_overview/frame_go-operator_unary.html#api-overview-framego-operator-unary)

FrameGO.\_\_abs\_\_()[](#static_frame.FrameGO.__abs__ "Link to this definition")
:   ```
...
FrameGO.\_\_invert\_\_()[](#static_frame.FrameGO.__invert__ "Link to this definition")
:   ```
...
FrameGO.\_\_neg\_\_()[](#static_frame.FrameGO.__neg__ "Link to this definition")
:   ```
    >>> f = sf.FrameGO.from_fields(((10, -2, 0, 0), (8, -3, 8, 0), (1, 0, 9, 12)), index=('p', 'q', 'r', 's'), columns=('a', 'b', 'c'), name='x')
    >>> f
    <FrameGO: x>
...
FrameGO.\_\_pos\_\_()[](#static_frame.FrameGO.__pos__ "Link to this definition")
:   ```
    >>> f = sf.FrameGO.from_fields(((10, -2, 0, 0), (8, -3, 8, 0), (1, 0, 9, 12)), index=('p', 'q', 'r', 's'), columns=('a', 'b', 'c'), name='x')
    >>> f
    <FrameGO: x>
...
FrameGO.abs()[](#static_frame.FrameGO.abs "Link to this definition")
:   ```
    >>> f = sf.FrameGO.from_fields(((10, -2, 0, 0), (8, -3, 8, 0), (1, 0, 9, 12)), index=('p', 'q', 'r', 's'), columns=('a', 'b', 'c'), name='x')
    >>> f
    <FrameGO: x>
