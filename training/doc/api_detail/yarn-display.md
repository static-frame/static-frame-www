...
:   A Frame documenting the interface of this class.
    ...
    <Index: signature>
    __init__(series, /, *, index, ind... Yarn     Constructor          Args: series: An ...
    from_buses(buses, /, *, name, ret... Yarn     Constructor          Return a Yarn fro...
    from_concat(containers, /, *, ind... Yarn     Constructor          Concatenate multi...
    ...
    to_zip_csv(fp, /, *, config, comp... Yarn     Exporter             Write the complet...
    to_zip_npy(fp, /, *, config, comp... Yarn     Exporter             Write the complet...
    to_zip_npz(fp, /, *, config, comp... Yarn     Exporter             Write the complet...
    to_zip_parquet(fp, /, *, config, ... Yarn     Exporter             Write the complet...
    to_zip_pickle(fp, /, *, config, c... Yarn     Exporter             Write the complet...
    to_zip_tsv(fp, /, *, config, comp... Yarn     Exporter             Write the complet...
    ...
    via_type_clinic.check(hint, /, *,... Yarn     Accessor Type Clinic Given a hint (a t...
    via_type_clinic.warn(hint, /, *, ... Yarn     Accessor Type Clinic Given a hint (a t...
