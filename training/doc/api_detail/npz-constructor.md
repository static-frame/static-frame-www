...
Detail: IndexAutoConstructorFactory: Display](index_auto_constructor_factory-display.md "previous page")
[next

Detail: NPZ: Attribute](npz-attribute.md "next page")

On this page

* [`NPZ.__init__()`](#static_frame.NPZ.__init__)
* [`NPZ.from_arrays()`](#static_frame.NPZ.from_arrays)
* [`NPZ.from_frames()`](#static_frame.NPZ.from_frames)
