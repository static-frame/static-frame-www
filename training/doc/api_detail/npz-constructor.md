...
NPZ.from\_frames(*frames*, *\**, *include\_index=True*, *include\_columns=True*, *axis=0*, *union=True*, *name=None*, *fill\_value=nan*)[](#static_frame.NPZ.from_frames "Link to this definition")
