...
* Detail: IndexDate: Accessor Regular Expression
* [View page source](../_sources/api_detail/index_date-accessor_regular_expression.rst.txt)

[Previous](index_date-accessor_string.html "Detail: IndexDate: Accessor String")
[Next](index_date-accessor_hashlib.html "Detail: IndexDate: Accessor Hashlib")

---

# Detail: IndexDate: Accessor Regular Expression[](#detail-indexdate-accessor-regular-expression "Link to this heading")

[Overview: IndexDate: Accessor Regular Expression](../api_overview/index_date-accessor_regular_expression.html#api-overview-indexdate-accessor-regular-expression)

IndexDate.via\_re(*pattern*, *flags).search(pos*, *endpos*)
...
IndexDate.via\_re(*pattern*, *flags).match(pos*, *endpos*)
:   via\_re *= <function Index.via\_re>*
...
IndexDate.via\_re(*pattern*, *flags).fullmatch(pos*, *endpos*)
:   via\_re *= <function Index.via\_re>*
...
IndexDate.via\_re(*pattern*, *flags).split(maxsplit*)
:   via\_re *= <function Index.via\_re>*
...
IndexDate.via\_re(*pattern*, *flags).findall(pos*, *endpos*)
:   via\_re *= <function Index.via\_re>*
...
IndexDate.via\_re(*pattern*, *flags).sub(repl*, *count*)
:   via\_re *= <function Index.via\_re>*
...
IndexDate.via\_re(*pattern*, *flags).subn(repl*, *count*)
:   via\_re *= <function Index.via\_re>*
