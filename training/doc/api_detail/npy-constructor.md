...
Detail: NPZ: Display](npz-display.md "previous page")
[next

Detail: NPY: Attribute](npy-attribute.md "next page")

On this page

* [`NPY.__init__()`](#static_frame.NPY.__init__)
* [`NPY.from_arrays()`](#static_frame.NPY.from_arrays)
* [`NPY.from_frames()`](#static_frame.NPY.from_frames)
