...
:   Return a shallow copy of this [`Bus`](bus-selector.md#Bus "Bus").
...
Detail: Bus: Attribute](bus-attribute.md "previous page")
[next

Detail: Bus: Dictionary-Like](bus-dictionary_like.md "next page")

On this page

* [`Bus.__bool__()`](#static_frame.Bus.__bool__)
* [`Bus.__copy__()`](#static_frame.Bus.__copy__)
* [`Bus.__len__()`](#static_frame.Bus.__len__)
* [`Bus.copy()`](#static_frame.Bus.copy)
* [`Bus.equals()`](#static_frame.Bus.equals)
* [`Bus.head()`](#static_frame.Bus.head)
* [`Bus.rehierarch()`](#static_frame.Bus.rehierarch)
* [`Bus.reindex()`](#static_frame.Bus.reindex)
* [`Bus.relabel()`](#static_frame.Bus.relabel)
* [`Bus.relabel_flat()`](#static_frame.Bus.relabel_flat)
* [`Bus.relabel_level_add()`](#static_frame.Bus.relabel_level_add)
* [`Bus.relabel_level_drop()`](#static_frame.Bus.relabel_level_drop)
* [`Bus.rename()`](#static_frame.Bus.rename)
* [`Bus.roll()`](#static_frame.Bus.roll)
* [`Bus.shift()`](#static_frame.Bus.shift)
* [`Bus.sort_index()`](#static_frame.Bus.sort_index)
* [`Bus.sort_values()`](#static_frame.Bus.sort_values)
* [`Bus.tail()`](#static_frame.Bus.tail)
* [`Bus.unpersist()`](#static_frame.Bus.unpersist)
