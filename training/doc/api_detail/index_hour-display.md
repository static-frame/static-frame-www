...
:   A Frame documenting the interface of this class.
    ...
    from_difference(*others)             IndexHour Constructor          Construct a new Ind…
    from_intersection(*others)           IndexHour Constructor          Construct a new Ind…
    from_labels(labels, /, *, name)      IndexHour Constructor          Construct an Index …
    from_pandas(value, /)                IndexHour Constructor          Given a Pandas inde…
    from_union(*others)                  IndexHour Constructor          Construct a new Ind…
    to_html(config, /, *, style_config)  IndexHour Exporter             Return an HTML tabl…
    to_html_datatables(fp, /, *, show, … IndexHour Exporter             Return a complete H…
    to_pandas()                          IndexHour Exporter             Return a Pandas Ind…
    to_series()                          IndexHour Exporter             Return a Series wit…
    to_visidata()                        IndexHour Exporter             Open an interactive…
    STATIC                               IndexHour Attribute            Returns True when t…
    depth                                IndexHour Attribute            int([x]) -> integer…
    dtype                                IndexHour Attribute            Return the dtype of…
    index_types                          IndexHour Attribute            Return a Series of …
    memory                               IndexHour Attribute            A MemoryDisplay, pr…
    mloc                                 IndexHour Attribute            The memory location…
    …                                    …         …                    …
    via_re(pattern, flags, /).sub(repl,… IndexHour Accessor Regular Ex… Return the string o…
    via_re(pattern, flags, /).subn(repl… IndexHour Accessor Regular Ex… Perform the same op…
    via_hashlib(*, include_name, includ… IndexHour Accessor Hashlib     Return the byte sig…
    via_hashlib(*, include_name, includ… IndexHour Accessor Hashlib
    via_hashlib(*, include_name, includ… IndexHour Accessor Hashlib
    via_hashlib(*, include_name, includ… IndexHour Accessor Hashlib
    via_hashlib(*, include_name, includ… IndexHour Accessor Hashlib
    via_hashlib(*, include_name, includ… IndexHour Accessor Hashlib
    ...
    via_hashlib(*, include_name, includ… IndexHour Accessor Hashlib
    via_hashlib(*, include_name, includ… IndexHour Accessor Hashlib
    via_type_clinic.to_hint()            IndexHour Accessor Type Clinic Return the type hin…
    via_type_clinic.check(hint, /, *, f… IndexHour Accessor Type Clinic Given a hint (a typ…
    via_type_clinic.warn(hint, /, *, fa… IndexHour Accessor Type Clinic Given a hint (a typ…
    via_type_clinic.__call__(hint, /, *… IndexHour Accessor Type Clinic Given a hint (a typ…
    via_type_clinic.__repr__()           IndexHour Accessor Type Clinic Return a compact st…
    <<U91>                               <<U9>     <<U27>               <<U81>
    ```
...
Detail: IndexHour: Dictionary-Like](index_hour-dictionary_like.md "previous page")
[next

Detail: IndexHour: Selector](index_hour-selector.md "next page")

On this page

* [`IndexHour.interface`](#IndexHour.interface)
* [`IndexHour.__repr__()`](#static_frame.IndexHour.__repr__)
* [`IndexHour.__str__()`](#static_frame.IndexHour.__str__)
* [`IndexHour.display()`](#static_frame.IndexHour.display)
* [`IndexHour.display_tall()`](#static_frame.IndexHour.display_tall)
* [`IndexHour.display_wide()`](#static_frame.IndexHour.display_wide)
