...
Detail: NPY: Method](npy-method.md "previous page")
[next

Detail: MemoryDisplay: Constructor](memory_display-constructor.md "next page")

On this page

* [`NPY.interface`](#NPY.interface)
* [`NPY.__repr__()`](#static_frame.NPY.__repr__)
* [`NPY.__str__()`](#static_frame.NPY.__str__)
