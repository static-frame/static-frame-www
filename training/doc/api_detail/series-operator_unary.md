...
Detail: Series: Operator Binary](series-operator_binary.md "previous page")
[next

Detail: Series: Accessor Values](series-accessor_values.md "next page")

On this page

* [`Series.__abs__()`](#static_frame.Series.__abs__)
* [`Series.__invert__()`](#static_frame.Series.__invert__)
* [`Series.__neg__()`](#static_frame.Series.__neg__)
* [`Series.__pos__()`](#static_frame.Series.__pos__)
* [`Series.abs()`](#static_frame.Series.abs)
