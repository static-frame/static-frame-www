...
Detail: HLoc: Constructor](hloc-constructor.md "previous page")
[next

Detail: HLoc: Method](hloc-method.md "next page")

On this page

* [`HLoc.STATIC`](#static_frame.HLoc.STATIC)
* [`HLoc.key`](#static_frame.HLoc.key)
