...
* [View page source](../_sources/api_detail/index_microsecond-accessor_datetime.rst.txt)

[Previous](index_microsecond-accessor_values.html "Detail: IndexMicrosecond: Accessor Values")
[Next](index_microsecond-accessor_string.html "Detail: IndexMicrosecond: Accessor String")

---

# Detail: IndexMicrosecond: Accessor Datetime[](#detail-indexmicrosecond-accessor-datetime "Link to this heading")

[Overview: IndexMicrosecond: Accessor Datetime](../api_overview/index_microsecond-accessor_datetime.html#api-overview-indexmicrosecond-accessor-datetime)

IndexMicrosecond.via\_dt.\_\_call\_\_(*\**, *fill\_value*)
:   IndexMicrosecond.via\_dt
...
IndexMicrosecond.via\_dt.year\_month
:   IndexMicrosecond.via\_dt
    :   Interface for applying datetime properties and methods to elements in this container.
...
IndexMicrosecond.via\_dt.year\_quarter
:   IndexMicrosecond.via\_dt
    :   Interface for applying datetime properties and methods to elements in this container.
...
IndexMicrosecond.via\_dt.month
:   IndexMicrosecond.via\_dt
    :   Interface for applying datetime properties and methods to elements in this container.
...
IndexMicrosecond.via\_dt.minute
:   IndexMicrosecond.via\_dt
    :   Interface for applying datetime properties and methods to elements in this container.
...
IndexMicrosecond.via\_dt.second
:   IndexMicrosecond.via\_dt
    :   Interface for applying datetime properties and methods to elements in this container.
...
IndexMicrosecond.via\_dt.weekday
:   IndexMicrosecond.via\_dt
    :   Interface for applying datetime properties and methods to elements in this container.
...
IndexMicrosecond.via\_dt.quarter
:   IndexMicrosecond.via\_dt
    :   Interface for applying datetime properties and methods to elements in this container.
...
IndexMicrosecond.via\_dt.is\_month\_end
:   IndexMicrosecond.via\_dt
    :   Interface for applying datetime properties and methods to elements in this container.
...
IndexMicrosecond.via\_dt.is\_month\_start
:   IndexMicrosecond.via\_dt
    :   Interface for applying datetime properties and methods to elements in this container.
...
IndexMicrosecond.via\_dt.is\_year\_end
:   IndexMicrosecond.via\_dt
    :   Interface for applying datetime properties and methods to elements in this container.
...
IndexMicrosecond.via\_dt.is\_year\_start
:   IndexMicrosecond.via\_dt
    :   Interface for applying datetime properties and methods to elements in this container.
...
IndexMicrosecond.via\_dt.is\_quarter\_end
:   IndexMicrosecond.via\_dt
    :   Interface for applying datetime properties and methods to elements in this container.
...
IndexMicrosecond.via\_dt.is\_quarter\_start
:   IndexMicrosecond.via\_dt
    :   Interface for applying datetime properties and methods to elements in this container.
...
IndexMicrosecond.via\_dt.timetuple
:   IndexMicrosecond.via\_dt
    :   Interface for applying datetime properties and methods to elements in this container.
...
IndexMicrosecond.via\_dt.isoformat(*\**, *sep*, *timespec*)
:   IndexMicrosecond.via\_dt
    :   Interface for applying datetime properties and methods to elements in this container.
...
IndexMicrosecond.via\_dt.fromisoformat
:   IndexMicrosecond.via\_dt
    :   Interface for applying datetime properties and methods to elements in this container.
...
IndexMicrosecond.via\_dt.strftime(*format*)
:   IndexMicrosecond.via\_dt
    :   Interface for applying datetime properties and methods to elements in this container.
...
IndexMicrosecond.via\_dt.strptime(*format*)
:   IndexMicrosecond.via\_dt
    :   Interface for applying datetime properties and methods to elements in this container.
...
IndexMicrosecond.via\_dt.strpdate(*format*)
:   IndexMicrosecond.via\_dt
    :   Interface for applying datetime properties and methods to elements in this container.
