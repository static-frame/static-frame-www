...
* Detail: IndexMicrosecond: Accessor Regular Expression
* [View page source](../_sources/api_detail/index_microsecond-accessor_regular_expression.rst.txt)

[Previous](index_microsecond-accessor_string.html "Detail: IndexMicrosecond: Accessor String")
[Next](index_microsecond-accessor_hashlib.html "Detail: IndexMicrosecond: Accessor Hashlib")

---

# Detail: IndexMicrosecond: Accessor Regular Expression[](#detail-indexmicrosecond-accessor-regular-expression "Link to this heading")

[Overview: IndexMicrosecond: Accessor Regular Expression](../api_overview/index_microsecond-accessor_regular_expression.html#api-overview-indexmicrosecond-accessor-regular-expression)

IndexMicrosecond.via\_re(*pattern*, *flags).search(pos*, *endpos*)
...
IndexMicrosecond.via\_re(*pattern*, *flags).match(pos*, *endpos*)
:   via\_re *= <function Index.via\_re>*
...
IndexMicrosecond.via\_re(*pattern*, *flags).fullmatch(pos*, *endpos*)
:   via\_re *= <function Index.via\_re>*
...
IndexMicrosecond.via\_re(*pattern*, *flags).split(maxsplit*)
:   via\_re *= <function Index.via\_re>*
...
IndexMicrosecond.via\_re(*pattern*, *flags).findall(pos*, *endpos*)
:   via\_re *= <function Index.via\_re>*
...
IndexMicrosecond.via\_re(*pattern*, *flags).sub(repl*, *count*)
:   via\_re *= <function Index.via\_re>*
...
IndexMicrosecond.via\_re(*pattern*, *flags).subn(repl*, *count*)
:   via\_re *= <function Index.via\_re>*
