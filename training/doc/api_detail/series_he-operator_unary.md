...
* [View page source](../_sources/api_detail/series_he-operator_unary.rst.txt)

[Previous](series_he-operator_binary.html "Detail: SeriesHE: Operator Binary")
[Next](series_he-accessor_values.html "Detail: SeriesHE: Accessor Values")

---

# Detail: SeriesHE: Operator Unary[](#detail-serieshe-operator-unary "Link to this heading")

[Overview: SeriesHE: Operator Unary](../api_overview/series_he-operator_unary.html#api-overview-serieshe-operator-unary)

SeriesHE.\_\_abs\_\_()[](#static_frame.SeriesHE.__abs__ "Link to this definition")
:   ```
...
SeriesHE.\_\_invert\_\_()[](#static_frame.SeriesHE.__invert__ "Link to this definition")
:   ```
...
SeriesHE.\_\_neg\_\_()[](#static_frame.SeriesHE.__neg__ "Link to this definition")
:   ```
...
SeriesHE.\_\_pos\_\_()[](#static_frame.SeriesHE.__pos__ "Link to this definition")
:   ```
    >>> s = sf.SeriesHE((10, 2, 8), index=('a', 'b', 'c'))
    >>> s
    <SeriesHE>
...
SeriesHE.abs()[](#static_frame.SeriesHE.abs "Link to this definition")
:   ```
    >>> s = sf.SeriesHE((-2, 8, 19, -2, 8), index=('a', 'b', 'c', 'd', 'e'))
    >>> s
    <SeriesHE>
