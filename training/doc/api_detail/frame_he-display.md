...
:   A Frame documenting the interface of this class.
    ...
    <Index: signature>
    __init__(data, /, *, index, colum... FrameHE  Constructor     Initializer. Args...
    from_arrow(value, /, *, index_dep... FrameHE  Constructor     Realize a Frame f...
    from_clipboard(*, delimiter, inde... FrameHE  Constructor     Create a Frame fr...
    from_concat(frames, /, *, axis, u... FrameHE  Constructor     Concatenate multi...
    from_concat_items(items, /, *, ax... FrameHE  Constructor     Produce a Frame w...
    from_csv(fp, /, *, index_depth, i... FrameHE  Constructor     Specialized versi...
    from_delimited(fp, /, *, delimite... FrameHE  Constructor     Create a Frame fr...
    from_dict(mapping, /, *, index, f... FrameHE  Constructor     Create a Frame fr...
    from_dict_fields(fields, /, *, co... FrameHE  Constructor     Frame constructor...
    from_dict_records(records, /, *, ... FrameHE  Constructor     Frame constructor...
    from_dict_records_items(items, /,... FrameHE  Constructor     Frame constructor...
    from_element(element, /, *, index... FrameHE  Constructor     Create a Frame fr...
    from_element_items(items, /, *, i... FrameHE  Constructor     Create a Frame fr...
    from_elements(elements, /, *, ind... FrameHE  Constructor     Create a Frame fr...
    from_fields(fields, /, *, index, ... FrameHE  Constructor     Frame constructor...
    from_items(pairs, /, *, index, fi... FrameHE  Constructor     Frame constructor...
    from_json_columns(json_data, /, *... FrameHE  Constructor     Frame constructor...
    ...                                  ...      ...             ...
...
Detail: FrameHE: Dictionary-Like](frame_he-dictionary_like.md "previous page")
[next

Detail: FrameHE: Assignment](frame_he-assignment.md "next page")

On this page

* [`FrameHE.interface`](#FrameHE.interface)
* [`FrameHE.__repr__()`](#static_frame.FrameHE.__repr__)
* [`FrameHE.__str__()`](#static_frame.FrameHE.__str__)
* [`FrameHE.display()`](#static_frame.FrameHE.display)
* [`FrameHE.display_tall()`](#static_frame.FrameHE.display_tall)
* [`FrameHE.display_wide()`](#static_frame.FrameHE.display_wide)
