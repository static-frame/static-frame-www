...
IndexYear.insert\_after(*key*, *labels*, */*)[#](#static_frame.IndexYear.insert_after "Link to this definition")
:   ```
    >>> ix = sf.IndexYear(('1517', '1520', '1518'))
    >>> ix
    <IndexYear>
...
IndexYear.insert\_before(*key*, *labels*, */*)[#](#static_frame.IndexYear.insert_before "Link to this definition")
:   ```
    >>> ix = sf.IndexYear(('1517', '1520', '1518'))
    >>> ix
    <IndexYear>
...
Detail: IndexYear: Attribute](index_year-attribute.md "previous page")
[next

Detail: IndexYear: Dictionary-Like](index_year-dictionary_like.md "next page")

On this page

* [`IndexYear.__array__()`](#static_frame.IndexYear.__array__)
* [`IndexYear.__array_ufunc__()`](#static_frame.IndexYear.__array_ufunc__)
* [`IndexYear.__bool__()`](#static_frame.IndexYear.__bool__)
* [`IndexYear.__copy__()`](#static_frame.IndexYear.__copy__)
* [`IndexYear.__deepcopy__()`](#static_frame.IndexYear.__deepcopy__)
* [`IndexYear.__len__()`](#static_frame.IndexYear.__len__)
* [`IndexYear.all()`](#static_frame.IndexYear.all)
* [`IndexYear.any()`](#static_frame.IndexYear.any)
* [`IndexYear.astype()`](#static_frame.IndexYear.astype)
* [`IndexYear.copy()`](#static_frame.IndexYear.copy)
* [`IndexYear.cumprod()`](#static_frame.IndexYear.cumprod)
* [`IndexYear.cumsum()`](#static_frame.IndexYear.cumsum)
* [`IndexYear.difference()`](#static_frame.IndexYear.difference)
* [`IndexYear.dropfalsy()`](#static_frame.IndexYear.dropfalsy)
* [`IndexYear.dropna()`](#static_frame.IndexYear.dropna)
* [`IndexYear.equals()`](#static_frame.IndexYear.equals)
* [`IndexYear.fillfalsy()`](#static_frame.IndexYear.fillfalsy)
* [`IndexYear.fillna()`](#static_frame.IndexYear.fillna)
* [`IndexYear.head()`](#static_frame.IndexYear.head)
* [`IndexYear.iloc_searchsorted()`](#static_frame.IndexYear.iloc_searchsorted)
* [`IndexYear.insert_after()`](#static_frame.IndexYear.insert_after)
* [`IndexYear.insert_before()`](#static_frame.IndexYear.insert_before)
...
* [`IndexYear.label_widths_at_depth()`](#static_frame.IndexYear.label_widths_at_depth)
* [`IndexYear.level_add()`](#static_frame.IndexYear.level_add)
* [`IndexYear.loc_searchsorted()`](#static_frame.IndexYear.loc_searchsorted)
* [`IndexYear.loc_to_iloc()`](#static_frame.IndexYear.loc_to_iloc)
* [`IndexYear.max()`](#static_frame.IndexYear.max)
* [`IndexYear.mean()`](#static_frame.IndexYear.mean)
* [`IndexYear.median()`](#static_frame.IndexYear.median)
* [`IndexYear.min()`](#static_frame.IndexYear.min)
* [`IndexYear.notfalsy()`](#static_frame.IndexYear.notfalsy)
* [`IndexYear.notna()`](#static_frame.IndexYear.notna)
* [`IndexYear.prod()`](#static_frame.IndexYear.prod)
* [`IndexYear.relabel()`](#static_frame.IndexYear.relabel)
* [`IndexYear.rename()`](#static_frame.IndexYear.rename)
* [`IndexYear.roll()`](#static_frame.IndexYear.roll)
* [`IndexYear.sample()`](#static_frame.IndexYear.sample)
* [`IndexYear.sort()`](#static_frame.IndexYear.sort)
* [`IndexYear.std()`](#static_frame.IndexYear.std)
* [`IndexYear.sum()`](#static_frame.IndexYear.sum)
* [`IndexYear.tail()`](#static_frame.IndexYear.tail)
* [`IndexYear.union()`](#static_frame.IndexYear.union)
* [`IndexYear.unique()`](#static_frame.IndexYear.unique)
* [`IndexYear.values_at_depth()`](#static_frame.IndexYear.values_at_depth)
* [`IndexYear.var()`](#static_frame.IndexYear.var)
