...
Detail: NPY: Attribute](npy-attribute.md "previous page")
[next

Detail: NPY: Display](npy-display.md "next page")

On this page

* [`NPY.__enter__()`](#static_frame.NPY.__enter__)
* [`NPY.__exit__()`](#static_frame.NPY.__exit__)
