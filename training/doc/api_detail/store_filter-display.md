...
Detail: StoreFilter: Attribute](store_filter-attribute.md "previous page")
[next

Detail: IndexAutoFactory: Constructor](index_auto_factory-constructor.md "next page")

On this page

* [`StoreFilter.interface`](#StoreFilter.interface)
* [`StoreFilter.__repr__()`](#static_frame.StoreFilter.__repr__)
* [`StoreFilter.__str__()`](#static_frame.StoreFilter.__str__)
