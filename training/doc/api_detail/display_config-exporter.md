...
Detail: DisplayConfig: Constructor](display_config-constructor.md "previous page")
[next

Detail: DisplayConfig: Attribute](display_config-attribute.md "next page")

On this page

* [`DisplayConfig.to_dict()`](#static_frame.DisplayConfig.to_dict)
* [`DisplayConfig.to_display_config()`](#static_frame.DisplayConfig.to_display_config)
* [`DisplayConfig.to_json()`](#static_frame.DisplayConfig.to_json)
* [`DisplayConfig.to_transpose()`](#static_frame.DisplayConfig.to_transpose)
