...
:   A Frame documenting the interface of this class.
    ...
    via_type_clinic.check(hint, /, *,... IndexSecond Accessor Type Clinic Given a hint (a t...
    via_type_clinic.warn(hint, /, *, ... IndexSecond Accessor Type Clinic Given a hint (a t...
