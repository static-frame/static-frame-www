...
:   iter\_series
    ...
    (<Series: (np.str_('x'), np.str_('p'…
    <Index>
    a                                    0
    b                                    1
    <<U1>                                <int64>, <Series: (np.str_('x'), np.str_('q'…
    <Index>
    a                                    2
    b                                    3
    <<U1>                                <int64>, <Series: (np.str_('x'), np.str_('r'…
    <Index>
    a                                    4
    b                                    5
    <<U1>                                <int64>, <Series: (np.str_('v'), np.str_('p'…
    <Index>
    a                                    40
    b                                    41
    <<U1>                                <int64>, <Series: (np.str_('v'), np.str_('q'…
    <Index>
    a                                    42
    b                                    43
    <<U1>                                <int64>, <Series: (np.str_('v'), np.str_('r'…
    <Index>
    a                                    44
    b                                    45
    <<U1>                                <int64>)
...
:   iter\_series\_items
    ...
    (((np.str_('x'), np.str_('p')), <Series: (np.str_('x'), np.str_('p'…
    <Index>
    a                                    0
    b                                    1
    <<U1>                                <int64>), ((np.str_('x'), np.str_('q')), <Series: (np.str_('x'), np.str_('q'…
    <Index>
    a                                    2
    b                                    3
    <<U1>                                <int64>), ((np.str_('x'), np.str_('r')), <Series: (np.str_('x'), np.str_('r'…
    <Index>
    a                                    4
    b                                    5
    <<U1>                                <int64>), ((np.str_('v'), np.str_('p')), <Series: (np.str_('v'), np.str_('p'…
    <Index>
    a                                    40
    b                                    41
    <<U1>                                <int64>), ((np.str_('v'), np.str_('q')), <Series: (np.str_('v'), np.str_('q'…
    <Index>
    a                                    42
    b                                    43
    <<U1>                                <int64>), ((np.str_('v'), np.str_('r')), <Series: (np.str_('v'), np.str_('r'…
    <Index>
    a                                    44
    b                                    45
    <<U1>                                <int64>))
...
:   iter\_tuple
    ...
    v                p     Axis(a=np.int64(40)…
    v                q     -2
    v                r     Axis(a=np.int64(44)…
    <<U1>            <<U1> <object>
    ```
...
Detail: Quilt: Selector](quilt-selector.md "previous page")
[next

Detail: Quilt: Accessor Hashlib](quilt-accessor_hashlib.md "next page")
