...
IndexMinuteGO.insert\_after(*key*, *labels*, */*)[#](#static_frame.IndexMinuteGO.insert_after "Link to this definition")
:   ```
    >>> ix = sf.IndexMinuteGO(('1517-04-01', '1517-12', '1517-06-30'))
    >>> ix
    <IndexMinuteGO>
...
IndexMinuteGO.insert\_before(*key*, *labels*, */*)[#](#static_frame.IndexMinuteGO.insert_before "Link to this definition")
:   ```
    >>> ix = sf.IndexMinuteGO(('1517-04-01', '1517-12', '1517-06-30'))
    >>> ix
    <IndexMinuteGO>
...
Detail: IndexMinuteGO: Attribute](index_minute_go-attribute.md "previous page")
[next

Detail: IndexMinuteGO: Dictionary-Like](index_minute_go-dictionary_like.md "next page")

On this page

* [`IndexMinuteGO.__array__()`](#static_frame.IndexMinuteGO.__array__)
* [`IndexMinuteGO.__array_ufunc__()`](#static_frame.IndexMinuteGO.__array_ufunc__)
* [`IndexMinuteGO.__bool__()`](#static_frame.IndexMinuteGO.__bool__)
* [`IndexMinuteGO.__copy__()`](#static_frame.IndexMinuteGO.__copy__)
* [`IndexMinuteGO.__deepcopy__()`](#static_frame.IndexMinuteGO.__deepcopy__)
* [`IndexMinuteGO.__len__()`](#static_frame.IndexMinuteGO.__len__)
* [`IndexMinuteGO.all()`](#static_frame.IndexMinuteGO.all)
* [`IndexMinuteGO.any()`](#static_frame.IndexMinuteGO.any)
* [`IndexMinuteGO.append()`](#static_frame.IndexMinuteGO.append)
* [`IndexMinuteGO.astype()`](#static_frame.IndexMinuteGO.astype)
* [`IndexMinuteGO.copy()`](#static_frame.IndexMinuteGO.copy)
* [`IndexMinuteGO.cumprod()`](#static_frame.IndexMinuteGO.cumprod)
* [`IndexMinuteGO.cumsum()`](#static_frame.IndexMinuteGO.cumsum)
* [`IndexMinuteGO.difference()`](#static_frame.IndexMinuteGO.difference)
* [`IndexMinuteGO.dropfalsy()`](#static_frame.IndexMinuteGO.dropfalsy)
* [`IndexMinuteGO.dropna()`](#static_frame.IndexMinuteGO.dropna)
* [`IndexMinuteGO.equals()`](#static_frame.IndexMinuteGO.equals)
* [`IndexMinuteGO.extend()`](#static_frame.IndexMinuteGO.extend)
* [`IndexMinuteGO.fillfalsy()`](#static_frame.IndexMinuteGO.fillfalsy)
* [`IndexMinuteGO.fillna()`](#static_frame.IndexMinuteGO.fillna)
...
* [`IndexMinuteGO.insert_after()`](#static_frame.IndexMinuteGO.insert_after)
* [`IndexMinuteGO.insert_before()`](#static_frame.IndexMinuteGO.insert_before)
...
* [`IndexMinuteGO.label_widths_at_depth()`](#static_frame.IndexMinuteGO.label_widths_at_depth)
* [`IndexMinuteGO.level_add()`](#static_frame.IndexMinuteGO.level_add)
* [`IndexMinuteGO.loc_searchsorted()`](#static_frame.IndexMinuteGO.loc_searchsorted)
* [`IndexMinuteGO.loc_to_iloc()`](#static_frame.IndexMinuteGO.loc_to_iloc)
* [`IndexMinuteGO.max()`](#static_frame.IndexMinuteGO.max)
* [`IndexMinuteGO.mean()`](#static_frame.IndexMinuteGO.mean)
* [`IndexMinuteGO.median()`](#static_frame.IndexMinuteGO.median)
* [`IndexMinuteGO.min()`](#static_frame.IndexMinuteGO.min)
* [`IndexMinuteGO.notfalsy()`](#static_frame.IndexMinuteGO.notfalsy)
* [`IndexMinuteGO.notna()`](#static_frame.IndexMinuteGO.notna)
* [`IndexMinuteGO.prod()`](#static_frame.IndexMinuteGO.prod)
* [`IndexMinuteGO.relabel()`](#static_frame.IndexMinuteGO.relabel)
* [`IndexMinuteGO.rename()`](#static_frame.IndexMinuteGO.rename)
* [`IndexMinuteGO.roll()`](#static_frame.IndexMinuteGO.roll)
* [`IndexMinuteGO.sample()`](#static_frame.IndexMinuteGO.sample)
* [`IndexMinuteGO.sort()`](#static_frame.IndexMinuteGO.sort)
* [`IndexMinuteGO.std()`](#static_frame.IndexMinuteGO.std)
* [`IndexMinuteGO.sum()`](#static_frame.IndexMinuteGO.sum)
* [`IndexMinuteGO.tail()`](#static_frame.IndexMinuteGO.tail)
* [`IndexMinuteGO.union()`](#static_frame.IndexMinuteGO.union)
* [`IndexMinuteGO.unique()`](#static_frame.IndexMinuteGO.unique)
* [`IndexMinuteGO.values_at_depth()`](#static_frame.IndexMinuteGO.values_at_depth)
* [`IndexMinuteGO.var()`](#static_frame.IndexMinuteGO.var)
