...
Detail: IndexDateGO: Exporter](index_date_go-exporter.md "previous page")
[next

Detail: IndexDateGO: Method](index_date_go-method.md "next page")

On this page

* [`IndexDateGO.STATIC`](#static_frame.IndexDateGO.STATIC)
* [`IndexDateGO.depth`](#static_frame.IndexDateGO.depth)
* [`IndexDateGO.dtype`](#static_frame.IndexDateGO.dtype)
* [`IndexDateGO.index_types`](#static_frame.IndexDateGO.index_types)
* [`IndexDateGO.memory`](#static_frame.IndexDateGO.memory)
* [`IndexDateGO.mloc`](#static_frame.IndexDateGO.mloc)
* [`IndexDateGO.name`](#static_frame.IndexDateGO.name)
* [`IndexDateGO.names`](#static_frame.IndexDateGO.names)
* [`IndexDateGO.nbytes`](#static_frame.IndexDateGO.nbytes)
* [`IndexDateGO.ndim`](#static_frame.IndexDateGO.ndim)
* [`IndexDateGO.positions`](#static_frame.IndexDateGO.positions)
* [`IndexDateGO.shape`](#static_frame.IndexDateGO.shape)
* [`IndexDateGO.size`](#static_frame.IndexDateGO.size)
