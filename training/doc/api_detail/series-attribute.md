...
Detail: Series: Exporter](series-exporter.md "previous page")
[next

Detail: Series: Method](series-method.md "next page")

On this page

* [`Series.STATIC`](#static_frame.Series.STATIC)
* [`Series.T`](#static_frame.Series.T)
* [`Series.dtype`](#static_frame.Series.dtype)
* [`Series.index`](#static_frame.Series.index)
* [`Series.memory`](#static_frame.Series.memory)
* [`Series.mloc`](#static_frame.Series.mloc)
* [`Series.name`](#static_frame.Series.name)
* [`Series.nbytes`](#static_frame.Series.nbytes)
* [`Series.ndim`](#static_frame.Series.ndim)
* [`Series.shape`](#static_frame.Series.shape)
* [`Series.size`](#static_frame.Series.size)
