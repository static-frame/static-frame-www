...
* [View page source](../_sources/api_detail/frame-display.rst.txt)

[Previous](frame-dictionary_like.html "Detail: Frame: Dictionary-Like")
[Next](frame-assignment.html "Detail: Frame: Assignment")

---

# Detail: Frame: Display[](#detail-frame-display "Link to this heading")

[Overview: Frame: Display](../api_overview/frame-display.html#api-overview-frame-display)

Frame.interface[](#Frame.interface "Link to this definition")
:   A Frame documenting the interface of this class.
    ...
    from_json_columns(json_data, *, d... Frame    Constructor     Frame constructor...
    ...                                  ...      ...             ...
    reduce.from_func(func, *, fill_va... Frame    Accessor Reduce For each Frame, a...
    reduce.from_func(func, *, fill_va... Frame    Accessor Reduce For each Frame, a...
    reduce.from_map_func(func, *, fil... Frame    Accessor Reduce For each Frame, r...
    reduce.from_map_func(func, *, fil... Frame    Accessor Reduce For each Frame, r...
    reduce.from_map_func(func, *, fil... Frame    Accessor Reduce For each Frame, r...
    reduce.from_map_func(func, *, fil... Frame    Accessor Reduce For each Frame, r...
    reduce.from_map_func(func, *, fil... Frame    Accessor Reduce For each Frame, r...
    reduce.from_label_map(func_map, *... Frame    Accessor Reduce For Frame, reduce...
    reduce.from_label_map(func_map, *... Frame    Accessor Reduce For Frame, reduce...
    reduce.from_label_map(func_map, *... Frame    Accessor Reduce For Frame, reduce...
    reduce.from_label_map(func_map, *... Frame    Accessor Reduce For Frame, reduce...
    reduce.from_label_map(func_map, *... Frame    Accessor Reduce For Frame, reduce...
    reduce.from_label_pair_map(func_m... Frame    Accessor Reduce For Frame, reduce...
    reduce.from_label_pair_map(func_m... Frame    Accessor Reduce For Frame, reduce...
    reduce.from_label_pair_map(func_m... Frame    Accessor Reduce For Frame, reduce...
    reduce.from_label_pair_map(func_m... Frame    Accessor Reduce For Frame, reduce...
    reduce.from_label_pair_map(func_m... Frame    Accessor Reduce For Frame, reduce...
...
Frame.\_\_repr\_\_()[](#static_frame.Frame.__repr__ "Link to this definition")
:   Return repr(self).
...
Frame.\_\_str\_\_()[](#static_frame.Frame.__str__ "Link to this definition")
:   Return str(self).
...
Frame.display(*config=None*, */*, *\**, *style\_config=None*)[[source]](../_modules/static_frame/core/frame.html#Frame.display)[](#static_frame.Frame.display "Link to this definition")
...
Frame.display\_tall(*config=None*, */*)[](#static_frame.Frame.display_tall "Link to this definition")
...
Frame.display\_wide(*config=None*, */*)[](#static_frame.Frame.display_wide "Link to this definition")
