...
:   Given any slotted object, return a [`MemoryDisplay`](memory_display.md#static_frame.MemoryDisplay "static_frame.MemoryDisplay") instance.
    ...
    >>> sf.MemoryDisplay.from_any(f.index)
          L   Lu    LM  LMu   LMD LMDu  R    Ru    RM  RMu   RMD RMDu
    Total 292 B     308 B     180 B     8.39 KB    340 B     212 B
    ```
...
Detail: NPY: Display](npy-display.md "previous page")
[next

Detail: MemoryDisplay: Exporter](memory_display-exporter.md "next page")

On this page

* [`MemoryDisplay.__init__()`](#static_frame.MemoryDisplay.__init__)
* [`MemoryDisplay.from_any()`](#static_frame.MemoryDisplay.from_any)
