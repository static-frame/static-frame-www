...
StoreFilter.from\_nat[](#static_frame.StoreFilter.from_nat "Link to this definition")

StoreFilter.from\_neginf[](#static_frame.StoreFilter.from_neginf "Link to this definition")

StoreFilter.from\_none[](#static_frame.StoreFilter.from_none "Link to this definition")

StoreFilter.from\_posinf[](#static_frame.StoreFilter.from_posinf "Link to this definition")

StoreFilter.to\_nan[](#static_frame.StoreFilter.to_nan "Link to this definition")

StoreFilter.to\_nat[](#static_frame.StoreFilter.to_nat "Link to this definition")

StoreFilter.to\_neginf[](#static_frame.StoreFilter.to_neginf "Link to this definition")

StoreFilter.to\_none[](#static_frame.StoreFilter.to_none "Link to this definition")

StoreFilter.to\_posinf[](#static_frame.StoreFilter.to_posinf "Link to this definition")

StoreFilter.value\_format\_complex\_positional[](#static_frame.StoreFilter.value_format_complex_positional "Link to this definition")

StoreFilter.value\_format\_complex\_scientific[](#static_frame.StoreFilter.value_format_complex_scientific "Link to this definition")

StoreFilter.value\_format\_float\_positional[](#static_frame.StoreFilter.value_format_float_positional "Link to this definition")
