...
* [View page source](../_sources/api_detail/index_nanosecond_go-accessor_regular_expression.rst.txt)

[Previous](index_nanosecond_go-accessor_string.html "Detail: IndexNanosecondGO: Accessor String")
[Next](index_nanosecond_go-accessor_hashlib.html "Detail: IndexNanosecondGO: Accessor Hashlib")

---

# Detail: IndexNanosecondGO: Accessor Regular Expression[](#detail-indexnanosecondgo-accessor-regular-expression "Link to this heading")

[Overview: IndexNanosecondGO: Accessor Regular Expression](../api_overview/index_nanosecond_go-accessor_regular_expression.html#api-overview-indexnanosecondgo-accessor-regular-expression)

IndexNanosecondGO.via\_re(*pattern*, *flags).search(pos*, *endpos*)
...
IndexNanosecondGO.via\_re(*pattern*, *flags).match(pos*, *endpos*)
:   via\_re *= <function Index.via\_re>*
...
IndexNanosecondGO.via\_re(*pattern*, *flags).fullmatch(pos*, *endpos*)
:   via\_re *= <function Index.via\_re>*
...
IndexNanosecondGO.via\_re(*pattern*, *flags).split(maxsplit*)
:   via\_re *= <function Index.via\_re>*
...
IndexNanosecondGO.via\_re(*pattern*, *flags).findall(pos*, *endpos*)
:   via\_re *= <function Index.via\_re>*
...
IndexNanosecondGO.via\_re(*pattern*, *flags).sub(repl*, *count*)
:   via\_re *= <function Index.via\_re>*
...
IndexNanosecondGO.via\_re(*pattern*, *flags).subn(repl*, *count*)
:   via\_re *= <function Index.via\_re>*
