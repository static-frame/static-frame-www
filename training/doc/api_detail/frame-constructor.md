...
:   Create a Frame from a dictionary (or any object that has an items() method) where keys are column labels and values are columns values (either sequence types or [`Series`](series-selector.md#Series "Series")).
    ...
    ```
    >>> sf.Frame.from_dict(dict(a=(10, 2, 8, 3), b=('1517-01-01', '1517-04-01', '1517-12-31', '1517-06-30')), dtypes=dict(b=np.datetime64), name='x')
    <Frame: x>
    <Index>    a       b               <<U1>
    <Index>
    0          10      1517-01-01
...
*classmethod* Frame.from\_display(*display*, */*)[[source]](../_modules/static_frame/core/frame.md#Frame.from_display)[#](#static_frame.Frame.from_display "Link to this definition")
...
:   Create a [`Frame`](frame-selector.md#Frame "Frame") from an iterable of key, value, where key is a pair of row, column labels.
    ...
    ```
    >>> sf.Frame.from_element_items(((('a', 0), -1), (('b', 0), 10), (('a', 1), 3), (('b', 1), 1)), columns=(0, 1), index=('a', 'b'), name='x', axis=1)
    <Frame: x>
    <Index>    0       1       <int64>
    <Index>
    a          -1      3
...
Detail: SeriesHE: Accessor Mapping](series_he-accessor_mapping.md "previous page")
[next

Detail: Frame: Exporter](frame-exporter.md "next page")

On this page

* [`Frame.__init__()`](#static_frame.Frame.__init__)
* [`Frame.from_arrow()`](#static_frame.Frame.from_arrow)
* [`Frame.from_clipboard()`](#static_frame.Frame.from_clipboard)
* [`Frame.from_concat()`](#static_frame.Frame.from_concat)
* [`Frame.from_concat_items()`](#static_frame.Frame.from_concat_items)
* [`Frame.from_csv()`](#static_frame.Frame.from_csv)
* [`Frame.from_delimited()`](#static_frame.Frame.from_delimited)
* [`Frame.from_dict()`](#static_frame.Frame.from_dict)
* [`Frame.from_dict_fields()`](#static_frame.Frame.from_dict_fields)
* [`Frame.from_dict_records()`](#static_frame.Frame.from_dict_records)
* [`Frame.from_dict_records_items()`](#static_frame.Frame.from_dict_records_items)
* [`Frame.from_display()`](#static_frame.Frame.from_display)
* [`Frame.from_element()`](#static_frame.Frame.from_element)
* [`Frame.from_element_items()`](#static_frame.Frame.from_element_items)
* [`Frame.from_elements()`](#static_frame.Frame.from_elements)
* [`Frame.from_fields()`](#static_frame.Frame.from_fields)
* [`Frame.from_items()`](#static_frame.Frame.from_items)
* [`Frame.from_json_columns()`](#static_frame.Frame.from_json_columns)
* [`Frame.from_json_index()`](#static_frame.Frame.from_json_index)
* [`Frame.from_json_records()`](#static_frame.Frame.from_json_records)
* [`Frame.from_json_split()`](#static_frame.Frame.from_json_split)
* [`Frame.from_json_typed()`](#static_frame.Frame.from_json_typed)
* [`Frame.from_json_values()`](#static_frame.Frame.from_json_values)
* [`Frame.from_npy()`](#static_frame.Frame.from_npy)
* [`Frame.from_npy_mmap()`](#static_frame.Frame.from_npy_mmap)
* [`Frame.from_npz()`](#static_frame.Frame.from_npz)
* [`Frame.from_overlay()`](#static_frame.Frame.from_overlay)
* [`Frame.from_pandas()`](#static_frame.Frame.from_pandas)
* [`Frame.from_parquet()`](#static_frame.Frame.from_parquet)
* [`Frame.from_pickle()`](#static_frame.Frame.from_pickle)
* [`Frame.from_records()`](#static_frame.Frame.from_records)
* [`Frame.from_records_items()`](#static_frame.Frame.from_records_items)
* [`Frame.from_series()`](#static_frame.Frame.from_series)
* [`Frame.from_sql()`](#static_frame.Frame.from_sql)
* [`Frame.from_sqlite()`](#static_frame.Frame.from_sqlite)
* [`Frame.from_structured_array()`](#static_frame.Frame.from_structured_array)
* [`Frame.from_tsv()`](#static_frame.Frame.from_tsv)
* [`Frame.from_xlsx()`](#static_frame.Frame.from_xlsx)
