...
:   consolidate
    ...
    ```
    >>> f1 = sf.FrameGO.from_fields(((0, 0, 10, 2), (20, 18, -3, 18), (0, 0, 0, 1), (False, True, True, False), (True, True, False, True)), columns=('a', 'b', 'c', 'd', 'e'), name='x')
    >>> f1
    <FrameGO: x>
    <IndexGO>    a       b       c       d      e      <<U1>
    <Index>
    0            0       20      0       False  True
    1            0       18      0       True   True
    2            10      -3      0       True   False
...
:   Extend this FrameGO (in-place) with another Frame’s blocks or Series array; as blocks are immutable, this is a no-copy operation when indices align. If indices do not align, the passed-in Frame or Series will be reindexed (as happens when adding a column to a FrameGO).
    ...
    This method differs from FrameGO.extend\_items() by permitting contiguous underlying blocks to be extended from another Frame into this Frame.
...
:   Given an iterable of index labels, return a new `Frame` with those rows as an `IndexHierarchy` on the columns.
    ...
    <FrameGO: x>
    <IndexHierarchyGO: ((np.int64(1), n…       8       True   1517-12-31      <object>
...
Detail: FrameGO: Attribute](frame_go-attribute.md "previous page")
[next

Detail: FrameGO: Dictionary-Like](frame_go-dictionary_like.md "next page")
...
* [`FrameGO.__round__()`](#static_frame.FrameGO.__round__)
* [`FrameGO.all()`](#static_frame.FrameGO.all)
* [`FrameGO.any()`](#static_frame.FrameGO.any)
* [`FrameGO.clip()`](#static_frame.FrameGO.clip)
* [`FrameGO.corr()`](#static_frame.FrameGO.corr)
* [`FrameGO.count()`](#static_frame.FrameGO.count)
* [`FrameGO.cov()`](#static_frame.FrameGO.cov)
* [`FrameGO.cumprod()`](#static_frame.FrameGO.cumprod)
* [`FrameGO.cumsum()`](#static_frame.FrameGO.cumsum)
* [`FrameGO.drop_duplicated()`](#static_frame.FrameGO.drop_duplicated)
* [`FrameGO.dropfalsy()`](#static_frame.FrameGO.dropfalsy)
* [`FrameGO.dropna()`](#static_frame.FrameGO.dropna)
* [`FrameGO.duplicated()`](#static_frame.FrameGO.duplicated)
* [`FrameGO.equals()`](#static_frame.FrameGO.equals)
* [`FrameGO.extend()`](#static_frame.FrameGO.extend)
* [`FrameGO.extend_items()`](#static_frame.FrameGO.extend_items)
* [`FrameGO.fillfalsy()`](#static_frame.FrameGO.fillfalsy)
* [`FrameGO.fillfalsy_backward()`](#static_frame.FrameGO.fillfalsy_backward)
* [`FrameGO.fillfalsy_forward()`](#static_frame.FrameGO.fillfalsy_forward)
* [`FrameGO.fillfalsy_leading()`](#static_frame.FrameGO.fillfalsy_leading)
* [`FrameGO.fillfalsy_trailing()`](#static_frame.FrameGO.fillfalsy_trailing)
* [`FrameGO.fillna()`](#static_frame.FrameGO.fillna)
* [`FrameGO.fillna_backward()`](#static_frame.FrameGO.fillna_backward)
* [`FrameGO.fillna_forward()`](#static_frame.FrameGO.fillna_forward)
* [`FrameGO.fillna_leading()`](#static_frame.FrameGO.fillna_leading)
* [`FrameGO.fillna_trailing()`](#static_frame.FrameGO.fillna_trailing)
* [`FrameGO.head()`](#static_frame.FrameGO.head)
* [`FrameGO.iloc_max()`](#static_frame.FrameGO.iloc_max)
* [`FrameGO.iloc_min()`](#static_frame.FrameGO.iloc_min)
* [`FrameGO.iloc_notfalsy_first()`](#static_frame.FrameGO.iloc_notfalsy_first)
* [`FrameGO.iloc_notfalsy_last()`](#static_frame.FrameGO.iloc_notfalsy_last)
* [`FrameGO.iloc_notna_first()`](#static_frame.FrameGO.iloc_notna_first)
* [`FrameGO.iloc_notna_last()`](#static_frame.FrameGO.iloc_notna_last)
* [`FrameGO.insert_after()`](#static_frame.FrameGO.insert_after)
* [`FrameGO.insert_before()`](#static_frame.FrameGO.insert_before)
* [`FrameGO.isfalsy()`](#static_frame.FrameGO.isfalsy)
* [`FrameGO.isin()`](#static_frame.FrameGO.isin)
* [`FrameGO.isna()`](#static_frame.FrameGO.isna)
* [`FrameGO.join_inner()`](#static_frame.FrameGO.join_inner)
* [`FrameGO.join_left()`](#static_frame.FrameGO.join_left)
* [`FrameGO.join_outer()`](#static_frame.FrameGO.join_outer)
* [`FrameGO.join_right()`](#static_frame.FrameGO.join_right)
* [`FrameGO.loc_max()`](#static_frame.FrameGO.loc_max)
* [`FrameGO.loc_min()`](#static_frame.FrameGO.loc_min)
* [`FrameGO.loc_notfalsy_first()`](#static_frame.FrameGO.loc_notfalsy_first)
* [`FrameGO.loc_notfalsy_last()`](#static_frame.FrameGO.loc_notfalsy_last)
* [`FrameGO.loc_notna_first()`](#static_frame.FrameGO.loc_notna_first)
* [`FrameGO.loc_notna_last()`](#static_frame.FrameGO.loc_notna_last)
* [`FrameGO.max()`](#static_frame.FrameGO.max)
* [`FrameGO.mean()`](#static_frame.FrameGO.mean)
* [`FrameGO.median()`](#static_frame.FrameGO.median)
* [`FrameGO.merge_inner()`](#static_frame.FrameGO.merge_inner)
* [`FrameGO.merge_left()`](#static_frame.FrameGO.merge_left)
* [`FrameGO.merge_outer()`](#static_frame.FrameGO.merge_outer)
* [`FrameGO.merge_right()`](#static_frame.FrameGO.merge_right)
* [`FrameGO.min()`](#static_frame.FrameGO.min)
* [`FrameGO.notfalsy()`](#static_frame.FrameGO.notfalsy)
* [`FrameGO.notna()`](#static_frame.FrameGO.notna)
* [`FrameGO.pivot()`](#static_frame.FrameGO.pivot)
* [`FrameGO.pivot_stack()`](#static_frame.FrameGO.pivot_stack)
* [`FrameGO.pivot_unstack()`](#static_frame.FrameGO.pivot_unstack)
* [`FrameGO.prod()`](#static_frame.FrameGO.prod)
* [`FrameGO.rank_dense()`](#static_frame.FrameGO.rank_dense)
* [`FrameGO.rank_max()`](#static_frame.FrameGO.rank_max)
* [`FrameGO.rank_mean()`](#static_frame.FrameGO.rank_mean)
* [`FrameGO.rank_min()`](#static_frame.FrameGO.rank_min)
* [`FrameGO.rank_ordinal()`](#static_frame.FrameGO.rank_ordinal)
* [`FrameGO.rehierarch()`](#static_frame.FrameGO.rehierarch)
* [`FrameGO.reindex()`](#static_frame.FrameGO.reindex)
* [`FrameGO.relabel()`](#static_frame.FrameGO.relabel)
* [`FrameGO.relabel_flat()`](#static_frame.FrameGO.relabel_flat)
* [`FrameGO.relabel_level_add()`](#static_frame.FrameGO.relabel_level_add)
* [`FrameGO.relabel_level_drop()`](#static_frame.FrameGO.relabel_level_drop)
* [`FrameGO.relabel_shift_in()`](#static_frame.FrameGO.relabel_shift_in)
* [`FrameGO.relabel_shift_out()`](#static_frame.FrameGO.relabel_shift_out)
* [`FrameGO.rename()`](#static_frame.FrameGO.rename)
* [`FrameGO.roll()`](#static_frame.FrameGO.roll)
* [`FrameGO.sample()`](#static_frame.FrameGO.sample)
* [`FrameGO.set_columns()`](#static_frame.FrameGO.set_columns)
* [`FrameGO.set_columns_hierarchy()`](#static_frame.FrameGO.set_columns_hierarchy)
* [`FrameGO.set_index()`](#static_frame.FrameGO.set_index)
* [`FrameGO.set_index_hierarchy()`](#static_frame.FrameGO.set_index_hierarchy)
* [`FrameGO.shift()`](#static_frame.FrameGO.shift)
* [`FrameGO.sort_columns()`](#static_frame.FrameGO.sort_columns)
* [`FrameGO.sort_index()`](#static_frame.FrameGO.sort_index)
* [`FrameGO.sort_values()`](#static_frame.FrameGO.sort_values)
* [`FrameGO.std()`](#static_frame.FrameGO.std)
* [`FrameGO.sum()`](#static_frame.FrameGO.sum)
* [`FrameGO.tail()`](#static_frame.FrameGO.tail)
* [`FrameGO.transpose()`](#static_frame.FrameGO.transpose)
* [`FrameGO.unique()`](#static_frame.FrameGO.unique)
* [`FrameGO.unique_enumerated()`](#static_frame.FrameGO.unique_enumerated)
* [`FrameGO.unset_columns()`](#static_frame.FrameGO.unset_columns)
* [`FrameGO.unset_index()`](#static_frame.FrameGO.unset_index)
* [`FrameGO.var()`](#static_frame.FrameGO.var)
