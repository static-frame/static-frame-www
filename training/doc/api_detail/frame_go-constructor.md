...
:   Create a [`Frame`](frame-selector.md#Frame "Frame") from an iterable of key, value, where key is a pair of row, column labels.
    ...
    ```
    >>> sf.FrameGO.from_element_items(((('a', 0), -1), (('b', 0), 10), (('a', 1), 3), (('b', 1), 1)), columns=(0, 1), index=('a', 'b'), name='x', axis=1)
    <FrameGO: x>
    <IndexGO>    0       1       <int64>
    <Index>
    a            -1      3
...
Detail: Frame: Accessor Reduce](frame-accessor_reduce.md "previous page")
[next

Detail: FrameGO: Exporter](frame_go-exporter.md "next page")

On this page

* [`FrameGO.__init__()`](#static_frame.FrameGO.__init__)
* [`FrameGO.from_arrow()`](#static_frame.FrameGO.from_arrow)
* [`FrameGO.from_clipboard()`](#static_frame.FrameGO.from_clipboard)
* [`FrameGO.from_concat()`](#static_frame.FrameGO.from_concat)
* [`FrameGO.from_concat_items()`](#static_frame.FrameGO.from_concat_items)
* [`FrameGO.from_csv()`](#static_frame.FrameGO.from_csv)
* [`FrameGO.from_delimited()`](#static_frame.FrameGO.from_delimited)
* [`FrameGO.from_dict()`](#static_frame.FrameGO.from_dict)
...
* [`FrameGO.from_fields()`](#static_frame.FrameGO.from_fields)
* [`FrameGO.from_items()`](#static_frame.FrameGO.from_items)
* [`FrameGO.from_json_columns()`](#static_frame.FrameGO.from_json_columns)
* [`FrameGO.from_json_index()`](#static_frame.FrameGO.from_json_index)
* [`FrameGO.from_json_records()`](#static_frame.FrameGO.from_json_records)
* [`FrameGO.from_json_split()`](#static_frame.FrameGO.from_json_split)
* [`FrameGO.from_json_typed()`](#static_frame.FrameGO.from_json_typed)
* [`FrameGO.from_json_values()`](#static_frame.FrameGO.from_json_values)
* [`FrameGO.from_npy()`](#static_frame.FrameGO.from_npy)
* [`FrameGO.from_npy_mmap()`](#static_frame.FrameGO.from_npy_mmap)
* [`FrameGO.from_npz()`](#static_frame.FrameGO.from_npz)
* [`FrameGO.from_overlay()`](#static_frame.FrameGO.from_overlay)
* [`FrameGO.from_pandas()`](#static_frame.FrameGO.from_pandas)
* [`FrameGO.from_parquet()`](#static_frame.FrameGO.from_parquet)
* [`FrameGO.from_pickle()`](#static_frame.FrameGO.from_pickle)
* [`FrameGO.from_records()`](#static_frame.FrameGO.from_records)
* [`FrameGO.from_records_items()`](#static_frame.FrameGO.from_records_items)
* [`FrameGO.from_series()`](#static_frame.FrameGO.from_series)
* [`FrameGO.from_sql()`](#static_frame.FrameGO.from_sql)
* [`FrameGO.from_sqlite()`](#static_frame.FrameGO.from_sqlite)
* [`FrameGO.from_structured_array()`](#static_frame.FrameGO.from_structured_array)
* [`FrameGO.from_tsv()`](#static_frame.FrameGO.from_tsv)
* [`FrameGO.from_xlsx()`](#static_frame.FrameGO.from_xlsx)
