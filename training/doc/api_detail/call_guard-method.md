...
:   A function decorator to perform run-time checking of function arguments and return values based on the function type annotations, including type hints and `Require`-provided validators. Raises `ClinicError` on failure.
    ...
    >>> func2
    <function func1 at 0x7c7e1695d760>
...
Detail: TypeClinic: Display](type_clinic-display.md "previous page")
[next

Detail: ClinicResult: Constructor](clinic_result-constructor.md "next page")

On this page

* [`CallGuard.check()`](#static_frame.CallGuard.check)
* [`CallGuard.warn()`](#static_frame.CallGuard.warn)
