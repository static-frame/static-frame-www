...
Detail: StoreFilter: Display](store_filter-display.md "previous page")
[next

Detail: IndexAutoFactory: Exporter](index_auto_factory-exporter.md "next page")

On this page

* [`IndexAutoFactory.__init__()`](#static_frame.IndexAutoFactory.__init__)
* [`IndexAutoFactory.from_optional_constructor()`](#static_frame.IndexAutoFactory.from_optional_constructor)
