...
Detail: IndexHour: Exporter](index_hour-exporter.md "previous page")
[next

Detail: IndexHour: Method](index_hour-method.md "next page")

On this page

* [`IndexHour.STATIC`](#static_frame.IndexHour.STATIC)
* [`IndexHour.depth`](#static_frame.IndexHour.depth)
* [`IndexHour.dtype`](#static_frame.IndexHour.dtype)
* [`IndexHour.index_types`](#static_frame.IndexHour.index_types)
* [`IndexHour.memory`](#static_frame.IndexHour.memory)
* [`IndexHour.mloc`](#static_frame.IndexHour.mloc)
* [`IndexHour.name`](#static_frame.IndexHour.name)
* [`IndexHour.names`](#static_frame.IndexHour.names)
* [`IndexHour.nbytes`](#static_frame.IndexHour.nbytes)
* [`IndexHour.ndim`](#static_frame.IndexHour.ndim)
* [`IndexHour.positions`](#static_frame.IndexHour.positions)
* [`IndexHour.shape`](#static_frame.IndexHour.shape)
* [`IndexHour.size`](#static_frame.IndexHour.size)
