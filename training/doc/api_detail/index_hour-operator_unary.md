...
* [View page source](../_sources/api_detail/index_hour-operator_unary.rst.txt)

[Previous](index_hour-operator_binary.html "Detail: IndexHour: Operator Binary")
[Next](index_hour-accessor_values.html "Detail: IndexHour: Accessor Values")

---

# Detail: IndexHour: Operator Unary[](#detail-indexhour-operator-unary "Link to this heading")

[Overview: IndexHour: Operator Unary](../api_overview/index_hour-operator_unary.html#api-overview-indexhour-operator-unary)

IndexHour.\_\_abs\_\_()[](#static_frame.IndexHour.__abs__ "Link to this definition")
:   ```
...
IndexHour.\_\_invert\_\_()[](#static_frame.IndexHour.__invert__ "Link to this definition")
:   ```
    >>> ix = sf.IndexHour(('1517-04-01', '1517-12-31', '1517-06-30'))
    >>> ix
    <IndexHour>
...
IndexHour.\_\_neg\_\_()[](#static_frame.IndexHour.__neg__ "Link to this definition")
:   ```
    >>> ix = sf.IndexHour(('1517-04-01', '1517-12-31', '1517-06-30'))
    >>> ix
    <IndexHour>
...
IndexHour.\_\_pos\_\_()[](#static_frame.IndexHour.__pos__ "Link to this definition")
:   ```
    >>> ix = sf.IndexHour(('1517-04-01', '1517-12-31', '1517-06-30'))
    >>> ix
    <IndexHour>
