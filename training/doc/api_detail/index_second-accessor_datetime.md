...
* [View page source](../_sources/api_detail/index_second-accessor_datetime.rst.txt)

[Previous](index_second-accessor_values.html "Detail: IndexSecond: Accessor Values")
[Next](index_second-accessor_string.html "Detail: IndexSecond: Accessor String")

---

# Detail: IndexSecond: Accessor Datetime[](#detail-indexsecond-accessor-datetime "Link to this heading")

[Overview: IndexSecond: Accessor Datetime](../api_overview/index_second-accessor_datetime.html#api-overview-indexsecond-accessor-datetime)

IndexSecond.via\_dt.\_\_call\_\_(*\**, *fill\_value*)
:   IndexSecond.via\_dt
...
IndexSecond.via\_dt.year\_month
:   IndexSecond.via\_dt
    :   Interface for applying datetime properties and methods to elements in this container.
...
IndexSecond.via\_dt.year\_quarter
:   IndexSecond.via\_dt
    :   Interface for applying datetime properties and methods to elements in this container.
...
IndexSecond.via\_dt.is\_month\_end
:   IndexSecond.via\_dt
    :   Interface for applying datetime properties and methods to elements in this container.
...
IndexSecond.via\_dt.is\_month\_start
:   IndexSecond.via\_dt
    :   Interface for applying datetime properties and methods to elements in this container.
...
IndexSecond.via\_dt.is\_year\_end
:   IndexSecond.via\_dt
    :   Interface for applying datetime properties and methods to elements in this container.
...
IndexSecond.via\_dt.is\_year\_start
:   IndexSecond.via\_dt
    :   Interface for applying datetime properties and methods to elements in this container.
...
IndexSecond.via\_dt.is\_quarter\_end
:   IndexSecond.via\_dt
    :   Interface for applying datetime properties and methods to elements in this container.
...
IndexSecond.via\_dt.is\_quarter\_start
:   IndexSecond.via\_dt
    :   Interface for applying datetime properties and methods to elements in this container.
...
IndexSecond.via\_dt.isoformat(*\**, *sep*, *timespec*)
:   IndexSecond.via\_dt
    :   Interface for applying datetime properties and methods to elements in this container.
...
IndexSecond.via\_dt.fromisoformat
:   IndexSecond.via\_dt
    :   Interface for applying datetime properties and methods to elements in this container.
...
IndexSecond.via\_dt.strftime(*format*)
:   IndexSecond.via\_dt
    :   Interface for applying datetime properties and methods to elements in this container.
...
IndexSecond.via\_dt.strptime(*format*)
:   IndexSecond.via\_dt
    :   Interface for applying datetime properties and methods to elements in this container.
...
IndexSecond.via\_dt.strpdate(*format*)
:   IndexSecond.via\_dt
    :   Interface for applying datetime properties and methods to elements in this container.
