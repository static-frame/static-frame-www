...
Series.assign[key].apply(func, \*, fill\_value)
:   Series.assign
    :   Interface for doing assignment-like selection and replacement.
...
Series.assign[key].apply\_element(func, \*, dtype, fill\_value)
:   Series.assign
    :   Interface for doing assignment-like selection and replacement.
...
Series.assign[key].apply\_element\_items(func, \*, dtype, fill\_value)
:   Series.assign
    :   Interface for doing assignment-like selection and replacement.
...
Series.assign.iloc[*key*](*value*, *\**, *fill\_value*)
:   Series.assign
    :   Interface for doing assignment-like selection and replacement.
...
Series.assign.iloc[key].apply(func, \*, fill\_value)
:   Series.assign
    :   Interface for doing assignment-like selection and replacement.
...
Series.assign.iloc[key].apply\_element(func, \*, dtype, fill\_value)
:   Series.assign
    :   Interface for doing assignment-like selection and replacement.
...
Series.assign.iloc[key].apply\_element\_items(func, \*, dtype, fill\_value)
:   Series.assign
    :   Interface for doing assignment-like selection and replacement.
...
Series.assign.loc[*key*](*value*, *\**, *fill\_value*)
:   Series.assign
    :   Interface for doing assignment-like selection and replacement.
...
Series.assign.loc[key].apply(func, \*, fill\_value)
:   Series.assign
    :   Interface for doing assignment-like selection and replacement.
...
Series.assign.loc[key].apply\_element(func, \*, dtype, fill\_value)
:   Series.assign
    :   Interface for doing assignment-like selection and replacement.
...
Series.assign.loc[key].apply\_element\_items(func, \*, dtype, fill\_value)
:   Series.assign
    :   Interface for doing assignment-like selection and replacement.
