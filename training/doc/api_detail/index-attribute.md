...
Detail: Index: Exporter](index-exporter.md "previous page")
[next

Detail: Index: Method](index-method.md "next page")

On this page

* [`Index.STATIC`](#static_frame.Index.STATIC)
* [`Index.depth`](#static_frame.Index.depth)
* [`Index.dtype`](#static_frame.Index.dtype)
* [`Index.index_types`](#static_frame.Index.index_types)
* [`Index.memory`](#static_frame.Index.memory)
* [`Index.mloc`](#static_frame.Index.mloc)
* [`Index.name`](#static_frame.Index.name)
* [`Index.names`](#static_frame.Index.names)
* [`Index.nbytes`](#static_frame.Index.nbytes)
* [`Index.ndim`](#static_frame.Index.ndim)
* [`Index.positions`](#static_frame.Index.positions)
* [`Index.shape`](#static_frame.Index.shape)
* [`Index.size`](#static_frame.Index.size)
