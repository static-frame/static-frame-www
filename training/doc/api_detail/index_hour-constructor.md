...
IndexHour.\_\_init\_\_(*labels*, */*, *\**, *loc\_is\_iloc=False*, *name=<object object>*, *sort\_status=SortStatus.UNKNOWN*)[#](#static_frame.IndexHour.__init__ "Link to this definition")
:   Initializer.
...
*classmethod* IndexHour.from\_difference(*\*others*)[#](#static_frame.IndexHour.from_difference "Link to this definition")
:   Construct a new Index based on the difference with Index, containers, or NumPy arrays. Retains order.

    ```
    >>> ix1 = sf.IndexHour.from_labels(('1517-04-01', '1517-12-31', '1517-06-30'))
    >>> ix1
    <IndexHour>
    1517-04-01T00
    1517-12-31T00
    1517-06-30T00
    <datetime64[h]>
    >>> ix2 = sf.IndexHour.from_labels(('2022-04-01', '2021-12-31', '2018-06-30'))
    >>> ix2
    <IndexHour>
    2022-04-01T00
    2021-12-31T00
    2018-06-30T00
    <datetime64[h]>
    >>> sf.IndexHour.from_difference(ix1, ix2)
    <IndexHour>
    1517-04-01T00
    1517-12-31T00
    1517-06-30T00
...
*classmethod* IndexHour.from\_intersection(*\*others*)[#](#static_frame.IndexHour.from_intersection "Link to this definition")
:   Construct a new Index based on the intersection with Index, containers, or NumPy arrays. Identical comparisons retain order.
    ...
    2018-06-30T00
    <datetime64[h]>
    >>> sf.IndexHour.from_intersection(ix1, ix2)
    <IndexHour>
    <datetime64[h]>
    ```
...
*classmethod* IndexHour.from\_union(*\*others*)[#](#static_frame.IndexHour.from_union "Link to this definition")
:   Construct a new Index based on the union with Index, containers, or NumPy arrays. Identical comparisons retain order.
    ...
    2018-06-30T00
    <datetime64[h]>
    >>> sf.IndexHour.from_union(ix1, ix2)
    <IndexHour>
    1517-04-01T00
    1517-06-30T00
    1517-12-31T00
...
Detail: IndexMinuteGO: Accessor Type Clinic](index_minute_go-accessor_type_clinic.md "previous page")
[next

Detail: IndexHour: Exporter](index_hour-exporter.md "next page")

On this page

* [`IndexHour.__init__()`](#static_frame.IndexHour.__init__)
* [`IndexHour.from_difference()`](#static_frame.IndexHour.from_difference)
* [`IndexHour.from_intersection()`](#static_frame.IndexHour.from_intersection)
* [`IndexHour.from_labels()`](#static_frame.IndexHour.from_labels)
* [`IndexHour.from_pandas()`](#static_frame.IndexHour.from_pandas)
* [`IndexHour.from_union()`](#static_frame.IndexHour.from_union)
