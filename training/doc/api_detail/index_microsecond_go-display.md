...
:   A Frame documenting the interface of this class.
    ...
    <Index: signature>
    __init__(labels, /, *, loc_is_ilo... IndexMicrosecondGO Constructor          Initializer. Args...
    from_difference(*others)             IndexMicrosecondGO Constructor          Construct a new I...
    from_intersection(*others)           IndexMicrosecondGO Constructor          Construct a new I...
    ...
    from_union(*others)                  IndexMicrosecondGO Constructor          Construct a new I...
    to_html(config, /, *, style_config)  IndexMicrosecondGO Exporter             Return an HTML ta...
    to_html_datatables(fp, /, *, show... IndexMicrosecondGO Exporter             Return a complete...
    ...
    ...                                  ...                ...                  ...
    via_re(pattern, flags, /).sub(rep... IndexMicrosecondGO Accessor Regular ... Return the string...
    via_re(pattern, flags, /).subn(re... IndexMicrosecondGO Accessor Regular ... Perform the same ...
    ...
    via_type_clinic.check(hint, /, *,... IndexMicrosecondGO Accessor Type Clinic Given a hint (a t...
    via_type_clinic.warn(hint, /, *, ... IndexMicrosecondGO Accessor Type Clinic Given a hint (a t...
...
Detail: IndexMicrosecondGO: Dictionary-Like](index_microsecond_go-dictionary_like.md "previous page")
[next

Detail: IndexMicrosecondGO: Selector](index_microsecond_go-selector.md "next page")

On this page

* [`IndexMicrosecondGO.interface`](#IndexMicrosecondGO.interface)
* [`IndexMicrosecondGO.__repr__()`](#static_frame.IndexMicrosecondGO.__repr__)
* [`IndexMicrosecondGO.__str__()`](#static_frame.IndexMicrosecondGO.__str__)
* [`IndexMicrosecondGO.display()`](#static_frame.IndexMicrosecondGO.display)
* [`IndexMicrosecondGO.display_tall()`](#static_frame.IndexMicrosecondGO.display_tall)
* [`IndexMicrosecondGO.display_wide()`](#static_frame.IndexMicrosecondGO.display_wide)
