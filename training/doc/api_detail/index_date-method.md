...
IndexDate.\_\_array\_\_(*dtype=None*, *copy=None*)[#](#static_frame.IndexDate.__array__ "Link to this definition")
...
IndexDate.\_\_len\_\_()[#](#static_frame.IndexDate.__len__ "Link to this definition")
:   ```
    >>> ix = sf.IndexDate(('1517-04-01', '1517-12', '1517-06-30'))
    >>> ix
    <IndexDate>
...
:   Perform difference with another Index, container, or NumPy array. Retains order.
    ...
    1517-06-30
    <datetime64[D]>
    >>> ix2 = sf.IndexDate(('2022-04-01', '2021-12-31', '2018-06-30'))
    >>> ix2
    <IndexDate>
    2022-04-01
    2021-12-31
...
IndexDate.insert\_after(*key*, *labels*, */*)[#](#static_frame.IndexDate.insert_after "Link to this definition")
:   ```
    >>> ix = sf.IndexDate(('1517-04-01', '1517-12', '1517-06-30'))
    >>> ix
    <IndexDate>
...
IndexDate.insert\_before(*key*, *labels*, */*)[#](#static_frame.IndexDate.insert_before "Link to this definition")
:   ```
    >>> ix = sf.IndexDate(('1517-04-01', '1517-12', '1517-06-30'))
    >>> ix
    <IndexDate>
...
IndexDate.is\_sorted(*\**, *ascending=True*, *kind='mergesort'*, *key=None*)[#](#static_frame.IndexDate.is_sorted "Link to this definition")
:   Return True if this Index is sorted according to the specified parameters.
    ...
    ```
    >>> ix = sf.IndexDate(('2022-04-01', '2021-12-31', '2018-06-30'))
    >>> ix
    <IndexDate>
    2022-04-01
    2021-12-31
...
Detail: IndexDate: Attribute](index_date-attribute.md "previous page")
[next

Detail: IndexDate: Dictionary-Like](index_date-dictionary_like.md "next page")

On this page

* [`IndexDate.__array__()`](#static_frame.IndexDate.__array__)
* [`IndexDate.__array_ufunc__()`](#static_frame.IndexDate.__array_ufunc__)
* [`IndexDate.__bool__()`](#static_frame.IndexDate.__bool__)
* [`IndexDate.__copy__()`](#static_frame.IndexDate.__copy__)
* [`IndexDate.__deepcopy__()`](#static_frame.IndexDate.__deepcopy__)
* [`IndexDate.__len__()`](#static_frame.IndexDate.__len__)
* [`IndexDate.all()`](#static_frame.IndexDate.all)
* [`IndexDate.any()`](#static_frame.IndexDate.any)
* [`IndexDate.astype()`](#static_frame.IndexDate.astype)
* [`IndexDate.copy()`](#static_frame.IndexDate.copy)
* [`IndexDate.cumprod()`](#static_frame.IndexDate.cumprod)
* [`IndexDate.cumsum()`](#static_frame.IndexDate.cumsum)
* [`IndexDate.difference()`](#static_frame.IndexDate.difference)
* [`IndexDate.dropfalsy()`](#static_frame.IndexDate.dropfalsy)
* [`IndexDate.dropna()`](#static_frame.IndexDate.dropna)
* [`IndexDate.equals()`](#static_frame.IndexDate.equals)
* [`IndexDate.fillfalsy()`](#static_frame.IndexDate.fillfalsy)
* [`IndexDate.fillna()`](#static_frame.IndexDate.fillna)
* [`IndexDate.head()`](#static_frame.IndexDate.head)
* [`IndexDate.iloc_searchsorted()`](#static_frame.IndexDate.iloc_searchsorted)
* [`IndexDate.insert_after()`](#static_frame.IndexDate.insert_after)
* [`IndexDate.insert_before()`](#static_frame.IndexDate.insert_before)
* [`IndexDate.intersection()`](#static_frame.IndexDate.intersection)
* [`IndexDate.is_sorted()`](#static_frame.IndexDate.is_sorted)
* [`IndexDate.isfalsy()`](#static_frame.IndexDate.isfalsy)
* [`IndexDate.isin()`](#static_frame.IndexDate.isin)
* [`IndexDate.isna()`](#static_frame.IndexDate.isna)
* [`IndexDate.label_widths_at_depth()`](#static_frame.IndexDate.label_widths_at_depth)
* [`IndexDate.level_add()`](#static_frame.IndexDate.level_add)
* [`IndexDate.loc_searchsorted()`](#static_frame.IndexDate.loc_searchsorted)
* [`IndexDate.loc_to_iloc()`](#static_frame.IndexDate.loc_to_iloc)
* [`IndexDate.max()`](#static_frame.IndexDate.max)
* [`IndexDate.mean()`](#static_frame.IndexDate.mean)
* [`IndexDate.median()`](#static_frame.IndexDate.median)
* [`IndexDate.min()`](#static_frame.IndexDate.min)
* [`IndexDate.notfalsy()`](#static_frame.IndexDate.notfalsy)
* [`IndexDate.notna()`](#static_frame.IndexDate.notna)
* [`IndexDate.prod()`](#static_frame.IndexDate.prod)
* [`IndexDate.relabel()`](#static_frame.IndexDate.relabel)
* [`IndexDate.rename()`](#static_frame.IndexDate.rename)
* [`IndexDate.roll()`](#static_frame.IndexDate.roll)
* [`IndexDate.sample()`](#static_frame.IndexDate.sample)
* [`IndexDate.sort()`](#static_frame.IndexDate.sort)
* [`IndexDate.std()`](#static_frame.IndexDate.std)
* [`IndexDate.sum()`](#static_frame.IndexDate.sum)
* [`IndexDate.tail()`](#static_frame.IndexDate.tail)
* [`IndexDate.union()`](#static_frame.IndexDate.union)
* [`IndexDate.unique()`](#static_frame.IndexDate.unique)
* [`IndexDate.values_at_depth()`](#static_frame.IndexDate.values_at_depth)
* [`IndexDate.var()`](#static_frame.IndexDate.var)
