...
Detail: IndexDate: Exporter](index_date-exporter.md "previous page")
[next

Detail: IndexDate: Method](index_date-method.md "next page")

On this page

* [`IndexDate.STATIC`](#static_frame.IndexDate.STATIC)
* [`IndexDate.depth`](#static_frame.IndexDate.depth)
* [`IndexDate.dtype`](#static_frame.IndexDate.dtype)
* [`IndexDate.index_types`](#static_frame.IndexDate.index_types)
* [`IndexDate.memory`](#static_frame.IndexDate.memory)
* [`IndexDate.mloc`](#static_frame.IndexDate.mloc)
* [`IndexDate.name`](#static_frame.IndexDate.name)
* [`IndexDate.names`](#static_frame.IndexDate.names)
* [`IndexDate.nbytes`](#static_frame.IndexDate.nbytes)
* [`IndexDate.ndim`](#static_frame.IndexDate.ndim)
* [`IndexDate.positions`](#static_frame.IndexDate.positions)
* [`IndexDate.shape`](#static_frame.IndexDate.shape)
* [`IndexDate.size`](#static_frame.IndexDate.size)
