...
* [View page source](../_sources/api_detail/index_hierarchy_go-operator_unary.rst.txt)

[Previous](index_hierarchy_go-operator_binary.html "Detail: IndexHierarchyGO: Operator Binary")
[Next](index_hierarchy_go-accessor_values.html "Detail: IndexHierarchyGO: Accessor Values")

---

# Detail: IndexHierarchyGO: Operator Unary[](#detail-indexhierarchygo-operator-unary "Link to this heading")

[Overview: IndexHierarchyGO: Operator Unary](../api_overview/index_hierarchy_go-operator_unary.html#api-overview-indexhierarchygo-operator-unary)

IndexHierarchyGO.\_\_abs\_\_()[](#static_frame.IndexHierarchyGO.__abs__ "Link to this definition")
:   ```
...
IndexHierarchyGO.\_\_invert\_\_()[](#static_frame.IndexHierarchyGO.__invert__ "Link to this definition")
:   ```
...
IndexHierarchyGO.\_\_neg\_\_()[](#static_frame.IndexHierarchyGO.__neg__ "Link to this definition")
:   ```
    >>> ih = sf.IndexHierarchyGO.from_labels(((0, 1024, 32), (1, -2048, 32), (1, 1024, 32)), name=('x', 'y', 'z'))
    >>> ih
    <IndexHierarchyGO: ('x', 'y', 'z')>
...
IndexHierarchyGO.\_\_pos\_\_()[](#static_frame.IndexHierarchyGO.__pos__ "Link to this definition")
:   ```
    >>> ih = sf.IndexHierarchyGO.from_labels(((0, 1024, 32), (1, -2048, 32), (1, 1024, 32)), name=('x', 'y', 'z'))
    >>> ih
    <IndexHierarchyGO: ('x', 'y', 'z')>
