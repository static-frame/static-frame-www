...
* Detail: IndexGO: Accessor Regular Expression
* [View page source](../_sources/api_detail/index_go-accessor_regular_expression.rst.txt)

[Previous](index_go-accessor_string.html "Detail: IndexGO: Accessor String")
[Next](index_go-accessor_hashlib.html "Detail: IndexGO: Accessor Hashlib")

---

# Detail: IndexGO: Accessor Regular Expression[](#detail-indexgo-accessor-regular-expression "Link to this heading")

[Overview: IndexGO: Accessor Regular Expression](../api_overview/index_go-accessor_regular_expression.html#api-overview-indexgo-accessor-regular-expression)

IndexGO.via\_re(*pattern*, *flags).search(pos*, *endpos*)
...
IndexGO.via\_re(*pattern*, *flags).match(pos*, *endpos*)
:   via\_re *= <function Index.via\_re>*
...
IndexGO.via\_re(*pattern*, *flags).fullmatch(pos*, *endpos*)
:   via\_re *= <function Index.via\_re>*
...
IndexGO.via\_re(*pattern*, *flags).split(maxsplit*)
:   via\_re *= <function Index.via\_re>*
...
IndexGO.via\_re(*pattern*, *flags).findall(pos*, *endpos*)
:   via\_re *= <function Index.via\_re>*
...
IndexGO.via\_re(*pattern*, *flags).sub(repl*, *count*)
:   via\_re *= <function Index.via\_re>*
...
IndexGO.via\_re(*pattern*, *flags).subn(repl*, *count*)
:   via\_re *= <function Index.via\_re>*
