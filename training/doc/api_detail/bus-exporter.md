...
Detail: Bus: Constructor](bus-constructor.md "previous page")
[next

Detail: Bus: Attribute](bus-attribute.md "next page")
...
* [`Bus.to_xlsx()`](#static_frame.Bus.to_xlsx)
* [`Bus.to_zip_csv()`](#static_frame.Bus.to_zip_csv)
* [`Bus.to_zip_npy()`](#static_frame.Bus.to_zip_npy)
* [`Bus.to_zip_npz()`](#static_frame.Bus.to_zip_npz)
* [`Bus.to_zip_parquet()`](#static_frame.Bus.to_zip_parquet)
* [`Bus.to_zip_pickle()`](#static_frame.Bus.to_zip_pickle)
* [`Bus.to_zip_tsv()`](#static_frame.Bus.to_zip_tsv)
