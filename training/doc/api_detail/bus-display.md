...
:   A Frame documenting the interface of this class.
    ...
    <Index: signature>
    __init__(frames, /, *, index, ind... Bus      Constructor          Default Bus const...
    from_concat(containers, /, *, ind... Bus      Constructor          Concatenate multi...
    from_dict(mapping, /, *, name, in... Bus      Constructor          Bus construction ...
    from_frames(frames, /, *, index_c... Bus      Constructor          Return a Bus from...
    from_items(pairs, /, *, config, n... Bus      Constructor          Return a Bus from...
    from_series(series, /, *, store, ... Bus      Constructor          Create a Bus from...
    from_sqlite(fp, /, *, config, max... Bus      Constructor          Given a file path...
    from_xlsx(fp, /, *, config, max_p... Bus      Constructor          Given a file path...
    from_zip_csv(fp, /, *, config, ma... Bus      Constructor          Given a file path...
    from_zip_npy(fp, /, *, config, ma... Bus      Constructor          Given a file path...
    from_zip_npz(fp, /, *, config, ma... Bus      Constructor          Given a file path...
    from_zip_parquet(fp, /, *, config... Bus      Constructor          Given a file path...
    from_zip_pickle(fp, /, *, config,... Bus      Constructor          Given a file path...
    from_zip_tsv(fp, /, *, config, ma... Bus      Constructor          Given a file path...
    ...
    via_type_clinic.check(hint, /, *,... Bus      Accessor Type Clinic Given a hint (a t...
    via_type_clinic.warn(hint, /, *, ... Bus      Accessor Type Clinic Given a hint (a t...
...
Detail: Bus: Dictionary-Like](bus-dictionary_like.md "previous page")
[next

Detail: Bus: Selector](bus-selector.md "next page")

On this page

* [`Bus.interface`](#Bus.interface)
* [`Bus.__repr__()`](#static_frame.Bus.__repr__)
* [`Bus.__str__()`](#static_frame.Bus.__str__)
* [`Bus.display()`](#static_frame.Bus.display)
* [`Bus.display_tall()`](#static_frame.Bus.display_tall)
* [`Bus.display_wide()`](#static_frame.Bus.display_wide)
