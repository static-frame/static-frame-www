...
Detail: IndexYearMonth: Exporter](index_year_month-exporter.md "previous page")
[next

Detail: IndexYearMonth: Method](index_year_month-method.md "next page")

On this page

* [`IndexYearMonth.STATIC`](#static_frame.IndexYearMonth.STATIC)
* [`IndexYearMonth.depth`](#static_frame.IndexYearMonth.depth)
* [`IndexYearMonth.dtype`](#static_frame.IndexYearMonth.dtype)
* [`IndexYearMonth.index_types`](#static_frame.IndexYearMonth.index_types)
* [`IndexYearMonth.memory`](#static_frame.IndexYearMonth.memory)
* [`IndexYearMonth.mloc`](#static_frame.IndexYearMonth.mloc)
* [`IndexYearMonth.name`](#static_frame.IndexYearMonth.name)
* [`IndexYearMonth.names`](#static_frame.IndexYearMonth.names)
* [`IndexYearMonth.nbytes`](#static_frame.IndexYearMonth.nbytes)
* [`IndexYearMonth.ndim`](#static_frame.IndexYearMonth.ndim)
* [`IndexYearMonth.positions`](#static_frame.IndexYearMonth.positions)
* [`IndexYearMonth.shape`](#static_frame.IndexYearMonth.shape)
* [`IndexYearMonth.size`](#static_frame.IndexYearMonth.size)
