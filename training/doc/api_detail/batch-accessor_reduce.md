...
:   Batch.reduce
    ...
    >>> bt.reduce.from_func(lambda f: f.iloc[1:]).to_frame()
    <Frame>
    <Index>                a       b       <<U1>
    <IndexHierarchy>
    i                q     2       3
...
Batch.reduce.from\_map\_func(*func*, *\**, *fill\_value*)
:   Batch.reduce
    :   Return a `ReduceAligned` interface, permitting function application per column or on entire containers.
    ...
    >>> bt
    <Batch max_workers=None>
    >>> bt.reduce.from_map_func(np.min).to_frame()
    <Frame>
    <Index>                a       b       <<U1>
    <IndexHierarchy>
    i                x     0       1
...
Batch.reduce.from\_label\_map(*func\_map*, *\**, *fill\_value*)
:   Batch.reduce
    :   Return a `ReduceAligned` interface, permitting function application per column or on entire containers.
    ...
    >>> bt
    <Batch max_workers=None>
    >>> bt.reduce.from_label_map({'b': np.min, 'a': np.max}).to_frame()
    <Frame>
    <Index>                b       a       <<U1>
    <IndexHierarchy>
    i                x     1       4
...
Batch.reduce.from\_label\_pair\_map(*func\_map*, *\**, *fill\_value*)
:   Batch.reduce
    :   Return a `ReduceAligned` interface, permitting function application per column or on entire containers.
    ...
    >>> bt
    <Batch max_workers=None>
    >>> bt.reduce.from_label_pair_map({('b', 'b-min'): np.min, ('b', 'b-max'): np.max}).to_frame()
    <Frame>
