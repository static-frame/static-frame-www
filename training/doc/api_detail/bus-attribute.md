...
Detail: Bus: Exporter](bus-exporter.md "previous page")
[next

Detail: Bus: Method](bus-method.md "next page")

On this page

* [`Bus.STATIC`](#static_frame.Bus.STATIC)
* [`Bus.dtype`](#static_frame.Bus.dtype)
* [`Bus.dtypes`](#static_frame.Bus.dtypes)
* [`Bus.index`](#static_frame.Bus.index)
* [`Bus.inventory`](#static_frame.Bus.inventory)
* [`Bus.memory`](#static_frame.Bus.memory)
* [`Bus.mloc`](#static_frame.Bus.mloc)
* [`Bus.name`](#static_frame.Bus.name)
* [`Bus.nbytes`](#static_frame.Bus.nbytes)
* [`Bus.ndim`](#static_frame.Bus.ndim)
* [`Bus.shape`](#static_frame.Bus.shape)
* [`Bus.shapes`](#static_frame.Bus.shapes)
* [`Bus.size`](#static_frame.Bus.size)
* [`Bus.status`](#static_frame.Bus.status)
