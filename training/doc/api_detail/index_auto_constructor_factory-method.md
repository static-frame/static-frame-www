...
Detail: IndexAutoConstructorFactory: Exporter](index_auto_constructor_factory-exporter.md "previous page")
[next

Detail: IndexAutoConstructorFactory: Display](index_auto_constructor_factory-display.md "next page")

On this page

* [`IndexAutoConstructorFactory.__call__()`](#static_frame.IndexAutoConstructorFactory.__call__)
