...
:   Batch.via\_dt
    ...
    <Index>                a                    b                    <<U1>
    <IndexHierarchy>
    i                p     time.struct_time(tm… time.struct_time(tm…
    i                q     time.struct_time(tm… time.struct_time(tm…
    i                r     time.struct_time(tm… time.struct_time(tm…
    j                p     time.struct_time(tm… time.struct_time(tm…
    j                q     time.struct_time(tm… time.struct_time(tm…
    j                r     time.struct_time(tm… time.struct_time(tm…
    <<U1>            <<U1> <object>             <object>
    ```
...
Detail: Batch: Accessor Values](batch-accessor_values.md "previous page")
[next

Detail: Batch: Accessor String](batch-accessor_string.md "next page")
