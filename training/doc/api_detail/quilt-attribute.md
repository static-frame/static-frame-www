...
Detail: Quilt: Exporter](quilt-exporter.md "previous page")
[next

Detail: Quilt: Method](quilt-method.md "next page")

On this page

* [`Quilt.STATIC`](#static_frame.Quilt.STATIC)
* [`Quilt.bus`](#static_frame.Quilt.bus)
* [`Quilt.columns`](#static_frame.Quilt.columns)
* [`Quilt.index`](#static_frame.Quilt.index)
* [`Quilt.inventory`](#static_frame.Quilt.inventory)
* [`Quilt.memory`](#static_frame.Quilt.memory)
* [`Quilt.name`](#static_frame.Quilt.name)
* [`Quilt.nbytes`](#static_frame.Quilt.nbytes)
* [`Quilt.ndim`](#static_frame.Quilt.ndim)
* [`Quilt.shape`](#static_frame.Quilt.shape)
* [`Quilt.size`](#static_frame.Quilt.size)
* [`Quilt.status`](#static_frame.Quilt.status)
