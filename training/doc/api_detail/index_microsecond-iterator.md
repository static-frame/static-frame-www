...
* Detail: IndexMicrosecond: Iterator
* [View page source](../_sources/api_detail/index_microsecond-iterator.rst.txt)

[Previous](index_microsecond-selector.html "Detail: IndexMicrosecond: Selector")
[Next](index_microsecond-operator_binary.html "Detail: IndexMicrosecond: Operator Binary")

---

# Detail: IndexMicrosecond: Iterator[](#detail-indexmicrosecond-iterator "Link to this heading")

[Overview: IndexMicrosecond: Iterator](../api_overview/index_microsecond-iterator.html#api-overview-indexmicrosecond-iterator)

IndexMicrosecond.iter\_label(*depth\_level*)
:   iter\_label
...
IndexMicrosecond.iter\_label(*depth\_level).apply(func*, *\**, *dtype*, *name*, *index\_constructor*, *columns\_constructor*)
:   iter\_label
...
IndexMicrosecond.iter\_label(*depth\_level).apply\_iter(func*)
:   iter\_label
...
IndexMicrosecond.iter\_label(*depth\_level).apply\_iter\_items(func*)
:   iter\_label
...
IndexMicrosecond.iter\_label(*depth\_level).apply\_pool(func*, *\**, *dtype*, *name*, *index\_constructor*, *max\_workers*, *chunksize*, *use\_threads*)
:   iter\_label
