...
Detail: Series: Method](series-method.md "previous page")
[next

Detail: Series: Display](series-display.md "next page")

On this page

* [`Series.__contains__()`](#static_frame.Series.__contains__)
* [`Series.__iter__()`](#static_frame.Series.__iter__)
* [`Series.__reversed__()`](#static_frame.Series.__reversed__)
* [`Series.get()`](#static_frame.Series.get)
* [`Series.items()`](#static_frame.Series.items)
* [`Series.keys()`](#static_frame.Series.keys)
* [`Series.values`](#static_frame.Series.values)
