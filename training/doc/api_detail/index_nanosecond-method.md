...
IndexNanosecond.\_\_array\_\_(*dtype=None*, *copy=None*)[#](#static_frame.IndexNanosecond.__array__ "Link to this definition")
...
IndexNanosecond.\_\_bool\_\_()[#](#static_frame.IndexNanosecond.__bool__ "Link to this definition")
...
:   Perform difference with another Index, container, or NumPy array. Retains order.
    ...
    1799-11-09T00:00:00.000000000
    <datetime64[ns]>
    >>> ix2 = sf.IndexNanosecond(('2022-04-01', '2021-12-31', '2018-06-30'))
    >>> ix2
    <IndexNanosecond>
...
IndexNanosecond.insert\_after(*key*, *labels*, */*)[#](#static_frame.IndexNanosecond.insert_after "Link to this definition")
:   ```
    >>> ix = sf.IndexNanosecond(('1789-05-05', '1789-12-31', '1799-11-09'))
    >>> ix
    <IndexNanosecond>
...
IndexNanosecond.insert\_before(*key*, *labels*, */*)[#](#static_frame.IndexNanosecond.insert_before "Link to this definition")
:   ```
    >>> ix = sf.IndexNanosecond(('1789-05-05', '1789-12-31', '1799-11-09'))
    >>> ix
    <IndexNanosecond>
...
IndexNanosecond.is\_sorted(*\**, *ascending=True*, *kind='mergesort'*, *key=None*)[#](#static_frame.IndexNanosecond.is_sorted "Link to this definition")
:   Return True if this Index is sorted according to the specified parameters.
    ...
    ```
    >>> ix = sf.IndexNanosecond(('2022-04-01', '2021-12-31', '2018-06-30'))
    >>> ix
    <IndexNanosecond>
    2022-04-01T00:00:00.000000000
    2021-12-31T00:00:00.000000000
...
Detail: IndexNanosecond: Attribute](index_nanosecond-attribute.md "previous page")
[next

Detail: IndexNanosecond: Dictionary-Like](index_nanosecond-dictionary_like.md "next page")

On this page

* [`IndexNanosecond.__array__()`](#static_frame.IndexNanosecond.__array__)
* [`IndexNanosecond.__array_ufunc__()`](#static_frame.IndexNanosecond.__array_ufunc__)
* [`IndexNanosecond.__bool__()`](#static_frame.IndexNanosecond.__bool__)
* [`IndexNanosecond.__copy__()`](#static_frame.IndexNanosecond.__copy__)
* [`IndexNanosecond.__deepcopy__()`](#static_frame.IndexNanosecond.__deepcopy__)
* [`IndexNanosecond.__len__()`](#static_frame.IndexNanosecond.__len__)
* [`IndexNanosecond.all()`](#static_frame.IndexNanosecond.all)
* [`IndexNanosecond.any()`](#static_frame.IndexNanosecond.any)
* [`IndexNanosecond.astype()`](#static_frame.IndexNanosecond.astype)
* [`IndexNanosecond.copy()`](#static_frame.IndexNanosecond.copy)
* [`IndexNanosecond.cumprod()`](#static_frame.IndexNanosecond.cumprod)
* [`IndexNanosecond.cumsum()`](#static_frame.IndexNanosecond.cumsum)
* [`IndexNanosecond.difference()`](#static_frame.IndexNanosecond.difference)
* [`IndexNanosecond.dropfalsy()`](#static_frame.IndexNanosecond.dropfalsy)
* [`IndexNanosecond.dropna()`](#static_frame.IndexNanosecond.dropna)
* [`IndexNanosecond.equals()`](#static_frame.IndexNanosecond.equals)
* [`IndexNanosecond.fillfalsy()`](#static_frame.IndexNanosecond.fillfalsy)
* [`IndexNanosecond.fillna()`](#static_frame.IndexNanosecond.fillna)
* [`IndexNanosecond.head()`](#static_frame.IndexNanosecond.head)
* [`IndexNanosecond.iloc_searchsorted()`](#static_frame.IndexNanosecond.iloc_searchsorted)
* [`IndexNanosecond.insert_after()`](#static_frame.IndexNanosecond.insert_after)
* [`IndexNanosecond.insert_before()`](#static_frame.IndexNanosecond.insert_before)
* [`IndexNanosecond.intersection()`](#static_frame.IndexNanosecond.intersection)
* [`IndexNanosecond.is_sorted()`](#static_frame.IndexNanosecond.is_sorted)
* [`IndexNanosecond.isfalsy()`](#static_frame.IndexNanosecond.isfalsy)
* [`IndexNanosecond.isin()`](#static_frame.IndexNanosecond.isin)
* [`IndexNanosecond.isna()`](#static_frame.IndexNanosecond.isna)
* [`IndexNanosecond.label_widths_at_depth()`](#static_frame.IndexNanosecond.label_widths_at_depth)
* [`IndexNanosecond.level_add()`](#static_frame.IndexNanosecond.level_add)
* [`IndexNanosecond.loc_searchsorted()`](#static_frame.IndexNanosecond.loc_searchsorted)
* [`IndexNanosecond.loc_to_iloc()`](#static_frame.IndexNanosecond.loc_to_iloc)
* [`IndexNanosecond.max()`](#static_frame.IndexNanosecond.max)
* [`IndexNanosecond.mean()`](#static_frame.IndexNanosecond.mean)
* [`IndexNanosecond.median()`](#static_frame.IndexNanosecond.median)
* [`IndexNanosecond.min()`](#static_frame.IndexNanosecond.min)
* [`IndexNanosecond.notfalsy()`](#static_frame.IndexNanosecond.notfalsy)
* [`IndexNanosecond.notna()`](#static_frame.IndexNanosecond.notna)
* [`IndexNanosecond.prod()`](#static_frame.IndexNanosecond.prod)
* [`IndexNanosecond.relabel()`](#static_frame.IndexNanosecond.relabel)
* [`IndexNanosecond.rename()`](#static_frame.IndexNanosecond.rename)
* [`IndexNanosecond.roll()`](#static_frame.IndexNanosecond.roll)
* [`IndexNanosecond.sample()`](#static_frame.IndexNanosecond.sample)
* [`IndexNanosecond.sort()`](#static_frame.IndexNanosecond.sort)
* [`IndexNanosecond.std()`](#static_frame.IndexNanosecond.std)
* [`IndexNanosecond.sum()`](#static_frame.IndexNanosecond.sum)
* [`IndexNanosecond.tail()`](#static_frame.IndexNanosecond.tail)
* [`IndexNanosecond.union()`](#static_frame.IndexNanosecond.union)
* [`IndexNanosecond.unique()`](#static_frame.IndexNanosecond.unique)
* [`IndexNanosecond.values_at_depth()`](#static_frame.IndexNanosecond.values_at_depth)
* [`IndexNanosecond.var()`](#static_frame.IndexNanosecond.var)
