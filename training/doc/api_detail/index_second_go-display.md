...
:   A Frame documenting the interface of this class.
    ...
    <Index: signature>
    __init__(labels, /, *, loc_is_ilo... IndexSecondGO Constructor          Initializer. Args...
    from_difference(*others)             IndexSecondGO Constructor          Construct a new I...
    from_intersection(*others)           IndexSecondGO Constructor          Construct a new I...
    ...
    from_union(*others)                  IndexSecondGO Constructor          Construct a new I...
    to_html(config, /, *, style_config)  IndexSecondGO Exporter             Return an HTML ta...
    to_html_datatables(fp, /, *, show... IndexSecondGO Exporter             Return a complete...
    ...
    ...                                  ...           ...                  ...
    via_re(pattern, flags, /).sub(rep... IndexSecondGO Accessor Regular ... Return the string...
    via_re(pattern, flags, /).subn(re... IndexSecondGO Accessor Regular ... Perform the same ...
    ...
    via_type_clinic.check(hint, /, *,... IndexSecondGO Accessor Type Clinic Given a hint (a t...
    via_type_clinic.warn(hint, /, *, ... IndexSecondGO Accessor Type Clinic Given a hint (a t...
...
Detail: IndexSecondGO: Dictionary-Like](index_second_go-dictionary_like.md "previous page")
[next

Detail: IndexSecondGO: Selector](index_second_go-selector.md "next page")

On this page

* [`IndexSecondGO.interface`](#IndexSecondGO.interface)
* [`IndexSecondGO.__repr__()`](#static_frame.IndexSecondGO.__repr__)
* [`IndexSecondGO.__str__()`](#static_frame.IndexSecondGO.__str__)
* [`IndexSecondGO.display()`](#static_frame.IndexSecondGO.display)
* [`IndexSecondGO.display_tall()`](#static_frame.IndexSecondGO.display_tall)
* [`IndexSecondGO.display_wide()`](#static_frame.IndexSecondGO.display_wide)
