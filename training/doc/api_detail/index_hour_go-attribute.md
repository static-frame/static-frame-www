...
:   A [`MemoryDisplay`](memory_display.md#static_frame.MemoryDisplay "static_frame.MemoryDisplay"), providing the size in memory of this object. For compound containers, component sizes will also be provided. Size can be interpreted through six combinations of three configurations:
...
Detail: IndexHourGO: Exporter](index_hour_go-exporter.md "previous page")
[next

Detail: IndexHourGO: Method](index_hour_go-method.md "next page")

On this page

* [`IndexHourGO.STATIC`](#static_frame.IndexHourGO.STATIC)
* [`IndexHourGO.depth`](#static_frame.IndexHourGO.depth)
* [`IndexHourGO.dtype`](#static_frame.IndexHourGO.dtype)
* [`IndexHourGO.index_types`](#static_frame.IndexHourGO.index_types)
* [`IndexHourGO.memory`](#static_frame.IndexHourGO.memory)
* [`IndexHourGO.mloc`](#static_frame.IndexHourGO.mloc)
* [`IndexHourGO.name`](#static_frame.IndexHourGO.name)
* [`IndexHourGO.names`](#static_frame.IndexHourGO.names)
* [`IndexHourGO.nbytes`](#static_frame.IndexHourGO.nbytes)
* [`IndexHourGO.ndim`](#static_frame.IndexHourGO.ndim)
* [`IndexHourGO.positions`](#static_frame.IndexHourGO.positions)
* [`IndexHourGO.shape`](#static_frame.IndexHourGO.shape)
* [`IndexHourGO.size`](#static_frame.IndexHourGO.size)
