...
:   consolidate
    ...
    ```
    >>> f1 = sf.FrameHE.from_fields(((0, 0, 10, 2), (20, 18, -3, 18), (0, 0, 0, 1), (False, True, True, False), (True, True, False, True)), columns=('a', 'b', 'c', 'd', 'e'), name='x')
    >>> f1
    <FrameHE: x>
    <Index>      a       b       c       d      e      <<U1>
    <Index>
...
Detail: FrameHE: Attribute](frame_he-attribute.md "previous page")
[next

Detail: FrameHE: Dictionary-Like](frame_he-dictionary_like.md "next page")
...
* [`FrameHE.__round__()`](#static_frame.FrameHE.__round__)
* [`FrameHE.all()`](#static_frame.FrameHE.all)
* [`FrameHE.any()`](#static_frame.FrameHE.any)
* [`FrameHE.clip()`](#static_frame.FrameHE.clip)
* [`FrameHE.corr()`](#static_frame.FrameHE.corr)
* [`FrameHE.count()`](#static_frame.FrameHE.count)
* [`FrameHE.cov()`](#static_frame.FrameHE.cov)
* [`FrameHE.cumprod()`](#static_frame.FrameHE.cumprod)
* [`FrameHE.cumsum()`](#static_frame.FrameHE.cumsum)
* [`FrameHE.drop_duplicated()`](#static_frame.FrameHE.drop_duplicated)
* [`FrameHE.dropfalsy()`](#static_frame.FrameHE.dropfalsy)
* [`FrameHE.dropna()`](#static_frame.FrameHE.dropna)
* [`FrameHE.duplicated()`](#static_frame.FrameHE.duplicated)
* [`FrameHE.equals()`](#static_frame.FrameHE.equals)
* [`FrameHE.fillfalsy()`](#static_frame.FrameHE.fillfalsy)
* [`FrameHE.fillfalsy_backward()`](#static_frame.FrameHE.fillfalsy_backward)
* [`FrameHE.fillfalsy_forward()`](#static_frame.FrameHE.fillfalsy_forward)
* [`FrameHE.fillfalsy_leading()`](#static_frame.FrameHE.fillfalsy_leading)
* [`FrameHE.fillfalsy_trailing()`](#static_frame.FrameHE.fillfalsy_trailing)
* [`FrameHE.fillna()`](#static_frame.FrameHE.fillna)
* [`FrameHE.fillna_backward()`](#static_frame.FrameHE.fillna_backward)
* [`FrameHE.fillna_forward()`](#static_frame.FrameHE.fillna_forward)
* [`FrameHE.fillna_leading()`](#static_frame.FrameHE.fillna_leading)
* [`FrameHE.fillna_trailing()`](#static_frame.FrameHE.fillna_trailing)
* [`FrameHE.head()`](#static_frame.FrameHE.head)
* [`FrameHE.iloc_max()`](#static_frame.FrameHE.iloc_max)
* [`FrameHE.iloc_min()`](#static_frame.FrameHE.iloc_min)
* [`FrameHE.iloc_notfalsy_first()`](#static_frame.FrameHE.iloc_notfalsy_first)
* [`FrameHE.iloc_notfalsy_last()`](#static_frame.FrameHE.iloc_notfalsy_last)
* [`FrameHE.iloc_notna_first()`](#static_frame.FrameHE.iloc_notna_first)
* [`FrameHE.iloc_notna_last()`](#static_frame.FrameHE.iloc_notna_last)
* [`FrameHE.insert_after()`](#static_frame.FrameHE.insert_after)
* [`FrameHE.insert_before()`](#static_frame.FrameHE.insert_before)
* [`FrameHE.isfalsy()`](#static_frame.FrameHE.isfalsy)
* [`FrameHE.isin()`](#static_frame.FrameHE.isin)
* [`FrameHE.isna()`](#static_frame.FrameHE.isna)
* [`FrameHE.join_inner()`](#static_frame.FrameHE.join_inner)
* [`FrameHE.join_left()`](#static_frame.FrameHE.join_left)
* [`FrameHE.join_outer()`](#static_frame.FrameHE.join_outer)
* [`FrameHE.join_right()`](#static_frame.FrameHE.join_right)
* [`FrameHE.loc_max()`](#static_frame.FrameHE.loc_max)
* [`FrameHE.loc_min()`](#static_frame.FrameHE.loc_min)
* [`FrameHE.loc_notfalsy_first()`](#static_frame.FrameHE.loc_notfalsy_first)
* [`FrameHE.loc_notfalsy_last()`](#static_frame.FrameHE.loc_notfalsy_last)
* [`FrameHE.loc_notna_first()`](#static_frame.FrameHE.loc_notna_first)
* [`FrameHE.loc_notna_last()`](#static_frame.FrameHE.loc_notna_last)
* [`FrameHE.max()`](#static_frame.FrameHE.max)
* [`FrameHE.mean()`](#static_frame.FrameHE.mean)
* [`FrameHE.median()`](#static_frame.FrameHE.median)
* [`FrameHE.merge_inner()`](#static_frame.FrameHE.merge_inner)
* [`FrameHE.merge_left()`](#static_frame.FrameHE.merge_left)
* [`FrameHE.merge_outer()`](#static_frame.FrameHE.merge_outer)
* [`FrameHE.merge_right()`](#static_frame.FrameHE.merge_right)
* [`FrameHE.min()`](#static_frame.FrameHE.min)
* [`FrameHE.notfalsy()`](#static_frame.FrameHE.notfalsy)
* [`FrameHE.notna()`](#static_frame.FrameHE.notna)
* [`FrameHE.pivot()`](#static_frame.FrameHE.pivot)
* [`FrameHE.pivot_stack()`](#static_frame.FrameHE.pivot_stack)
* [`FrameHE.pivot_unstack()`](#static_frame.FrameHE.pivot_unstack)
* [`FrameHE.prod()`](#static_frame.FrameHE.prod)
* [`FrameHE.rank_dense()`](#static_frame.FrameHE.rank_dense)
* [`FrameHE.rank_max()`](#static_frame.FrameHE.rank_max)
* [`FrameHE.rank_mean()`](#static_frame.FrameHE.rank_mean)
* [`FrameHE.rank_min()`](#static_frame.FrameHE.rank_min)
* [`FrameHE.rank_ordinal()`](#static_frame.FrameHE.rank_ordinal)
* [`FrameHE.rehierarch()`](#static_frame.FrameHE.rehierarch)
* [`FrameHE.reindex()`](#static_frame.FrameHE.reindex)
* [`FrameHE.relabel()`](#static_frame.FrameHE.relabel)
* [`FrameHE.relabel_flat()`](#static_frame.FrameHE.relabel_flat)
* [`FrameHE.relabel_level_add()`](#static_frame.FrameHE.relabel_level_add)
* [`FrameHE.relabel_level_drop()`](#static_frame.FrameHE.relabel_level_drop)
* [`FrameHE.relabel_shift_in()`](#static_frame.FrameHE.relabel_shift_in)
* [`FrameHE.relabel_shift_out()`](#static_frame.FrameHE.relabel_shift_out)
* [`FrameHE.rename()`](#static_frame.FrameHE.rename)
* [`FrameHE.roll()`](#static_frame.FrameHE.roll)
* [`FrameHE.sample()`](#static_frame.FrameHE.sample)
* [`FrameHE.set_columns()`](#static_frame.FrameHE.set_columns)
* [`FrameHE.set_columns_hierarchy()`](#static_frame.FrameHE.set_columns_hierarchy)
* [`FrameHE.set_index()`](#static_frame.FrameHE.set_index)
* [`FrameHE.set_index_hierarchy()`](#static_frame.FrameHE.set_index_hierarchy)
* [`FrameHE.shift()`](#static_frame.FrameHE.shift)
* [`FrameHE.sort_columns()`](#static_frame.FrameHE.sort_columns)
* [`FrameHE.sort_index()`](#static_frame.FrameHE.sort_index)
* [`FrameHE.sort_values()`](#static_frame.FrameHE.sort_values)
* [`FrameHE.std()`](#static_frame.FrameHE.std)
* [`FrameHE.sum()`](#static_frame.FrameHE.sum)
* [`FrameHE.tail()`](#static_frame.FrameHE.tail)
* [`FrameHE.transpose()`](#static_frame.FrameHE.transpose)
* [`FrameHE.unique()`](#static_frame.FrameHE.unique)
* [`FrameHE.unique_enumerated()`](#static_frame.FrameHE.unique_enumerated)
* [`FrameHE.unset_columns()`](#static_frame.FrameHE.unset_columns)
* [`FrameHE.unset_index()`](#static_frame.FrameHE.unset_index)
* [`FrameHE.var()`](#static_frame.FrameHE.var)
