...
Detail: Frame: Exporter](frame-exporter.md "previous page")
[next

Detail: Frame: Method](frame-method.md "next page")

On this page

* [`Frame.STATIC`](#static_frame.Frame.STATIC)
* [`Frame.T`](#static_frame.Frame.T)
* [`Frame.columns`](#static_frame.Frame.columns)
* [`Frame.dtypes`](#static_frame.Frame.dtypes)
* [`Frame.index`](#static_frame.Frame.index)
* [`Frame.memory`](#static_frame.Frame.memory)
* [`Frame.mloc`](#static_frame.Frame.mloc)
* [`Frame.name`](#static_frame.Frame.name)
* [`Frame.nbytes`](#static_frame.Frame.nbytes)
* [`Frame.ndim`](#static_frame.Frame.ndim)
* [`Frame.shape`](#static_frame.Frame.shape)
* [`Frame.size`](#static_frame.Frame.size)
