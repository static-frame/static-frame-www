...
* Detail: IndexMinuteGO: Accessor Datetime
* [View page source](../_sources/api_detail/index_minute_go-accessor_datetime.rst.txt)

[Previous](index_minute_go-accessor_values.html "Detail: IndexMinuteGO: Accessor Values")
[Next](index_minute_go-accessor_string.html "Detail: IndexMinuteGO: Accessor String")

---

# Detail: IndexMinuteGO: Accessor Datetime[](#detail-indexminutego-accessor-datetime "Link to this heading")

[Overview: IndexMinuteGO: Accessor Datetime](../api_overview/index_minute_go-accessor_datetime.html#api-overview-indexminutego-accessor-datetime)

IndexMinuteGO.via\_dt.\_\_call\_\_(*\**, *fill\_value*)
:   IndexMinuteGO.via\_dt
...
IndexMinuteGO.via\_dt.year\_month
:   IndexMinuteGO.via\_dt
    :   Interface for applying datetime properties and methods to elements in this container.
...
IndexMinuteGO.via\_dt.year\_quarter
:   IndexMinuteGO.via\_dt
    :   Interface for applying datetime properties and methods to elements in this container.
...
IndexMinuteGO.via\_dt.is\_month\_end
:   IndexMinuteGO.via\_dt
    :   Interface for applying datetime properties and methods to elements in this container.
...
IndexMinuteGO.via\_dt.is\_month\_start
:   IndexMinuteGO.via\_dt
    :   Interface for applying datetime properties and methods to elements in this container.
...
IndexMinuteGO.via\_dt.is\_year\_end
:   IndexMinuteGO.via\_dt
    :   Interface for applying datetime properties and methods to elements in this container.
...
IndexMinuteGO.via\_dt.is\_year\_start
:   IndexMinuteGO.via\_dt
    :   Interface for applying datetime properties and methods to elements in this container.
...
IndexMinuteGO.via\_dt.is\_quarter\_end
:   IndexMinuteGO.via\_dt
    :   Interface for applying datetime properties and methods to elements in this container.
...
IndexMinuteGO.via\_dt.is\_quarter\_start
:   IndexMinuteGO.via\_dt
    :   Interface for applying datetime properties and methods to elements in this container.
...
IndexMinuteGO.via\_dt.timetuple
:   IndexMinuteGO.via\_dt
    :   Interface for applying datetime properties and methods to elements in this container.
...
IndexMinuteGO.via\_dt.isoformat(*\**, *sep*, *timespec*)
:   IndexMinuteGO.via\_dt
    :   Interface for applying datetime properties and methods to elements in this container.
...
IndexMinuteGO.via\_dt.fromisoformat
:   IndexMinuteGO.via\_dt
    :   Interface for applying datetime properties and methods to elements in this container.
...
IndexMinuteGO.via\_dt.strftime(*format*)
:   IndexMinuteGO.via\_dt
    :   Interface for applying datetime properties and methods to elements in this container.
...
IndexMinuteGO.via\_dt.strptime(*format*)
:   IndexMinuteGO.via\_dt
    :   Interface for applying datetime properties and methods to elements in this container.
...
IndexMinuteGO.via\_dt.strpdate(*format*)
:   IndexMinuteGO.via\_dt
    :   Interface for applying datetime properties and methods to elements in this container.
