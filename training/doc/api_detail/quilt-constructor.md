...
Detail: Yarn: Accessor Type Clinic](yarn-accessor_type_clinic.md "previous page")
[next

Detail: Quilt: Exporter](quilt-exporter.md "next page")

On this page

* [`Quilt.__init__()`](#static_frame.Quilt.__init__)
* [`Quilt.from_frame()`](#static_frame.Quilt.from_frame)
* [`Quilt.from_frames()`](#static_frame.Quilt.from_frames)
* [`Quilt.from_items()`](#static_frame.Quilt.from_items)
* [`Quilt.from_sqlite()`](#static_frame.Quilt.from_sqlite)
* [`Quilt.from_xlsx()`](#static_frame.Quilt.from_xlsx)
* [`Quilt.from_zip_csv()`](#static_frame.Quilt.from_zip_csv)
* [`Quilt.from_zip_npy()`](#static_frame.Quilt.from_zip_npy)
* [`Quilt.from_zip_npz()`](#static_frame.Quilt.from_zip_npz)
* [`Quilt.from_zip_parquet()`](#static_frame.Quilt.from_zip_parquet)
* [`Quilt.from_zip_pickle()`](#static_frame.Quilt.from_zip_pickle)
* [`Quilt.from_zip_tsv()`](#static_frame.Quilt.from_zip_tsv)
