...
StoreConfig.read\_frame\_filter[#](#static_frame.StoreConfig.read_frame_filter "Link to this definition")
...
Detail: StoreConfig: Exporter](store_config-exporter.md "previous page")
[next

Detail: StoreConfig: Method](store_config-method.md "next page")

On this page

* [`StoreConfig.columns_constructors`](#static_frame.StoreConfig.columns_constructors)
* [`StoreConfig.columns_depth`](#static_frame.StoreConfig.columns_depth)
* [`StoreConfig.columns_name_depth_level`](#static_frame.StoreConfig.columns_name_depth_level)
* [`StoreConfig.columns_select`](#static_frame.StoreConfig.columns_select)
* [`StoreConfig.consolidate_blocks`](#static_frame.StoreConfig.consolidate_blocks)
* [`StoreConfig.dtypes`](#static_frame.StoreConfig.dtypes)
* [`StoreConfig.include_columns`](#static_frame.StoreConfig.include_columns)
* [`StoreConfig.include_columns_name`](#static_frame.StoreConfig.include_columns_name)
* [`StoreConfig.include_index`](#static_frame.StoreConfig.include_index)
* [`StoreConfig.include_index_name`](#static_frame.StoreConfig.include_index_name)
* [`StoreConfig.index_constructors`](#static_frame.StoreConfig.index_constructors)
* [`StoreConfig.index_depth`](#static_frame.StoreConfig.index_depth)
* [`StoreConfig.index_name_depth_level`](#static_frame.StoreConfig.index_name_depth_level)
* [`StoreConfig.label_decoder`](#static_frame.StoreConfig.label_decoder)
* [`StoreConfig.label_encoder`](#static_frame.StoreConfig.label_encoder)
* [`StoreConfig.merge_hierarchical_labels`](#static_frame.StoreConfig.merge_hierarchical_labels)
* [`StoreConfig.mp_context`](#static_frame.StoreConfig.mp_context)
* [`StoreConfig.read_chunksize`](#static_frame.StoreConfig.read_chunksize)
* [`StoreConfig.read_frame_filter`](#static_frame.StoreConfig.read_frame_filter)
