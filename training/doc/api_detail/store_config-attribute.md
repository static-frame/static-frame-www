...
StoreConfig.columns\_depth[](#static_frame.StoreConfig.columns_depth "Link to this definition")

StoreConfig.columns\_name\_depth\_level[](#static_frame.StoreConfig.columns_name_depth_level "Link to this definition")

StoreConfig.columns\_select[](#static_frame.StoreConfig.columns_select "Link to this definition")

StoreConfig.consolidate\_blocks[](#static_frame.StoreConfig.consolidate_blocks "Link to this definition")

StoreConfig.dtypes[](#static_frame.StoreConfig.dtypes "Link to this definition")

StoreConfig.include\_columns[](#static_frame.StoreConfig.include_columns "Link to this definition")

StoreConfig.include\_columns\_name[](#static_frame.StoreConfig.include_columns_name "Link to this definition")

StoreConfig.include\_index[](#static_frame.StoreConfig.include_index "Link to this definition")

StoreConfig.include\_index\_name[](#static_frame.StoreConfig.include_index_name "Link to this definition")

StoreConfig.index\_constructors[](#static_frame.StoreConfig.index_constructors "Link to this definition")

StoreConfig.index\_depth[](#static_frame.StoreConfig.index_depth "Link to this definition")

StoreConfig.index\_name\_depth\_level[](#static_frame.StoreConfig.index_name_depth_level "Link to this definition")

StoreConfig.label\_decoder[](#static_frame.StoreConfig.label_decoder "Link to this definition")

StoreConfig.label\_encoder[](#static_frame.StoreConfig.label_encoder "Link to this definition")

StoreConfig.merge\_hierarchical\_labels[](#static_frame.StoreConfig.merge_hierarchical_labels "Link to this definition")

StoreConfig.mp\_context[](#static_frame.StoreConfig.mp_context "Link to this definition")

StoreConfig.read\_chunksize[](#static_frame.StoreConfig.read_chunksize "Link to this definition")

StoreConfig.read\_max\_workers[](#static_frame.StoreConfig.read_max_workers "Link to this definition")

StoreConfig.skip\_footer[](#static_frame.StoreConfig.skip_footer "Link to this definition")
