...
Detail: FrameHE: Method](frame_he-method.md "previous page")
[next

Detail: FrameHE: Display](frame_he-display.md "next page")

On this page

* [`FrameHE.__contains__()`](#static_frame.FrameHE.__contains__)
* [`FrameHE.__iter__()`](#static_frame.FrameHE.__iter__)
* [`FrameHE.__reversed__()`](#static_frame.FrameHE.__reversed__)
* [`FrameHE.get()`](#static_frame.FrameHE.get)
* [`FrameHE.items()`](#static_frame.FrameHE.items)
* [`FrameHE.keys()`](#static_frame.FrameHE.keys)
* [`FrameHE.values`](#static_frame.FrameHE.values)
