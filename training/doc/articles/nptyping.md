...
# Do More with NumPy Array Type Hints: Annotate & Validate Shape & Dtype[#](#do-more-with-numpy-array-type-hints-annotate-validate-shape-dtype "Link to this heading")
...
## Generic Types in Python[#](#generic-types-in-python "Link to this heading")
...
## The Generic `np.ndarray`[#](#the-generic-np-ndarray "Link to this heading")
...
### The Shape Type Parameter[#](#the-shape-type-parameter "Link to this heading")
...
### The `dtype` Type Parameter[#](#the-dtype-type-parameter "Link to this heading")
...
## Making `np.ndarray` Concrete[#](#making-np-ndarray-concrete "Link to this heading")
...
## Static Type Checking with Mypy[#](#static-type-checking-with-mypy "Link to this heading")
...
## Runtime Validation with `sf.CallGuard`[#](#runtime-validation-with-sf-callguard "Link to this heading")
...
Liberating Performance with Immutable DataFrames in Free-Threaded Python](freethread.md "previous page")
[next

Improving Code Quality with Array and DataFrame Type Hints](guard.md "next page")

On this page

* [Generic Types in Python](#generic-types-in-python)
* [The Generic `np.ndarray`](#the-generic-np-ndarray)
  + [The Shape Type Parameter](#the-shape-type-parameter)
  + [The `dtype` Type Parameter](#the-dtype-type-parameter)
* [Making `np.ndarray` Concrete](#making-np-ndarray-concrete)
* [Static Type Checking with Mypy](#static-type-checking-with-mypy)
* [Runtime Validation with `sf.CallGuard`](#runtime-validation-with-sf-callguard)
