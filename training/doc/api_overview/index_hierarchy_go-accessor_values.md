...
[Previous](index_hierarchy_go-operator_unary.md "Overview: IndexHierarchyGO: Operator Unary")
[Next](index_hierarchy_go-accessor_datetime.md "Overview: IndexHierarchyGO: Accessor Datetime")

---

# Overview: IndexHierarchyGO: Accessor Values[](#overview-indexhierarchygo-accessor-values "Link to this heading")

[Detail: IndexHierarchyGO: Accessor Values](../api_detail/index_hierarchy_go-accessor_values.md#api-detail-indexhierarchygo-accessor-values)

|  |  |  |
| --- | --- | --- |
| [Detail](../api_detail/index_hierarchy_go-accessor_values.md#api-sig-indexhierarchygo-via-values-apply) | `IndexHierarchyGO.via_values.apply(func, *args, **kwargs)` |  |
| [Detail](../api_detail/index_hierarchy_go-accessor_values.md#api-sig-indexhierarchygo-via-values-array-ufunc) | `IndexHierarchyGO.via_values.__array_ufunc__(ufunc, method, *args, **kwargs)` | Support for applying NumPy functions directly on containers. |
| [Detail](../api_detail/index_hierarchy_go-accessor_values.md#api-sig-indexhierarchygo-via-values-call) | `IndexHierarchyGO.via_values.__call__(*, consolidate_blocks, unify_blocks, dtype)` | Args: consolidate\_blocks: Group adjacent same-typed arrays into 2D arrays. unify… |
