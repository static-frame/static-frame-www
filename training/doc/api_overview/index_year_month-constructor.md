...
|  |  |  |
| --- | --- | --- |
| [Detail](../api_detail/index_year_month-constructor.md#api-sig-indexyearmonth-init) | `IndexYearMonth.__init__(labels, /, *, loc_is_iloc, name, sort_status)` | Initializer. Args: labels: Iterable of hashable values to be used as the index l… |
...
| [Detail](../api_detail/index_year_month-constructor.md#api-sig-indexyearmonth-from-difference) | `IndexYearMonth.from_difference(*others)` | Construct a new Index based on the difference with Index, containers, or NumPy a… |
| [Detail](../api_detail/index_year_month-constructor.md#api-sig-indexyearmonth-from-intersection) | `IndexYearMonth.from_intersection(*others)` | Construct a new Index based on the intersection with Index, containers, or NumPy… |
...
| [Detail](../api_detail/index_year_month-constructor.md#api-sig-indexyearmonth-from-union) | `IndexYearMonth.from_union(*others)` | Construct a new Index based on the union with Index, containers, or NumPy arrays… |
...
Overview: IndexYearGO: Accessor Type Clinic](index_year_go-accessor_type_clinic.md "previous page")
[next

Overview: IndexYearMonth: Exporter](index_year_month-exporter.md "next page")
