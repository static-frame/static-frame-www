...
| [Detail](../api_detail/index_second_go-accessor_string.html#api-sig-indexsecondgo-via-str-lstrip) | `IndexSecondGO.via_str.lstrip(chars)` | For each element, return a copy with the leading characters removed. |
