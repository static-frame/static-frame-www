...
|  |  |  |
| --- | --- | --- |
| [Detail](../api_detail/batch-method.md#api-sig-batch-array) | `Batch.__array__(dtype, copy)` | Support the \_\_array\_\_ interface, returning an array of values. |
...
Overview: Batch: Attribute](batch-attribute.md "previous page")
[next

Overview: Batch: Dictionary-Like](batch-dictionary_like.md "next page")
