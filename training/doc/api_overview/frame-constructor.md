...
| [Detail](../api_detail/frame-constructor.md#api-sig-frame-from-display) | `Frame.from_display(display, /)` | Construct a Frame from a string that was produced by repr(frame) (i.e. the outpu… |
...
Overview: SeriesHE: Accessor Mapping](series_he-accessor_mapping.md "previous page")
[next

Overview: Frame: Exporter](frame-exporter.md "next page")
