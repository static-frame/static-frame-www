...
| [Detail](../api_detail/index_hour-method.md#api-sig-indexhour-level-add) | `IndexHour.level_add(level, *, index_constructor)` | Return an IndexHierarchy with an added root level. Args: level: A hashable to us… |
