...
[Previous](frame-method.md "Overview: Frame: Method")
[Next](frame-display.md "Overview: Frame: Display")

---

# Overview: Frame: Dictionary-Like[](#overview-frame-dictionary-like "Link to this heading")

[Detail: Frame: Dictionary-Like](../api_detail/frame-dictionary_like.md#api-detail-frame-dictionary-like)

|  |  |  |
| --- | --- | --- |
| [Detail](../api_detail/frame-dictionary_like.md#api-sig-frame-contains) | `Frame.__contains__(value)` | Inclusion of value in column labels. |
| [Detail](../api_detail/frame-dictionary_like.md#api-sig-frame-iter) | `Frame.__iter__()` | Iterator of column labels, same as Frame.keys. |
| [Detail](../api_detail/frame-dictionary_like.md#api-sig-frame-reversed) | `Frame.__reversed__()` | Returns a reverse iterator on the frame’s columns. |
| [Detail](../api_detail/frame-dictionary_like.md#api-sig-frame-get) | `Frame.get(key, default)` | Return the value found at the columns key, else the default if the key is not fo… |
| [Detail](../api_detail/frame-dictionary_like.md#api-sig-frame-items) | `Frame.items()` | Iterator of pairs of column label and corresponding column Series. |
| [Detail](../api_detail/frame-dictionary_like.md#api-sig-frame-keys) | `Frame.keys()` | Iterator of column labels. |
| [Detail](../api_detail/frame-dictionary_like.md#api-sig-frame-values) | `Frame.values` | A 2D NumPy array of all values in the Frame. As this is a single array, heteroge… |
