...
| [Detail](../api_detail/frame_he-attribute.md#api-sig-framehe-memory) | `FrameHE.memory` | A MemoryDisplay, providing the size in memory of this object. For compound conta… |
...
Overview: FrameHE: Exporter](frame_he-exporter.md "previous page")
[next

Overview: FrameHE: Method](frame_he-method.md "next page")
