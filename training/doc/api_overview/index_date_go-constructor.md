...
|  |  |  |
| --- | --- | --- |
| [Detail](../api_detail/index_date_go-constructor.md#api-sig-indexdatego-init) | `IndexDateGO.__init__(labels, /, *, loc_is_iloc, name, sort_status)` | Initializer. Args: labels: Iterable of hashable values to be used as the index l… |
...
| [Detail](../api_detail/index_date_go-constructor.md#api-sig-indexdatego-from-difference) | `IndexDateGO.from_difference(*others)` | Construct a new Index based on the difference with Index, containers, or NumPy a… |
| [Detail](../api_detail/index_date_go-constructor.md#api-sig-indexdatego-from-intersection) | `IndexDateGO.from_intersection(*others)` | Construct a new Index based on the intersection with Index, containers, or NumPy… |
...
| [Detail](../api_detail/index_date_go-constructor.md#api-sig-indexdatego-from-union) | `IndexDateGO.from_union(*others)` | Construct a new Index based on the union with Index, containers, or NumPy arrays… |
...
Overview: IndexDate: Accessor Type Clinic](index_date-accessor_type_clinic.md "previous page")
[next

Overview: IndexDateGO: Exporter](index_date_go-exporter.md "next page")
