...
| [Detail](../api_detail/index_nanosecond_go-accessor_string.html#api-sig-indexnanosecondgo-via-str-len) | `IndexNanosecondGO.via_str.len()` | Return the length of the string. |
