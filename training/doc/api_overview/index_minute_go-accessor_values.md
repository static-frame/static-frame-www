...
[Previous](index_minute_go-operator_unary.md "Overview: IndexMinuteGO: Operator Unary")
[Next](index_minute_go-accessor_datetime.md "Overview: IndexMinuteGO: Accessor Datetime")

---

# Overview: IndexMinuteGO: Accessor Values[](#overview-indexminutego-accessor-values "Link to this heading")

[Detail: IndexMinuteGO: Accessor Values](../api_detail/index_minute_go-accessor_values.md#api-detail-indexminutego-accessor-values)

|  |  |  |
| --- | --- | --- |
| [Detail](../api_detail/index_minute_go-accessor_values.md#api-sig-indexminutego-via-values-apply) | `IndexMinuteGO.via_values.apply(func, *args, **kwargs)` |  |
| [Detail](../api_detail/index_minute_go-accessor_values.md#api-sig-indexminutego-via-values-array-ufunc) | `IndexMinuteGO.via_values.__array_ufunc__(ufunc, method, *args, **kwargs)` | Support for applying NumPy functions directly on containers. |
| [Detail](../api_detail/index_minute_go-accessor_values.md#api-sig-indexminutego-via-values-call) | `IndexMinuteGO.via_values.__call__(*, consolidate_blocks, unify_blocks, dtype)` | Args: consolidate\_blocks: Group adjacent same-typed arrays into 2D arrays. unify… |
