...
|  |  |  |
| --- | --- | --- |
| [Detail](../api_detail/index_year_go-constructor.md#api-sig-indexyeargo-init) | `IndexYearGO.__init__(labels, /, *, loc_is_iloc, name, sort_status)` | Initializer. Args: labels: Iterable of hashable values to be used as the index l… |
...
| [Detail](../api_detail/index_year_go-constructor.md#api-sig-indexyeargo-from-difference) | `IndexYearGO.from_difference(*others)` | Construct a new Index based on the difference with Index, containers, or NumPy a… |
| [Detail](../api_detail/index_year_go-constructor.md#api-sig-indexyeargo-from-intersection) | `IndexYearGO.from_intersection(*others)` | Construct a new Index based on the intersection with Index, containers, or NumPy… |
...
| [Detail](../api_detail/index_year_go-constructor.md#api-sig-indexyeargo-from-union) | `IndexYearGO.from_union(*others)` | Construct a new Index based on the union with Index, containers, or NumPy arrays… |
...
Overview: IndexYear: Accessor Type Clinic](index_year-accessor_type_clinic.md "previous page")
[next

Overview: IndexYearGO: Exporter](index_year_go-exporter.md "next page")
