...
|  |  |  |
| --- | --- | --- |
| [Detail](../api_detail/index_hour-constructor.md#api-sig-indexhour-init) | `IndexHour.__init__(labels, /, *, loc_is_iloc, name, sort_status)` | Initializer. Args: labels: Iterable of hashable values to be used as the index l… |
| [Detail](../api_detail/index_hour-constructor.md#api-sig-indexhour-from-difference) | `IndexHour.from_difference(*others)` | Construct a new Index based on the difference with Index, containers, or NumPy a… |
| [Detail](../api_detail/index_hour-constructor.md#api-sig-indexhour-from-intersection) | `IndexHour.from_intersection(*others)` | Construct a new Index based on the intersection with Index, containers, or NumPy… |
...
| [Detail](../api_detail/index_hour-constructor.md#api-sig-indexhour-from-union) | `IndexHour.from_union(*others)` | Construct a new Index based on the union with Index, containers, or NumPy arrays… |
...
Overview: IndexMinuteGO: Accessor Type Clinic](index_minute_go-accessor_type_clinic.md "previous page")
[next

Overview: IndexHour: Exporter](index_hour-exporter.md "next page")
