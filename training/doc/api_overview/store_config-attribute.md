...
| [Detail](../api_detail/store_config-attribute.md#api-sig-storeconfig-read-frame-filter) | `StoreConfig.read_frame_filter` | The type of the None singleton. |
...
Overview: StoreConfig: Exporter](store_config-exporter.md "previous page")
[next

Overview: StoreConfig: Method](store_config-method.md "next page")
