...
|  |  |  |
| --- | --- | --- |
| [Detail](../api_detail/index_minute_go-constructor.md#api-sig-indexminutego-init) | `IndexMinuteGO.__init__(labels, /, *, loc_is_iloc, name, sort_status)` | Initializer. Args: labels: Iterable of hashable values to be used as the index l… |
| [Detail](../api_detail/index_minute_go-constructor.md#api-sig-indexminutego-from-difference) | `IndexMinuteGO.from_difference(*others)` | Construct a new Index based on the difference with Index, containers, or NumPy a… |
| [Detail](../api_detail/index_minute_go-constructor.md#api-sig-indexminutego-from-intersection) | `IndexMinuteGO.from_intersection(*others)` | Construct a new Index based on the intersection with Index, containers, or NumPy… |
...
| [Detail](../api_detail/index_minute_go-constructor.md#api-sig-indexminutego-from-union) | `IndexMinuteGO.from_union(*others)` | Construct a new Index based on the union with Index, containers, or NumPy arrays… |
...
Overview: IndexMinute: Accessor Type Clinic](index_minute-accessor_type_clinic.md "previous page")
[next

Overview: IndexMinuteGO: Exporter](index_minute_go-exporter.md "next page")
