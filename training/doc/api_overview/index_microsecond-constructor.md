...
|  |  |  |
| --- | --- | --- |
| [Detail](../api_detail/index_microsecond-constructor.md#api-sig-indexmicrosecond-init) | `IndexMicrosecond.__init__(labels, /, *, loc_is_iloc, name, sort_status)` | Initializer. Args: labels: Iterable of hashable values to be used as the index l… |
| [Detail](../api_detail/index_microsecond-constructor.md#api-sig-indexmicrosecond-from-difference) | `IndexMicrosecond.from_difference(*others)` | Construct a new Index based on the difference with Index, containers, or NumPy a… |
| [Detail](../api_detail/index_microsecond-constructor.md#api-sig-indexmicrosecond-from-intersection) | `IndexMicrosecond.from_intersection(*others)` | Construct a new Index based on the intersection with Index, containers, or NumPy… |
...
| [Detail](../api_detail/index_microsecond-constructor.md#api-sig-indexmicrosecond-from-union) | `IndexMicrosecond.from_union(*others)` | Construct a new Index based on the union with Index, containers, or NumPy arrays… |
...
Overview: IndexMillisecondGO: Accessor Type Clinic](index_millisecond_go-accessor_type_clinic.md "previous page")
[next

Overview: IndexMicrosecond: Exporter](index_microsecond-exporter.md "next page")
