...
| [Detail](../api_detail/frame_he-exporter.md#api-sig-framehe-to-duckdb) | `FrameHE.to_duckdb(fp, *, label, include_index, include_columns)` | Write the Frame as single-table DuckDB file. |
...
| [Detail](../api_detail/frame_he-exporter.md#api-sig-framehe-to-hdf5) | `FrameHE.to_hdf5(fp, *, label, include_index, include_columns)` | Write the Frame as single-table SQLite file. |
...
| [Detail](../api_detail/frame_he-exporter.md#api-sig-framehe-to-msgpack) | `FrameHE.to_msgpack()` | Return msgpack bytes. |
