...
|  |  |  |
| --- | --- | --- |
| [Detail](../api_detail/index_second_go-constructor.md#api-sig-indexsecondgo-init) | `IndexSecondGO.__init__(labels, /, *, loc_is_iloc, name, sort_status)` | Initializer. Args: labels: Iterable of hashable values to be used as the index l… |
| [Detail](../api_detail/index_second_go-constructor.md#api-sig-indexsecondgo-from-difference) | `IndexSecondGO.from_difference(*others)` | Construct a new Index based on the difference with Index, containers, or NumPy a… |
| [Detail](../api_detail/index_second_go-constructor.md#api-sig-indexsecondgo-from-intersection) | `IndexSecondGO.from_intersection(*others)` | Construct a new Index based on the intersection with Index, containers, or NumPy… |
...
| [Detail](../api_detail/index_second_go-constructor.md#api-sig-indexsecondgo-from-union) | `IndexSecondGO.from_union(*others)` | Construct a new Index based on the union with Index, containers, or NumPy arrays… |
...
Overview: IndexSecond: Accessor Type Clinic](index_second-accessor_type_clinic.md "previous page")
[next

Overview: IndexSecondGO: Exporter](index_second_go-exporter.md "next page")
