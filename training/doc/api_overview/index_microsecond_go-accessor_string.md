...
| [Detail](../api_detail/index_microsecond_go-accessor_string.html#api-sig-indexmicrosecondgo-via-str-len) | `IndexMicrosecondGO.via_str.len()` | Return the length of the string. |
