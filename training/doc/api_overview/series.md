...
| [Accessor Mapping](series-accessor_mapping.md#api-overview-series-accessor-mapping) | Return a wrapper around Series data that fully implements the Python Mapping interface. |
...
Boring Indices & Where to Find Them: The Auto-Incremented Integer Index in StaticFrame](../articles/aiii.md "previous page")
[next

Overview: SeriesHE](series_he.md "next page")
