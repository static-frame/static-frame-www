...
|  |  |  |
| --- | --- | --- |
| [Detail](../api_detail/index_microsecond_go-constructor.md#api-sig-indexmicrosecondgo-init) | `IndexMicrosecondGO.__init__(labels, /, *, loc_is_iloc, name, sort_status)` | Initializer. Args: labels: Iterable of hashable values to be used as the index l… |
| [Detail](../api_detail/index_microsecond_go-constructor.md#api-sig-indexmicrosecondgo-from-difference) | `IndexMicrosecondGO.from_difference(*others)` | Construct a new Index based on the difference with Index, containers, or NumPy a… |
| [Detail](../api_detail/index_microsecond_go-constructor.md#api-sig-indexmicrosecondgo-from-intersection) | `IndexMicrosecondGO.from_intersection(*others)` | Construct a new Index based on the intersection with Index, containers, or NumPy… |
...
| [Detail](../api_detail/index_microsecond_go-constructor.md#api-sig-indexmicrosecondgo-from-union) | `IndexMicrosecondGO.from_union(*others)` | Construct a new Index based on the union with Index, containers, or NumPy arrays… |
...
Overview: IndexMicrosecond: Accessor Type Clinic](index_microsecond-accessor_type_clinic.md "previous page")
[next

Overview: IndexMicrosecondGO: Exporter](index_microsecond_go-exporter.md "next page")
