...
## 3.5.0[#](#id3 "Link to this heading")
...
## 3.4.0[#](#id4 "Link to this heading")
...
## 3.3.0[#](#id5 "Link to this heading")
...
## 3.0.0[#](#id8 "Link to this heading")
...
## 2.18.0[#](#id9 "Link to this heading")
...
## 2.17.0[#](#id10 "Link to this heading")
...
## 2.16.1[#](#id11 "Link to this heading")
...
## 2.16.0[#](#id12 "Link to this heading")
...
## 2.15.1[#](#id13 "Link to this heading")
...
## 2.15.0[#](#id14 "Link to this heading")
...
## 2.14.0[#](#id15 "Link to this heading")
...
## 2.11.0[#](#id20 "Link to this heading")
...
## 2.9.0[#](#id25 "Link to this heading")
...
## 2.0.1[#](#id43 "Link to this heading")

Corrected import in `setup.py`.

## 2.0.0[#](#id44 "Link to this heading")
...
## 1.6.1[#](#id49 "Link to this heading")
...
## 1.4.6[#](#id52 "Link to this heading")

Set `arraykit` to 0.4.9.

## 1.4.5[#](#id53 "Link to this heading")
...
## 1.4.2[#](#id56 "Link to this heading")
...
## 1.3.1[#](#id60 "Link to this heading")

Set `arraykit` version to 0.3.1.

## 1.3.0[#](#id61 "Link to this heading")
...
## 1.2.7[#](#id62 "Link to this heading")
...
## 1.2.6[#](#id63 "Link to this heading")
...
## 1.2.5[#](#id64 "Link to this heading")
...
## 1.2.4[#](#id65 "Link to this heading")
...
## 1.2.3[#](#id66 "Link to this heading")
...
## 1.2.2[#](#id67 "Link to this heading")
...
## 1.2.1[#](#id68 "Link to this heading")
...
## 1.2.0[#](#id69 "Link to this heading")
...
## 1.1.1[#](#id70 "Link to this heading")
...
## 1.1.0[#](#id71 "Link to this heading")
...
## 1.0.1[#](#id72 "Link to this heading")
...
## 1.0.0[#](#id73 "Link to this heading")
...
## 0.9.23[#](#id74 "Link to this heading")
...
## 0.9.22[#](#id75 "Link to this heading")
...
## 0.9.21[#](#id76 "Link to this heading")
...
## 0.9.20[#](#id77 "Link to this heading")
...
## 0.9.19[#](#id78 "Link to this heading")
...
## 0.9.18[#](#id79 "Link to this heading")
...
## 0.9.17[#](#id80 "Link to this heading")
...
## 0.9.16[#](#id81 "Link to this heading")
...
## 0.9.15[#](#id82 "Link to this heading")
...
## 0.9.14[#](#id83 "Link to this heading")
...
## 0.9.13[#](#id84 "Link to this heading")
...
## 0.9.12[#](#id85 "Link to this heading")
...
## 0.9.11[#](#id86 "Link to this heading")
...
## 0.9.10[#](#id87 "Link to this heading")

Corrected single depth selection issue with `IndexHierarchy`.

## 0.9.9[#](#id88 "Link to this heading")
...
## 0.9.8[#](#id89 "Link to this heading")
...
## 0.9.7[#](#id90 "Link to this heading")
...
## 0.9.6[#](#id91 "Link to this heading")
...
## 0.9.3[#](#id94 "Link to this heading")
...
## 0.9.2[#](#id95 "Link to this heading")
...
## 0.9.1[#](#id96 "Link to this heading")
...
## 0.9.0[#](#id97 "Link to this heading")
...
## 0.8.35[#](#id101 "Link to this heading")
...
## 0.8.34[#](#id102 "Link to this heading")
...
## 0.8.33[#](#id103 "Link to this heading")

Performance enhancements to `Frame.from_npy` and `Frame.from_npz`.

## 0.8.32[#](#id104 "Link to this heading")
...
## 0.8.27[#](#id109 "Link to this heading")
...
## 0.8.26[#](#id110 "Link to this heading")
...
## 0.8.20[#](#id116 "Link to this heading")
...
## 0.8.19[#](#id117 "Link to this heading")
...
## 0.8.18[#](#id118 "Link to this heading")
...
## 0.8.17[#](#id119 "Link to this heading")
...
## 0.8.16[#](#id120 "Link to this heading")
...
## 0.8.15[#](#id121 "Link to this heading")
...
## 0.8.14[#](#id122 "Link to this heading")
...
## 0.8.13[#](#id123 "Link to this heading")
...
## 0.8.10[#](#id126 "Link to this heading")
...
## 0.8.9[#](#id127 "Link to this heading")
...
## 0.8.6[#](#id130 "Link to this heading")
...
## 0.8.5[#](#id131 "Link to this heading")
...
## 0.8.2[#](#id134 "Link to this heading")
...
## 0.8.1[#](#id135 "Link to this heading")
...
## 0.8.0[#](#id136 "Link to this heading")
...
## 0.7.15[#](#id137 "Link to this heading")
...
## 0.7.14[#](#id138 "Link to this heading")
...
## 0.7.13[#](#id139 "Link to this heading")
...
## 0.7.12[#](#id140 "Link to this heading")
...
## 0.7.8[#](#id144 "Link to this heading")
...
## 0.7.7[#](#id145 "Link to this heading")
...
## 0.7.3[#](#id149 "Link to this heading")
...
## 0.6.38[#](#id153 "Link to this heading")
...
## 0.6.35[#](#id156 "Link to this heading")
...
## 0.6.34[#](#id157 "Link to this heading")
...
## 0.6.29[#](#id162 "Link to this heading")
...
## 0.6.28[#](#id163 "Link to this heading")
...
## 0.6.27[#](#id164 "Link to this heading")

Improved implementation of `Frame.pivot`.

## 0.6.26[#](#id165 "Link to this heading")
...
## 0.6.22[#](#id169 "Link to this heading")
...
## 0.6.21[#](#id170 "Link to this heading")
...
## 0.6.20[#](#id171 "Link to this heading")
...
## 0.6.19[#](#id172 "Link to this heading")
...
## 0.6.18[#](#id173 "Link to this heading")
...
## 0.6.17[#](#id174 "Link to this heading")
...
## 0.6.16[#](#id175 "Link to this heading")
...
## 0.6.15[#](#id176 "Link to this heading")
...
## 0.6.12[#](#id179 "Link to this heading")
...
## 0.6.11[#](#id180 "Link to this heading")
...
## 0.6.10[#](#id181 "Link to this heading")
...
## 0.6.9[#](#id182 "Link to this heading")
...
## 0.6.8[#](#id183 "Link to this heading")
...
## 0.6.5[#](#id186 "Link to this heading")

Refined `IndexBase.from_pandas`.

## 0.6.4[#](#id187 "Link to this heading")
...
## 0.6.3[#](#id188 "Link to this heading")
...
## 0.6.2[#](#id189 "Link to this heading")
...
## 0.6.1[#](#id190 "Link to this heading")
...
## 0.6.0[#](#id191 "Link to this heading")
...
## 0.5.13[#](#id192 "Link to this heading")
...
## 0.5.12[#](#id193 "Link to this heading")
...
## 0.5.9[#](#id196 "Link to this heading")
...
## 0.5.8[#](#id197 "Link to this heading")
...
## 0.5.7[#](#id198 "Link to this heading")
...
## 0.5.6[#](#id199 "Link to this heading")
...
## 0.5.5[#](#id200 "Link to this heading")
...
## 0.5.4[#](#id201 "Link to this heading")
...
## 0.5.3[#](#id202 "Link to this heading")
...
## 0.5.2[#](#id203 "Link to this heading")
...
## 0.5.1[#](#id204 "Link to this heading")
...
## 0.5.0[#](#id205 "Link to this heading")
...
## 0.4.1[#](#id208 "Link to this heading")
...
## 0.4.0[#](#id209 "Link to this heading")
...
## 0.3.9[#](#id210 "Link to this heading")
...
## 0.3.8[#](#id211 "Link to this heading")
...
## 0.3.7[#](#id212 "Link to this heading")
...
## 0.3.6[#](#id213 "Link to this heading")
...
## 0.3.5[#](#id214 "Link to this heading")
...
## 0.3.4[#](#id215 "Link to this heading")
...
## 0.3.3[#](#id216 "Link to this heading")
...
## 0.3.2[#](#id217 "Link to this heading")
...
## 0.3.1[#](#id218 "Link to this heading")
...
## 0.3.0[#](#id219 "Link to this heading")
