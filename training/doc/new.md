...
## 3.0.0[#](#id3 "Link to this heading")
...
## 2.18.0[#](#id4 "Link to this heading")
...
## 2.17.0[#](#id5 "Link to this heading")
...
## 2.16.1[#](#id6 "Link to this heading")
...
## 2.16.0[#](#id7 "Link to this heading")
...
## 2.15.1[#](#id8 "Link to this heading")
...
## 2.15.0[#](#id9 "Link to this heading")
...
## 2.14.0[#](#id10 "Link to this heading")
...
## 2.11.0[#](#id15 "Link to this heading")
...
## 2.9.0[#](#id20 "Link to this heading")
...
## 2.0.1[#](#id38 "Link to this heading")

Corrected import in `setup.py`.

## 2.0.0[#](#id39 "Link to this heading")
...
## 1.6.1[#](#id44 "Link to this heading")
...
## 1.4.6[#](#id47 "Link to this heading")

Set `arraykit` to 0.4.9.

## 1.4.5[#](#id48 "Link to this heading")
...
## 1.4.2[#](#id51 "Link to this heading")
...
## 1.3.1[#](#id55 "Link to this heading")

Set `arraykit` version to 0.3.1.

## 1.3.0[#](#id56 "Link to this heading")
...
## 1.2.7[#](#id57 "Link to this heading")
...
## 1.2.6[#](#id58 "Link to this heading")
...
## 1.2.5[#](#id59 "Link to this heading")
...
## 1.2.4[#](#id60 "Link to this heading")
...
## 1.2.3[#](#id61 "Link to this heading")
...
## 1.2.2[#](#id62 "Link to this heading")
...
## 1.2.1[#](#id63 "Link to this heading")
...
## 1.2.0[#](#id64 "Link to this heading")
...
## 1.1.1[#](#id65 "Link to this heading")
...
## 1.1.0[#](#id66 "Link to this heading")
...
## 1.0.1[#](#id67 "Link to this heading")
...
## 1.0.0[#](#id68 "Link to this heading")
...
## 0.9.23[#](#id69 "Link to this heading")
...
## 0.9.22[#](#id70 "Link to this heading")
...
## 0.9.21[#](#id71 "Link to this heading")
...
## 0.9.20[#](#id72 "Link to this heading")
...
## 0.9.19[#](#id73 "Link to this heading")
...
## 0.9.18[#](#id74 "Link to this heading")
...
## 0.9.17[#](#id75 "Link to this heading")
...
## 0.9.16[#](#id76 "Link to this heading")
...
## 0.9.15[#](#id77 "Link to this heading")
...
## 0.9.14[#](#id78 "Link to this heading")
...
## 0.9.13[#](#id79 "Link to this heading")
...
## 0.9.12[#](#id80 "Link to this heading")
...
## 0.9.11[#](#id81 "Link to this heading")
...
## 0.9.10[#](#id82 "Link to this heading")

Corrected single depth selection issue with `IndexHierarchy`.

## 0.9.9[#](#id83 "Link to this heading")
...
## 0.9.8[#](#id84 "Link to this heading")
...
## 0.9.7[#](#id85 "Link to this heading")
...
## 0.9.6[#](#id86 "Link to this heading")
...
## 0.9.3[#](#id89 "Link to this heading")
...
## 0.9.2[#](#id90 "Link to this heading")
...
## 0.9.1[#](#id91 "Link to this heading")
...
## 0.9.0[#](#id92 "Link to this heading")
...
## 0.8.35[#](#id96 "Link to this heading")
...
## 0.8.34[#](#id97 "Link to this heading")
...
## 0.8.33[#](#id98 "Link to this heading")

Performance enhancements to `Frame.from_npy` and `Frame.from_npz`.

## 0.8.32[#](#id99 "Link to this heading")
...
## 0.8.27[#](#id104 "Link to this heading")
...
## 0.8.26[#](#id105 "Link to this heading")
...
## 0.8.20[#](#id111 "Link to this heading")
...
## 0.8.19[#](#id112 "Link to this heading")
...
## 0.8.18[#](#id113 "Link to this heading")
...
## 0.8.17[#](#id114 "Link to this heading")
...
## 0.8.16[#](#id115 "Link to this heading")
...
## 0.8.15[#](#id116 "Link to this heading")
...
## 0.8.14[#](#id117 "Link to this heading")
...
## 0.8.13[#](#id118 "Link to this heading")
...
## 0.8.10[#](#id121 "Link to this heading")
...
## 0.8.9[#](#id122 "Link to this heading")
...
## 0.8.6[#](#id125 "Link to this heading")
...
## 0.8.5[#](#id126 "Link to this heading")
...
## 0.8.2[#](#id129 "Link to this heading")
...
## 0.8.1[#](#id130 "Link to this heading")
...
## 0.8.0[#](#id131 "Link to this heading")
...
## 0.7.15[#](#id132 "Link to this heading")
...
## 0.7.14[#](#id133 "Link to this heading")
...
## 0.7.13[#](#id134 "Link to this heading")
...
## 0.7.12[#](#id135 "Link to this heading")
...
## 0.7.8[#](#id139 "Link to this heading")
...
## 0.7.7[#](#id140 "Link to this heading")
...
## 0.7.3[#](#id144 "Link to this heading")
...
## 0.6.38[#](#id148 "Link to this heading")
...
## 0.6.35[#](#id151 "Link to this heading")
...
## 0.6.34[#](#id152 "Link to this heading")
...
## 0.6.29[#](#id157 "Link to this heading")
...
## 0.6.28[#](#id158 "Link to this heading")
...
## 0.6.27[#](#id159 "Link to this heading")

Improved implementation of `Frame.pivot`.

## 0.6.26[#](#id160 "Link to this heading")
...
## 0.6.22[#](#id164 "Link to this heading")
...
## 0.6.21[#](#id165 "Link to this heading")
...
## 0.6.20[#](#id166 "Link to this heading")
...
## 0.6.19[#](#id167 "Link to this heading")
...
## 0.6.18[#](#id168 "Link to this heading")
...
## 0.6.17[#](#id169 "Link to this heading")
...
## 0.6.16[#](#id170 "Link to this heading")
...
## 0.6.15[#](#id171 "Link to this heading")
...
## 0.6.12[#](#id174 "Link to this heading")
...
## 0.6.11[#](#id175 "Link to this heading")
...
## 0.6.10[#](#id176 "Link to this heading")
...
## 0.6.9[#](#id177 "Link to this heading")
...
## 0.6.8[#](#id178 "Link to this heading")
...
## 0.6.5[#](#id181 "Link to this heading")

Refined `IndexBase.from_pandas`.

## 0.6.4[#](#id182 "Link to this heading")
...
## 0.6.3[#](#id183 "Link to this heading")
...
## 0.6.2[#](#id184 "Link to this heading")
...
## 0.6.1[#](#id185 "Link to this heading")
...
## 0.6.0[#](#id186 "Link to this heading")
...
## 0.5.13[#](#id187 "Link to this heading")
...
## 0.5.12[#](#id188 "Link to this heading")
...
## 0.5.9[#](#id191 "Link to this heading")
...
## 0.5.8[#](#id192 "Link to this heading")
...
## 0.5.7[#](#id193 "Link to this heading")
...
## 0.5.6[#](#id194 "Link to this heading")
...
## 0.5.5[#](#id195 "Link to this heading")
...
## 0.5.4[#](#id196 "Link to this heading")
...
## 0.5.3[#](#id197 "Link to this heading")
...
## 0.5.2[#](#id198 "Link to this heading")
...
## 0.5.1[#](#id199 "Link to this heading")
...
## 0.5.0[#](#id200 "Link to this heading")
...
## 0.4.1[#](#id203 "Link to this heading")
...
## 0.4.0[#](#id204 "Link to this heading")
...
## 0.3.9[#](#id205 "Link to this heading")
...
## 0.3.8[#](#id206 "Link to this heading")
...
## 0.3.7[#](#id207 "Link to this heading")
...
## 0.3.6[#](#id208 "Link to this heading")
...
## 0.3.5[#](#id209 "Link to this heading")
...
## 0.3.4[#](#id210 "Link to this heading")
...
## 0.3.3[#](#id211 "Link to this heading")
...
## 0.3.2[#](#id212 "Link to this heading")
...
## 0.3.1[#](#id213 "Link to this heading")
...
## 0.3.0[#](#id214 "Link to this heading")
