...
## 3.1.0[#](#id1 "Link to this heading")
...
## 3.0.0[#](#id2 "Link to this heading")
...
## 2.18.0[#](#id3 "Link to this heading")
...
## 2.17.0[#](#id4 "Link to this heading")
...
## 2.16.1[#](#id5 "Link to this heading")
...
## 2.16.0[#](#id6 "Link to this heading")
...
## 2.15.1[#](#id7 "Link to this heading")
...
## 2.15.0[#](#id8 "Link to this heading")
...
## 2.14.0[#](#id9 "Link to this heading")
...
## 2.11.0[#](#id14 "Link to this heading")
...
## 2.9.0[#](#id19 "Link to this heading")
...
## 2.0.1[#](#id37 "Link to this heading")

Corrected import in `setup.py`.

## 2.0.0[#](#id38 "Link to this heading")
...
## 1.6.1[#](#id43 "Link to this heading")
...
## 1.4.6[#](#id46 "Link to this heading")

Set `arraykit` to 0.4.9.

## 1.4.5[#](#id47 "Link to this heading")
...
## 1.4.2[#](#id50 "Link to this heading")
...
## 1.3.1[#](#id54 "Link to this heading")

Set `arraykit` version to 0.3.1.

## 1.3.0[#](#id55 "Link to this heading")
...
## 1.2.7[#](#id56 "Link to this heading")
...
## 1.2.6[#](#id57 "Link to this heading")
...
## 1.2.5[#](#id58 "Link to this heading")
...
## 1.2.4[#](#id59 "Link to this heading")
...
## 1.2.3[#](#id60 "Link to this heading")
...
## 1.2.2[#](#id61 "Link to this heading")
...
## 1.2.1[#](#id62 "Link to this heading")
...
## 1.2.0[#](#id63 "Link to this heading")
...
## 1.1.1[#](#id64 "Link to this heading")
...
## 1.1.0[#](#id65 "Link to this heading")
...
## 1.0.1[#](#id66 "Link to this heading")
...
## 1.0.0[#](#id67 "Link to this heading")
...
## 0.9.23[#](#id68 "Link to this heading")
...
## 0.9.22[#](#id69 "Link to this heading")
...
## 0.9.21[#](#id70 "Link to this heading")
...
## 0.9.20[#](#id71 "Link to this heading")
...
## 0.9.19[#](#id72 "Link to this heading")
...
## 0.9.18[#](#id73 "Link to this heading")
...
## 0.9.17[#](#id74 "Link to this heading")
...
## 0.9.16[#](#id75 "Link to this heading")
...
## 0.9.15[#](#id76 "Link to this heading")
...
## 0.9.14[#](#id77 "Link to this heading")
...
## 0.9.13[#](#id78 "Link to this heading")
...
## 0.9.12[#](#id79 "Link to this heading")
...
## 0.9.11[#](#id80 "Link to this heading")
...
## 0.9.10[#](#id81 "Link to this heading")

Corrected single depth selection issue with `IndexHierarchy`.

## 0.9.9[#](#id82 "Link to this heading")
...
## 0.9.8[#](#id83 "Link to this heading")
...
## 0.9.7[#](#id84 "Link to this heading")
...
## 0.9.6[#](#id85 "Link to this heading")
...
## 0.9.3[#](#id88 "Link to this heading")
...
## 0.9.2[#](#id89 "Link to this heading")
...
## 0.9.1[#](#id90 "Link to this heading")
...
## 0.9.0[#](#id91 "Link to this heading")
...
## 0.8.35[#](#id95 "Link to this heading")
...
## 0.8.34[#](#id96 "Link to this heading")
...
## 0.8.33[#](#id97 "Link to this heading")

Performance enhancements to `Frame.from_npy` and `Frame.from_npz`.

## 0.8.32[#](#id98 "Link to this heading")
...
## 0.8.27[#](#id103 "Link to this heading")
...
## 0.8.26[#](#id104 "Link to this heading")
...
## 0.8.20[#](#id110 "Link to this heading")
...
## 0.8.19[#](#id111 "Link to this heading")
...
## 0.8.18[#](#id112 "Link to this heading")
...
## 0.8.17[#](#id113 "Link to this heading")
...
## 0.8.16[#](#id114 "Link to this heading")
...
## 0.8.15[#](#id115 "Link to this heading")
...
## 0.8.14[#](#id116 "Link to this heading")
...
## 0.8.13[#](#id117 "Link to this heading")
...
## 0.8.10[#](#id120 "Link to this heading")
...
## 0.8.9[#](#id121 "Link to this heading")
...
## 0.8.6[#](#id124 "Link to this heading")
...
## 0.8.5[#](#id125 "Link to this heading")
...
## 0.8.2[#](#id128 "Link to this heading")
...
## 0.8.1[#](#id129 "Link to this heading")
...
## 0.8.0[#](#id130 "Link to this heading")
...
## 0.7.15[#](#id131 "Link to this heading")
...
## 0.7.14[#](#id132 "Link to this heading")
...
## 0.7.13[#](#id133 "Link to this heading")
...
## 0.7.12[#](#id134 "Link to this heading")
...
## 0.7.8[#](#id138 "Link to this heading")
...
## 0.7.7[#](#id139 "Link to this heading")
...
## 0.7.3[#](#id143 "Link to this heading")
...
## 0.6.38[#](#id147 "Link to this heading")
...
## 0.6.35[#](#id150 "Link to this heading")
...
## 0.6.34[#](#id151 "Link to this heading")
...
## 0.6.29[#](#id156 "Link to this heading")
...
## 0.6.28[#](#id157 "Link to this heading")
...
## 0.6.27[#](#id158 "Link to this heading")

Improved implementation of `Frame.pivot`.

## 0.6.26[#](#id159 "Link to this heading")
...
## 0.6.22[#](#id163 "Link to this heading")
...
## 0.6.21[#](#id164 "Link to this heading")
...
## 0.6.20[#](#id165 "Link to this heading")
...
## 0.6.19[#](#id166 "Link to this heading")
...
## 0.6.18[#](#id167 "Link to this heading")
...
## 0.6.17[#](#id168 "Link to this heading")
...
## 0.6.16[#](#id169 "Link to this heading")
...
## 0.6.15[#](#id170 "Link to this heading")
...
## 0.6.12[#](#id173 "Link to this heading")
...
## 0.6.11[#](#id174 "Link to this heading")
...
## 0.6.10[#](#id175 "Link to this heading")
...
## 0.6.9[#](#id176 "Link to this heading")
...
## 0.6.8[#](#id177 "Link to this heading")
...
## 0.6.5[#](#id180 "Link to this heading")

Refined `IndexBase.from_pandas`.

## 0.6.4[#](#id181 "Link to this heading")
...
## 0.6.3[#](#id182 "Link to this heading")
...
## 0.6.2[#](#id183 "Link to this heading")
...
## 0.6.1[#](#id184 "Link to this heading")
...
## 0.6.0[#](#id185 "Link to this heading")
...
## 0.5.13[#](#id186 "Link to this heading")
...
## 0.5.12[#](#id187 "Link to this heading")
...
## 0.5.9[#](#id190 "Link to this heading")
...
## 0.5.8[#](#id191 "Link to this heading")
...
## 0.5.7[#](#id192 "Link to this heading")
...
## 0.5.6[#](#id193 "Link to this heading")
...
## 0.5.5[#](#id194 "Link to this heading")
...
## 0.5.4[#](#id195 "Link to this heading")
...
## 0.5.3[#](#id196 "Link to this heading")
...
## 0.5.2[#](#id197 "Link to this heading")
...
## 0.5.1[#](#id198 "Link to this heading")
...
## 0.5.0[#](#id199 "Link to this heading")
...
## 0.4.1[#](#id202 "Link to this heading")
...
## 0.4.0[#](#id203 "Link to this heading")
...
## 0.3.9[#](#id204 "Link to this heading")
...
## 0.3.8[#](#id205 "Link to this heading")
...
## 0.3.7[#](#id206 "Link to this heading")
...
## 0.3.6[#](#id207 "Link to this heading")
...
## 0.3.5[#](#id208 "Link to this heading")
...
## 0.3.4[#](#id209 "Link to this heading")
...
## 0.3.3[#](#id210 "Link to this heading")
...
## 0.3.2[#](#id211 "Link to this heading")
...
## 0.3.1[#](#id212 "Link to this heading")
...
## 0.3.0[#](#id213 "Link to this heading")
