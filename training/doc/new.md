...
## 3.8.0[#](#id1 "Link to this heading")
...
## 3.7.0[#](#id2 "Link to this heading")
...
## 3.6.0[#](#id3 "Link to this heading")
...
## 3.5.0[#](#id6 "Link to this heading")
...
## 3.4.0[#](#id7 "Link to this heading")
...
## 3.3.0[#](#id8 "Link to this heading")
...
## 3.0.0[#](#id11 "Link to this heading")
...
## 2.18.0[#](#id12 "Link to this heading")
...
## 2.17.0[#](#id13 "Link to this heading")
...
## 2.16.1[#](#id14 "Link to this heading")
...
## 2.16.0[#](#id15 "Link to this heading")
...
## 2.15.1[#](#id16 "Link to this heading")
...
## 2.15.0[#](#id17 "Link to this heading")
...
## 2.14.0[#](#id18 "Link to this heading")
...
## 2.11.0[#](#id23 "Link to this heading")
...
## 2.9.0[#](#id28 "Link to this heading")
...
## 2.0.1[#](#id46 "Link to this heading")

Corrected import in `setup.py`.

## 2.0.0[#](#id47 "Link to this heading")
...
## 1.6.1[#](#id52 "Link to this heading")
...
## 1.4.6[#](#id55 "Link to this heading")

Set `arraykit` to 0.4.9.

## 1.4.5[#](#id56 "Link to this heading")
...
## 1.4.2[#](#id59 "Link to this heading")
...
## 1.3.1[#](#id63 "Link to this heading")

Set `arraykit` version to 0.3.1.

## 1.3.0[#](#id64 "Link to this heading")
...
## 1.2.7[#](#id65 "Link to this heading")
...
## 1.2.6[#](#id66 "Link to this heading")
...
## 1.2.5[#](#id67 "Link to this heading")
...
## 1.2.4[#](#id68 "Link to this heading")
...
## 1.2.3[#](#id69 "Link to this heading")
...
## 1.2.2[#](#id70 "Link to this heading")
...
## 1.2.1[#](#id71 "Link to this heading")
...
## 1.2.0[#](#id72 "Link to this heading")
...
## 1.1.1[#](#id73 "Link to this heading")
...
## 1.1.0[#](#id74 "Link to this heading")
...
## 1.0.1[#](#id75 "Link to this heading")
...
## 1.0.0[#](#id76 "Link to this heading")
...
## 0.9.23[#](#id77 "Link to this heading")
...
## 0.9.22[#](#id78 "Link to this heading")
...
## 0.9.21[#](#id79 "Link to this heading")
...
## 0.9.20[#](#id80 "Link to this heading")
...
## 0.9.19[#](#id81 "Link to this heading")
...
## 0.9.18[#](#id82 "Link to this heading")
...
## 0.9.17[#](#id83 "Link to this heading")
...
## 0.9.16[#](#id84 "Link to this heading")
...
## 0.9.15[#](#id85 "Link to this heading")
...
## 0.9.14[#](#id86 "Link to this heading")
...
## 0.9.13[#](#id87 "Link to this heading")
...
## 0.9.12[#](#id88 "Link to this heading")
...
## 0.9.11[#](#id89 "Link to this heading")
...
## 0.9.10[#](#id90 "Link to this heading")

Corrected single depth selection issue with `IndexHierarchy`.

## 0.9.9[#](#id91 "Link to this heading")
...
## 0.9.8[#](#id92 "Link to this heading")
...
## 0.9.7[#](#id93 "Link to this heading")
...
## 0.9.6[#](#id94 "Link to this heading")
...
## 0.9.3[#](#id97 "Link to this heading")
...
## 0.9.2[#](#id98 "Link to this heading")
...
## 0.9.1[#](#id99 "Link to this heading")
...
## 0.9.0[#](#id100 "Link to this heading")
...
## 0.8.35[#](#id104 "Link to this heading")
...
## 0.8.34[#](#id105 "Link to this heading")
...
## 0.8.33[#](#id106 "Link to this heading")

Performance enhancements to `Frame.from_npy` and `Frame.from_npz`.

## 0.8.32[#](#id107 "Link to this heading")
...
## 0.8.27[#](#id112 "Link to this heading")
...
## 0.8.26[#](#id113 "Link to this heading")
...
## 0.8.20[#](#id119 "Link to this heading")
...
## 0.8.19[#](#id120 "Link to this heading")
...
## 0.8.18[#](#id121 "Link to this heading")
...
## 0.8.17[#](#id122 "Link to this heading")
...
## 0.8.16[#](#id123 "Link to this heading")
...
## 0.8.15[#](#id124 "Link to this heading")
...
## 0.8.14[#](#id125 "Link to this heading")
...
## 0.8.13[#](#id126 "Link to this heading")
...
## 0.8.10[#](#id129 "Link to this heading")
...
## 0.8.9[#](#id130 "Link to this heading")
...
## 0.8.6[#](#id133 "Link to this heading")
...
## 0.8.5[#](#id134 "Link to this heading")
...
## 0.8.2[#](#id137 "Link to this heading")
...
## 0.8.1[#](#id138 "Link to this heading")
...
## 0.8.0[#](#id139 "Link to this heading")
...
## 0.7.15[#](#id140 "Link to this heading")
...
## 0.7.14[#](#id141 "Link to this heading")
...
## 0.7.13[#](#id142 "Link to this heading")
...
## 0.7.12[#](#id143 "Link to this heading")
...
## 0.7.8[#](#id147 "Link to this heading")
...
## 0.7.7[#](#id148 "Link to this heading")
...
## 0.7.3[#](#id152 "Link to this heading")
...
## 0.6.38[#](#id156 "Link to this heading")
...
## 0.6.35[#](#id159 "Link to this heading")
...
## 0.6.34[#](#id160 "Link to this heading")
...
## 0.6.29[#](#id165 "Link to this heading")
...
## 0.6.28[#](#id166 "Link to this heading")
...
## 0.6.27[#](#id167 "Link to this heading")

Improved implementation of `Frame.pivot`.

## 0.6.26[#](#id168 "Link to this heading")
...
## 0.6.22[#](#id172 "Link to this heading")
...
## 0.6.21[#](#id173 "Link to this heading")
...
## 0.6.20[#](#id174 "Link to this heading")
...
## 0.6.19[#](#id175 "Link to this heading")
...
## 0.6.18[#](#id176 "Link to this heading")
...
## 0.6.17[#](#id177 "Link to this heading")
...
## 0.6.16[#](#id178 "Link to this heading")
...
## 0.6.15[#](#id179 "Link to this heading")
...
## 0.6.12[#](#id182 "Link to this heading")
...
## 0.6.11[#](#id183 "Link to this heading")
...
## 0.6.10[#](#id184 "Link to this heading")
...
## 0.6.9[#](#id185 "Link to this heading")
...
## 0.6.8[#](#id186 "Link to this heading")
...
## 0.6.5[#](#id189 "Link to this heading")

Refined `IndexBase.from_pandas`.

## 0.6.4[#](#id190 "Link to this heading")
...
## 0.6.3[#](#id191 "Link to this heading")
...
## 0.6.2[#](#id192 "Link to this heading")
...
## 0.6.1[#](#id193 "Link to this heading")
...
## 0.6.0[#](#id194 "Link to this heading")
...
## 0.5.13[#](#id195 "Link to this heading")
...
## 0.5.12[#](#id196 "Link to this heading")
...
## 0.5.9[#](#id199 "Link to this heading")
...
## 0.5.8[#](#id200 "Link to this heading")
...
## 0.5.7[#](#id201 "Link to this heading")
...
## 0.5.6[#](#id202 "Link to this heading")
...
## 0.5.5[#](#id203 "Link to this heading")
...
## 0.5.4[#](#id204 "Link to this heading")
...
## 0.5.3[#](#id205 "Link to this heading")
...
## 0.5.2[#](#id206 "Link to this heading")
...
## 0.5.1[#](#id207 "Link to this heading")
...
## 0.5.0[#](#id208 "Link to this heading")
...
## 0.4.1[#](#id211 "Link to this heading")
...
## 0.4.0[#](#id212 "Link to this heading")
...
## 0.3.9[#](#id213 "Link to this heading")
...
## 0.3.8[#](#id214 "Link to this heading")
...
## 0.3.7[#](#id215 "Link to this heading")
...
## 0.3.6[#](#id216 "Link to this heading")
...
## 0.3.5[#](#id217 "Link to this heading")
...
## 0.3.4[#](#id218 "Link to this heading")
...
## 0.3.3[#](#id219 "Link to this heading")
...
## 0.3.2[#](#id220 "Link to this heading")
...
## 0.3.1[#](#id221 "Link to this heading")
...
## 0.3.0[#](#id222 "Link to this heading")
