...
## 3.10.0[#](#id1 "Link to this heading")
...
## 3.9.0[#](#id2 "Link to this heading")
...
## 3.8.0[#](#id3 "Link to this heading")
...
## 3.7.0[#](#id4 "Link to this heading")
...
## 3.6.0[#](#id5 "Link to this heading")
...
## 3.5.0[#](#id8 "Link to this heading")
...
## 3.4.0[#](#id9 "Link to this heading")
...
## 3.3.0[#](#id10 "Link to this heading")
...
## 3.0.0[#](#id13 "Link to this heading")
...
## 2.18.0[#](#id14 "Link to this heading")
...
## 2.17.0[#](#id15 "Link to this heading")
...
## 2.16.1[#](#id16 "Link to this heading")
...
## 2.16.0[#](#id17 "Link to this heading")
...
## 2.15.1[#](#id18 "Link to this heading")
...
## 2.15.0[#](#id19 "Link to this heading")
...
## 2.14.0[#](#id20 "Link to this heading")
...
## 2.11.0[#](#id25 "Link to this heading")
...
## 2.9.0[#](#id30 "Link to this heading")
...
## 2.0.1[#](#id48 "Link to this heading")

Corrected import in `setup.py`.

## 2.0.0[#](#id49 "Link to this heading")
...
## 1.6.1[#](#id54 "Link to this heading")
...
## 1.4.6[#](#id57 "Link to this heading")

Set `arraykit` to 0.4.9.

## 1.4.5[#](#id58 "Link to this heading")
...
## 1.4.2[#](#id61 "Link to this heading")
...
## 1.3.1[#](#id65 "Link to this heading")

Set `arraykit` version to 0.3.1.

## 1.3.0[#](#id66 "Link to this heading")
...
## 1.2.7[#](#id67 "Link to this heading")
...
## 1.2.6[#](#id68 "Link to this heading")
...
## 1.2.5[#](#id69 "Link to this heading")
...
## 1.2.4[#](#id70 "Link to this heading")
...
## 1.2.3[#](#id71 "Link to this heading")
...
## 1.2.2[#](#id72 "Link to this heading")
...
## 1.2.1[#](#id73 "Link to this heading")
...
## 1.2.0[#](#id74 "Link to this heading")
...
## 1.1.1[#](#id75 "Link to this heading")
...
## 1.1.0[#](#id76 "Link to this heading")
...
## 1.0.1[#](#id77 "Link to this heading")
...
## 1.0.0[#](#id78 "Link to this heading")
...
## 0.9.23[#](#id79 "Link to this heading")
...
## 0.9.22[#](#id80 "Link to this heading")
...
## 0.9.21[#](#id81 "Link to this heading")
...
## 0.9.20[#](#id82 "Link to this heading")
...
## 0.9.19[#](#id83 "Link to this heading")
...
## 0.9.18[#](#id84 "Link to this heading")
...
## 0.9.17[#](#id85 "Link to this heading")
...
## 0.9.16[#](#id86 "Link to this heading")
...
## 0.9.15[#](#id87 "Link to this heading")
...
## 0.9.14[#](#id88 "Link to this heading")
...
## 0.9.13[#](#id89 "Link to this heading")
...
## 0.9.12[#](#id90 "Link to this heading")
...
## 0.9.11[#](#id91 "Link to this heading")
...
## 0.9.10[#](#id92 "Link to this heading")

Corrected single depth selection issue with `IndexHierarchy`.

## 0.9.9[#](#id93 "Link to this heading")
...
## 0.9.8[#](#id94 "Link to this heading")
...
## 0.9.7[#](#id95 "Link to this heading")
...
## 0.9.6[#](#id96 "Link to this heading")
...
## 0.9.3[#](#id99 "Link to this heading")
...
## 0.9.2[#](#id100 "Link to this heading")
...
## 0.9.1[#](#id101 "Link to this heading")
...
## 0.9.0[#](#id102 "Link to this heading")
...
## 0.8.35[#](#id106 "Link to this heading")
...
## 0.8.34[#](#id107 "Link to this heading")
...
## 0.8.33[#](#id108 "Link to this heading")

Performance enhancements to `Frame.from_npy` and `Frame.from_npz`.

## 0.8.32[#](#id109 "Link to this heading")
...
## 0.8.27[#](#id114 "Link to this heading")
...
## 0.8.26[#](#id115 "Link to this heading")
...
## 0.8.20[#](#id121 "Link to this heading")
...
## 0.8.19[#](#id122 "Link to this heading")
...
## 0.8.18[#](#id123 "Link to this heading")
...
## 0.8.17[#](#id124 "Link to this heading")
...
## 0.8.16[#](#id125 "Link to this heading")
...
## 0.8.15[#](#id126 "Link to this heading")
...
## 0.8.14[#](#id127 "Link to this heading")
...
## 0.8.13[#](#id128 "Link to this heading")
...
## 0.8.10[#](#id131 "Link to this heading")
...
## 0.8.9[#](#id132 "Link to this heading")
...
## 0.8.6[#](#id135 "Link to this heading")
...
## 0.8.5[#](#id136 "Link to this heading")
...
## 0.8.2[#](#id139 "Link to this heading")
...
## 0.8.1[#](#id140 "Link to this heading")
...
## 0.8.0[#](#id141 "Link to this heading")
...
## 0.7.15[#](#id142 "Link to this heading")
...
## 0.7.14[#](#id143 "Link to this heading")
...
## 0.7.13[#](#id144 "Link to this heading")
...
## 0.7.12[#](#id145 "Link to this heading")
...
## 0.7.11[#](#id146 "Link to this heading")

Corrected issue in `Frame.iter_series` due to recent optimization.

## 0.7.10[#](#id147 "Link to this heading")

Improvements to `Quilt` extraction routines.

## 0.7.9[#](#id148 "Link to this heading")

Improved handling of invalid file paths given to constructors.

Improved implementations of `Bus.items()`, `Bus.values`, and `Bus.equals()` that deliver proper results when max\_persist is active.
...
## 0.7.8[#](#id149 "Link to this heading")
...
## 0.7.7[#](#id150 "Link to this heading")
...
## 0.7.3[#](#id154 "Link to this heading")
...
## 0.6.38[#](#id158 "Link to this heading")
...
## 0.6.35[#](#id161 "Link to this heading")
...
## 0.6.34[#](#id162 "Link to this heading")
...
Support for writing date, datetime, and np.datetime64 via Frame.to\_xlsx.

Exposed `store_filter` parameter in `Frame.from_xlsx`,``Frame.to\_xlsx``.

Removed `format_index`, `format_columns` attributes from `StoreConfig`.

## 0.6.29[#](#id167 "Link to this heading")
...
## 0.6.28[#](#id168 "Link to this heading")
...
Added include\_index\_name, include\_columns\_name to `Frame.to_delimited`.

Added include\_index\_name, include\_columns\_name to `StoreConfig` and `Frame.to_xlsx` interfaces.

Added index\_name\_depth\_level and columns\_name\_depth\_level to Frame.from\_delimited and related methods.

Added index\_name\_depth\_level, columns\_name\_depth\_level to `StoreConfig` and `Frame.from_xlsx` interfaces.

## 0.6.27[#](#id169 "Link to this heading")

Improved implementation of `Frame.pivot`.

## 0.6.26[#](#id170 "Link to this heading")
...
## 0.6.22[#](#id174 "Link to this heading")
...
## 0.6.21[#](#id175 "Link to this heading")
...
## 0.6.20[#](#id176 "Link to this heading")
...
## 0.6.19[#](#id177 "Link to this heading")
...
## 0.6.18[#](#id178 "Link to this heading")
...
## 0.6.17[#](#id179 "Link to this heading")
...
## 0.6.16[#](#id180 "Link to this heading")
...
## 0.6.15[#](#id181 "Link to this heading")
...
## 0.6.12[#](#id184 "Link to this heading")
...
## 0.6.11[#](#id185 "Link to this heading")
...
## 0.6.10[#](#id186 "Link to this heading")
...
## 0.6.9[#](#id187 "Link to this heading")
...
## 0.6.8[#](#id188 "Link to this heading")
...
## 0.6.5[#](#id191 "Link to this heading")

Refined `IndexBase.from_pandas`.

## 0.6.4[#](#id192 "Link to this heading")
...
## 0.6.3[#](#id193 "Link to this heading")
...
## 0.6.2[#](#id194 "Link to this heading")
...
## 0.6.1[#](#id195 "Link to this heading")
...
## 0.6.0[#](#id196 "Link to this heading")
...
## 0.5.13[#](#id197 "Link to this heading")
...
## 0.5.12[#](#id198 "Link to this heading")
...
Added index\_constructor, columns\_constructor arguement to Frame.from\_items, Frame.from\_dict.
...
## 0.5.9[#](#id201 "Link to this heading")
...
## 0.5.8[#](#id202 "Link to this heading")
...
## 0.5.7[#](#id203 "Link to this heading")
...
## 0.5.6[#](#id204 "Link to this heading")
...
## 0.5.5[#](#id205 "Link to this heading")
...
## 0.5.4[#](#id206 "Link to this heading")
...
## 0.5.3[#](#id207 "Link to this heading")
...
## 0.5.2[#](#id208 "Link to this heading")
...
## 0.5.1[#](#id209 "Link to this heading")
...
## 0.5.0[#](#id210 "Link to this heading")
...
## 0.4.1[#](#id213 "Link to this heading")
...
## 0.4.0[#](#id214 "Link to this heading")
...
## 0.3.9[#](#id215 "Link to this heading")
...
## 0.3.8[#](#id216 "Link to this heading")
...
## 0.3.7[#](#id217 "Link to this heading")

Completed implementation of `Frame.fillna_forward`, `Frame.fillna_backward`, `Frame.fillna_leading`, `Frame.fillna_trailing`.

Fixed issue exposed in FrameGO.sort\_values() due to NumPy integers being used for selection.
...
## 0.3.6[#](#id218 "Link to this heading")
...
## 0.3.5[#](#id219 "Link to this heading")
...
## 0.3.4[#](#id220 "Link to this heading")
...
## 0.3.3[#](#id221 "Link to this heading")
...
## 0.3.2[#](#id222 "Link to this heading")
...
## 0.3.1[#](#id223 "Link to this heading")
...
Implemented Series.from\_concat; improved Frame.from\_concat in concatenating indices with diverse types. Frame.from\_concat() now accepts Series.
...
## 0.3.0[#](#id224 "Link to this heading")
...
About StaticFrame](intro.md "previous page")
[next

Contributing](contributing.md "next page")
