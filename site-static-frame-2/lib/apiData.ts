...
export const sigToGroup = new Map<string, string>(Object.entries(sigToGroupJSON));
export const methodToSig = new Map<string, string[]>(Object.entries(methodToSigJSON));
export const sigFullToSig = new Map<string, string>(Object.entries(sigFullToSigJSON));
