...
server.tool(
    ...
    {
        query: z.string().describe('The search query (method name, class name, or pattern)'),
        fullSigSearch: z.boolean().optional().describe('Include parameter names in search (default: false)'),
        reSearch: z.boolean().optional().describe('Use regular expression matching (default: false)'),
    },
