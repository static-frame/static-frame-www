...
export const cnColFieldGradient = "px-4 py-2 rounded-sm shadow-md bg-gradient-to-b from-zinc-700 to-zinc-900"
...
export const CNButtonHover = "ml-1 my-1 p-2 bg-zinc-800 hover:bg-zinc-700 rounded-sm text-base text-zinc-400 font-sans";
export const CNToolTipLeft = "pointer-events-none absolute opacity-0 bg-slate-600 rounded-sm w-max p-2 -top-14 right-0 font-sans text-slate-100 text-right transition-opacity delay-500 group-hover:opacity-80";
